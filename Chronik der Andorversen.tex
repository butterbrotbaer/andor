...
\title{Chronik der Andorversen\\Stand März 2025}
\author{Werke von Michael Menzel, Stefanie Schmitt,\\Christoph Kling, Dorothea Michels, Andreas Kälber, Matthias Miller,\\Jens Baumeister, Timo Grubing, Peter Gustav Bartschat,\\Gerhard Hecht, Inka und Markus Brand, Stefan Blanck\\sowie allerlei anderen andorischen Autor*innen,\\zusammengestellt von Butterbrotbär}
\date{}
...
\begin{titlepage}
    ...
    \fontsize{36}{50}
    \textcolor{white}{\andorfont \contour{black}{Stand März 2025}}
\end{titlepage}
...
\textbf{Und nun schreitet voran, angehende Andor-Expert*innen, und schafft euch einen Überblick über die umfangreiche Welt der Andorversen.}\bigskip
...
\begin{center}
    Legende aus \refprodukt{Die Bonus-Box (2017)} oder \refprodukt{Big Box (2023)}
\end{center}
...
\begin{center}
    Legende von der offiziellen Website oder aus \refprodukt{Die Bonus-Box (2017)} oder \refprodukt{Big Box (2023)}
\end{center}
