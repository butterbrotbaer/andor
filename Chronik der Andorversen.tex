...
\begin{center}
    \begin{tikzpicture}
        ...
        % Draw boxes.
        \node[box] (DLvA) at (0,0){\hyperref[Produkt: Die Legenden von Andor (2012)]{\includegraphics[height=72px]{Chronik der Andorversen/Bilder/Die Legenden von Andor (2012).png}}};
        \node[box] (DRidN) at (4.1,-1.4){\hyperref[Produkt: Die Reise in den Norden (2014)]{\includegraphics[height=72px]{Chronik der Andorversen/Bilder/Die Reise in den Norden (2014).png}}};
        \node[box] (DlH) at (0,-2.7){\hyperref[Produkt: Die letzte Hoffnung (2016)]{\includegraphics[height=72px]{Chronik der Andorversen/Bilder/Die letzte Hoffnung (2016).png}}};
        \node[box] (DLvA-Erweiterungen) at (9.7,0.3)
        {
            \hyperref[Produkt: Der Sternenschild (2013)]{\includegraphics[height=72px]{Chronik der Andorversen/Bilder/Der Sternenschild (2013).png}}
            \hyperref[Produkt: Die Bonus-Box (2024)]{\includegraphics[height=72px]{Chronik der Andorversen/Bilder/Die Bonus-Box (2024).jpeg}}
            \hyperref[Produkt: Alte Geister (2018)]{\includegraphics[height=72px]{Chronik der Andorversen/Bilder/Alte Geister (2018).png}}
            \hyperref[Produkt: Düstere Zeiten (2020)]{\includegraphics[height=72px]{Chronik der Andorversen/Bilder/Düstere Zeiten (2020).png}}
        };
        \node[box] (NH) at (8.1,-2.6) {\hyperref[Produkt: Neue Helden (2014)]{\includegraphics[height=72px]{Chronik der Andorversen/Bilder/Neue Helden (2014).png}}};   
        \node[box] (MH) at (9.7,-2.8) {\hyperref[Produkt: Magische Helden (2021)]{\includegraphics[height=72px]{Chronik der Andorversen/Bilder/Magische Helden (2021).png}}}; 
        \node[box] (DH) at (11.3,-3) {\hyperref[Produkt: Dunkle Helden (2017)]{\includegraphics[height=72px]{Chronik der Andorversen/Bilder/Dunkle Helden (2017).png}}}; 
        \node[box] (AJ) at (0,3.1){\hyperref[Produkt: Andor Junior (2020)]{\includegraphics[height=72px]{Chronik der Andorversen/Bilder/Andor Junior (2020).png}}};
        \node[box] (GadS) at (4.7,3.1){\hyperref[Produkt: Die Gefahr aus dem Schatten (2022)]{\includegraphics[height=72px]{Chronik der Andorversen/Bilder/Die Gefahr aus dem Schatten (2022).png}}};
        \node[box] (DeK) at (0,-5.8){\hyperref[Produkt: Die ewige Kälte (2022)]{\includegraphics[height=72px]{Chronik der Andorversen/Bilder/Die ewige Kälte (2022).png}}};
        \node[box] (DfL) at (0,-8.5) {\hyperref[Produkt: Das ferne Land (2025)]{\includegraphics[height=72px]{Chronik der Andorversen/Bilder/Das ferne Land (2025).png}}}; 
        \node[box] (LdD) at (4.8,-5.8){\hyperref[Produkt: Die ewige Kälte (2022)]{\includegraphics[height=44px]{Chronik der Andorversen/Bilder/Das Licht der Dunkelklinge (2026)}}};
        \node[box] (CuT) at (8.8,-8.9) {\hyperref[Produkt: Chada und Thorn (2015)]{\includegraphics[height=48px]{Chronik der Andorversen/Bilder/Chada und Thorn (2015).png}}};  
        \node[box] (BdR) at (10.6,-8.6) {\hyperref[Produkt: Die Befreiung der Rietburg (2019)]{\includegraphics[height=66px]{Chronik der Andorversen/Bilder/Die Befreiung der Rietburg (2019).png}}};  
        \node[box] (SQ-DP) at (12.1,-9) {\hyperref[Produkt: Dunkle Pfade (2021)]{\includegraphics[height=44px]{Chronik der Andorversen/Bilder/Dunkle Pfade (2021).png}}};  
...
\fillbreak
\produkt{Bücherhelden: Der Drachenwald (2026)}

\begin{center}
    Buch
\end{center}

\bildmitts{Der Drachenwald (2026).jpeg}
