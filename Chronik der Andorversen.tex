...
%\footnote{\refstorytext{Michael Menzel im Interview (2013)}\label{fn:Andori}} (Bewahrer-Wort\footnote{\refstorytext{Feuer und Metall (2020)}\label{fn:ST_FuM}})

\textit{Andori} – Angekommener
%\footref{fn:Andori}\textsuperscript{,}\footnote{\refstorytext{Tenayas Reise (2022)}} (Bewahrer-Wort\footref{fn:ST_FuM})
