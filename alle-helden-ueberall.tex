%!LW recipe = alle-helden-ueberall-recipe
...
\usepackage{fontspec}
    \newfontfamily{\andorfont}{andor-schriftart.otf}[Path=alle-helden-ueberall/]
...
\newcommand{\heldenfigur}[2]{%
    \begin{tikzpicture}[remember picture, overlay]
        \node[opacity=1, inner sep=1.5cm, anchor=north] at (current page.north) {%
            \color{#2}\fbox{\includegraphics[height=54pt]{alle-helden-ueberall/heldenfiguren/#1}}%
        };
    \end{tikzpicture}%
    \vspace*{-\baselineskip}
}

\newcommand{\heldenfigurenlink}[3]{%
    \color{#2}\fbox{\hyperref[#3]{\includegraphics[width=42pt]{alle-helden-ueberall/heldenfiguren/#1}}}%
}
...
\setlength{\fboxrule}{3pt}  % Dicke von \fbox
\setlength{\fboxsep}{0pt}   % Padding von \fbox
...
\title{Alle Helden überall\\Stand ???? ????}
...
\date{\vfill Alle Helden überall v??.?\\Dieses Dokument wurde erstellt mit \LaTeX{}.\\Für den Quelltext siehe \url{https://butterbrotbaer.github.io}.\\Für die neuste Version siehe \url{https://legenden-von-andor.de/forum/viewtopic.php?f=11&t=11151}.}
...
\begin{titlepage}
    ...
    \heldenfigurenlink{trieest.jpg}{orange}{feuerkrieger}
    \heldenfigurenlink{jarid.jpg}{RoyalBlue}{wassermagierin}
    \heldenfigurenlink{leander.jpg}{Blue}{seher}
    \heldenfigurenlink{ijsdur.jpg}{white}{eis-daemon}
    \heldenfigurenlink{orfen.jpg}{Blue}{wolfskrieger}
    \heldenfigurenlink{kram.jpg}{yellow}{zwerg}
    \heldenfigurenlink{stinner.jpg}{Wheat1}{seekrieger}
    \heldenfigurenlink{thorn.jpg}{RoyalBlue}{krieger}
    \heldenfigurenlink{thorn-reiter.jpg}{RoyalBlue}{ritter}
    \heldenfigurenlink{bragor.jpg}{brown}{tarus}

    \vspace{2pt}

    \heldenfigurenlink{fenn.jpg}{orange}{faehrtenleser}
    \heldenfigurenlink{drukil.jpg}{brown}{hautwandler}
    \heldenfigurenlink{avida.jpg}{RoyalBlue}{heilerin}
    \heldenfigurenlink{santa-gor.jpg}{ForestGreen}{weihnachts-gor}
    \heldenfigurenlink{chada.jpg}{ForestGreen}{bogenschuetzin}
    \heldenfigurenlink{ach.jpg}{orange}{takuri-hueterin}
    \heldenfigurenlink{kheela.jpg}{white}{hueterin}
    \heldenfigurenlink{grent.jpg}{Fuchsia}{bergkrieger}
    \heldenfigurenlink{eara.jpg}{Fuchsia}{zauberin}

    \vspace{2pt}

    \heldenfigurenlink{eara-dunkel.jpg}{Fuchsia}{dunkle-magierin}
    \heldenfigurenlink{forn.jpg}{red}{halbskral}
    \heldenfigurenlink{barz.jpg}{HotPink1}{steppennomade}
    \heldenfigurenlink{raash.jpg}{brown}{steppenreiter}
    \heldenfigurenlink{arbon.jpg}{Gray}{bewahrer}
    \heldenfigurenlink{iril.jpg}{Blue}{runenmeisterin}
    \heldenfigurenlink{tenaya-feuerwaechterin.jpg}{ForestGreen}{feuerwaechterin}
    \heldenfigurenlink{tenaya.jpg}{ForestGreen}{feuerbezwingerin}
    \heldenfigurenlink{kirr.jpg}{Fuchsia}{zeitzauberer}
    \heldenfigurenlink{darh.jpg}{Wheat1}{beschwoererin}
\end{titlepage}
...
\fan{Zum anderen ergänzt es diese gesammelten Regeln um Vorschläge für Hausregeln, mit denen endlich alle offiziellen Helden in (fast) allen offiziellen Legenden gespielt werden können.}

Zur Unterscheidung sind offizielle Regeln jeweils gerade geschrieben, \fan{während Fan-Hausregeln kursiv sind.}\bigskip
...
– König Brandur zu \hyperref[bogenschuetzin]{Chada}
\supercite{ldk-der-koenig-von-andor}
...
\bullet{} Legende 3, "Die Tage des Widerstands", darf mit der Solo-Variante auch mit nur 1 Held gespielt werden.
...
\bullet{} Die Mini-Legende "Die Rückkehr" kann nur mit 2 Helden gespielt werden, und nur mit einer \hyperref[bogenschuetzin]{Bogenschützin} und einem \hyperref[krieger]{Krieger}.

\bullet{} Die Bonus-Legende "Im Bann von Choranat" kann nur mit 2 bis 4 verschiedenen Helden gespielt werden, und nur mit dem \hyperref[eis-daemon]{Eis-Dämon}, der \hyperref[runenmeisterin]{Runenmeisterin}, dem \hyperref[steppennomade]{Steppennomaden} oder der \hyperref[takuri-hueterin]{Takuri-Hüterin}.
...
\fan{Spielt ihr mehrere Helden mit gleichem Rang, bestimmt für alle Helden mit selbem Rang eine Reihenfolge, welche eigentlich gleich großen Ränge als höher und welche als tiefer gelten sollen. Diese Reihenfolge gilt dann für die gesamte Legende (z.B. für die Startheldbestimmung).}
...
\fan{Helden mit besonderen Würfeln (\hyperref[eis-daemon]{Eis-Dämon},  \hyperref[runenmeisterin]{Runenmeisterin} und \hyperref[steppennomade]{Steppennomade}) müssen ihre besonderen Würfel nutzen. Andere Helden können diese besonderen Würfel nicht nutzen}
...
\bullet{} Die \hyperref[ablagen-und-leisten]{Regeln für Ablagen/Leisten}.

\bullet{} Die \hyperref[bonusstaerke]{Regeln für Bonusstärke}.

\bullet{} Die \hyperref[gegenstaende-und-sonderplaettchen]{Regeln für Gegenstände/\fan{Sonderplättchen}}.
...
Ausnahme: In "Die letzte Hoffnung" gehen Höhlenplättchen\supercite{40676} und Sternkraut\supercite{dlh-ausruestungstafel} nicht zurück in den Vorrat.\newline
...
\fan{Auf eigene Verantwortung dürft ihr mehreren Helden dieselben Heldenkarten geben, Helden Karten anderer Helden nutzen lassen, selbst Heldenkarten erfinden oder Fan-Heldenkarten aus der Taverne wählen. Dort gibt es bereits Fan-Heldenkarten zum Download:}

\href{https://legenden-von-andor.de/forum/viewtopic.php?p=103303#p103303}
{\blacktriangleright \fan{\enquote{Neue Helden in Die letzte Hoffnung}} (Darhen)}

\href{https://legenden-von-andor.de/forum/viewtopic.php?p=56931#p56931}
{\blacktriangleright \fan{\enquote{Alle Helden ins Graue Gebirge}} (Butterbrotbär)}

\href{https://legenden-von-andor.de/forum/viewtopic.php?p=136266#p136266}
{\blacktriangleright \fan{\enquote{Alle Helden überall – Die letzte Hoffnung}} (Mivo)}

Die hiesigen Hausregeln orientieren sich an letzteren.
...
\fan{Wurde der verhexte Held enttarnt, kann er seine Sonderfähigkeiten nicht mehr nutzen.}
...
\fan{Wer keine Hoffnungskarte nutzt, erhält als dritte Sonderfähigkeit, wenn der Erzähler sein Heldenwappen erreicht: "Lege dein Heldenwappen auf ein beliebiges Feld. Fortan hast du, wenn du dort stehst, +5 \hyperref[bonusstaerke]{Bonusstärke}."}

\fan{Spielt ihr mit mehreren gleichen Helden, gilt eine offizielle Hoffnungskarte für den Helden, der sie nutzt, nicht für andere gleiche Helden mit unterscheidbarem Spielmaterial (z.B. bei der \hyperref[beschwoererin]{Beschwörerin} "dein Golem-Symbol" statt "das Golem-Symbol").}
...
Felder, die von Helden nur mit genug Willenspunkten betreten werden können:
...
Verbindungen zwischen zwei Feldern, die von Helden nur mit genug Willenspunkten überquert werden können:
...
\begin{nobgcolor}
Diese Regeln gelten immer für den \hyperref[bewahrer]{Bewahrer}, die \hyperref[bogenschuetzin]{Bogenschützin}, den \hyperref[steppennomade]{Steppennomaden} und den \hyperref[steppenreiter]{Steppenreiter} sowie für alle Helden, während sie an Bord des Schiffs stehen.
...
Er muss seine Würfel auch nacheinander werfen, wenn der \hyperref[faehrtenleser]{Fährtenleser} sein Horn nutzte.
...
Kann eine Verbindung zwischen zwei Feldern von Helden nur mit genug Willenspunkten überquert werden (z.B. Sprungfelder in "Die letzte Hoffnung"\supercite{dlh-begleitheft,dlh11-b} oder der steile Felsen in "Das ferne Land"), darf der Fernkämpfer Gegner über diese Verbindung bekämpfen, egal wie viele Willenspunkte er hat.
...
Der Fernkämpfer darf vom Turm aus auch angrenzende Gegner mit +2 \hyperref[bonusstaerke]{Bonusstärke} bekämpfen.
...
\fan{Kann ein Feld von Helden nur mit genug Willenspunkten betreten werden (z.B. das Lager der Trolle in "Düstere Zeiten" oder die Höhle der Verwandlung in "Die ewige Kälte"), kann der Reiter, auch wenn er selbst genug Willenspunkte hat, einen Helden mit zu wenig Willenspunkten nicht auf dieses Feld mitbewegen.}

Will der Reiter einen Helden über eine Verbindung zwischen zwei Feldern mitbewegen, die von Helden nur mit genug Willenspunkten überquert werden kann (z.B. Sprungfelder in "Die letzte Hoffnung"\supercite{dlh-begleitheft,dlh-faq} oder der steile Felsen in "Das ferne Land"\supercite{dfl-begleitheft,dfl2-erkungsungskarte-555}), muss der Reiter selbst genug Willenspunkte haben. Es ist aber egal, ob der mitbewegte Held zu wenig Willenspunkte hat.
...
\label{feuerkrieger}
\heldenfigur{trieest.jpg}{orange}
\vspace*{-1.8\baselineskip}
\begin{center}
    \footnotesize
    Als Blanko-Held (2019, \url{https://legenden-von-andor.de/feuerkrieger/}) und aus Herz aus Eis (2023).
\end{center}
...
\fan{Er hat auch so viele Würfel weniger, wenn der \hyperref[faehrtenleser]{Fährtenleser} sein Horn nutzte.}

\fan{Hätte der Feuerkrieger keine oder eine negative Anzahl Heldenwürfel, addiert er keinen Würfelwert zu seinem Kampfwert.}

Ein durch seinen Lavastein zu seinem Kampfwert addierten Würfel kann nicht auf andere Arten (z.B. mit einem Helm \fan{oder Eisernen Handschuh in "Die letzte Hoffnung"}) zu seinem Kampfwert addiert werden \fan{und kann nicht mit dem Trank der Hexe verdoppelt werden}.

Er kann diese Fähigkeit nicht im \hyperref[fernkaempfer]{Fernkampf} nutzen.
\supercite{112103}
...
\fan{Hätte der Feuerkrieger keine oder eine negative Anzahl Heldenwürfel, kann er auch keinen Ersatzwürfel (z.B. den großen weißen Würfel der \hyperref[hueterin]{Hüterin}) statt seiner Heldenwürfel werfen. Ausnahme: Hat er einen Gegnerwürfel, darf er den Ersatzwürfel statt des Gegnerwürfels werfen.}
...
\fan{Steht der Feuerkrieger bei oder angrenzend zu Geistern, kann er im Kampf durch seinen Lavastein keinen Würfel addieren.}
...
\heldenfigur{jarid.jpg}{RoyalBlue}
\vspace*{-1.8\baselineskip}
\begin{center}
    \footnotesize
    Als Bonus-Heldin (2019, \url{https://legenden-von-andor.de/zusatzheld-jarim-jarid/}).
\end{center}
...
\fan{Der Teleport gilt als Betreten des Felds und Stehenbleiben auf dem Feld. Er löst entsprechende Effekte (z.B. Nebelplättchen oder Arbaks in "Alte Geister") aus.}
...
\subsection{\fan{Große blaue Einführungsplättchen:}}

\fan{Die Wassermagierin kann sich nicht von oder zu großen blauen Einführungsplättchen teleportieren.}
...
\fan{Sie kann sich nicht von oder zu einem Feuer auf der Heldentafel der \hyperref[feuerwaechterin]{Feuerwächterin} teleportieren.}
...
\label{seher}
\heldenfigur{leander.jpg}{Blue}
\vspace*{-1.8\baselineskip}
\begin{center}
    \footnotesize
    Aus Dunkle Helden (2017).
\end{center}
...
Statt Heldenwürfel zu werfen, legt der Seher den nächsten Würfel seiner Würfelleiste weg und wertet diesen. Der Würfel darf vor der Wertung gedreht (z.B. von der \hyperref[zauberin]{Zauberin})\supercite{dh-faq}, \fan{neu geworfen (z.B. mit Messer)} und mit dem Trank der Hexe verdoppelt werden.

Der Seher kann auch mit einem Helm nicht mehrere Würfel seiner Würfelleiste addieren.
\supercite{dh-faq,dh-begleitheft}

\fan{Das Horn des \hyperref[faehrtenleser]{Fährtenlesers} hat keinen Effekt auf ihn.}
...
\supercite{bl-bdm-a3-en}

Ein auf eine "1" gedrehter (z.B. von der \hyperref[zauberin]{Zauberin}) \fan{oder neu geworfener (z.B. mit Messer)} Würfel kann nicht fürs Sehende Auge genutzt werden.
\supercite{dh-faq}
...
\fan{Wirft der Seher einen Ersatzwürfel (z.B. den großen weißen Würfel der \hyperref[hueterin]{Hüterin}), legt er keinen Würfel von seiner Würfelleiste weg.}
\supercite{49630}
...
\subsection{\fan{Mehrere Seher:}}

\fan{Jeder Seher hat seine eigene Würfelleiste.}
...
\supercite{dh11-heldenkarte-seher}
...
Es gibt keine Ereigniskarten. Der Seher kann seine zweite Sonderfähigkeit nicht nutzen.
\supercite{dh-begleitheft}
...
\supercite{dz-begleitheft}
\fan{Wirft der Seher bei leerer Würfelleiste neu, kann er Würfel auf Schattenplättchen nicht neu werfen und er kann für jeden seiner Würfel auf Schattenplättchen einen Würfel weniger weglegen.}
...
\label{eis-daemon}
\heldenfigur{ijsdur.jpg}{white}
\vspace*{-1.8\baselineskip}
\begin{center}
    \footnotesize
    Aus Magische Helden (2021).
\end{center}
...
\supercite{mh-kaelte,mh-begleitheft}
...
Eisblitze sind \hyperref[gegenstaende-und-sonderplaettchen]{\fan{Sonderplättchen}}. 

Würde der Eis-Dämon mehr Eisblitze erhalten, als er tragen kann, verfallen überzählige.
...
\supercite{mh-kaelte}
Dann legt er den Kampfblitz rechts an seinen Stärkestein auf seine Stärkeleiste. Solange der Kampfblitz dort liegt, hat er +5 \hyperref[bonusstaerke]{Bonusstärke}.
\supercite{mh-begleitheft}
Wird der Stärkestein des Eis-Dämons bewegt, bewegt den Kampfblitz mit.
\supercite{88778} 
...
Solange die Eisbrücke im Spiel ist, gelten die beiden Felder als angrenzend für Helden, von Helden mitbewegte Plättchen und Figuren, \hyperref[helfer]{\fan{Helfer}} und als eigene Aktion bewegbare Figuren. 
\supercite{88780}
...
Eisbrücken dürfen auch aufs Feld für besiegte Kreaturen gebaut werden.\supercite{88778} \fan{Dort liegende Kreaturen können aber nicht erneut bekämpft werden. Ein dort liegender Knochen-Golem der \hyperref[beschwoererin]{Beschwörerin} kann nicht bewegt werden.}



\subsection{Willenspunkte-Schranken:}

Jeder Held kann eine Eisbrücke nutzen, egal wie viele Willenspunkte er hat, auch wenn zwischen ihren Endfeldern eine Verbindung ist, die von Helden nur mit genug Willenspunkten überquert werden kann (z.B. Sprungfelder in "Die letzte Hoffnung"\supercite{mh11-heldenkarte-eis-daemon} \fan{oder der steile Felsen in "Das ferne Land"}).
...
\fan{Legt am Anfang 5 Eisblitze pro Eis-Dämon bereit, aber nur ein Eiskristall-Plättchen auf das Sonnenaufgang-Feld. Dieses gilt für alle Eis-Dämonen. Jeder Eis-Dämon kann einen Kampfblitz nur auf seine eigene Stärkeleiste legen.}
...
\supercite{mh11-heldenkarte-eis-daemon}
...
\fan{Wird der Eis-Dämon enttarnt, gehen Eisblitze von seiner Heldentafel aus dem Spiel. Eisbrücken bleiben aber liegen, bis der Eiskristall sie entfernt.}
...
\fan{Der Takuri-Spiegel kann keine besiegte Kreatur von Feld 80 versetzen. Ist wegen einer Eisbrücke eine andere Figur auf Feld 80, darf der Takuri-Spiegel eine Kreatur oder andere Figur auf Feld 80 versetzen. Liegt die versetzte Kreatur, so markiert sie (z.B. mit einem Sternchen) zur Erinnerung, dass sie nicht besiegt ist und wieder aufstehen wird.}
...
\fan{Eisbrücken dürfen auch zur Pfahlbausiedlung (Feld 453) gebaut werden. Der Rand von Feld 453 liegt zwischen der Pfahlbausiedlung und dem See, nicht am äußeren Seeufer.}
...
\fan{Steht der Eis-Dämon bei oder angrenzend zu Geistern, erhält er bei Sonnenaufgang keine Eisblitze, kann keine Eisblitze von seiner Heldentafel einsetzen und erhält keine \hyperref[bonusstaerke]{Bonusstärke} durch Kampfblitze. Es ist egal, ob der Gegner bei oder angrenzend zu Geistern steht.}
...
\label{wolfskrieger}
\heldenfigur{orfen.jpg}{Blue}
\vspace*{-1.8\baselineskip}
\begin{center}
    \footnotesize
    Als Bonus-Held (2012, \url{https://legenden-von-andor.de/zusatzheld-orfen-der-wolfskrieger/}) und aus Die Bonus-Box (2017/2024), Das Geheimnis des Königs (2019) und Big Box (2023).
\end{center}
...
Im Kampf (außer gegen Trolle) hat der Wolfskrieger, wenn er weniger Stärkepunkte hat als die 10er-Stelle seiner Feldzahl, die Differenz zwischen der 10er-Stelle seiner Feldzahl und seinen Stärkepunkten als \hyperref[bonusstaerke]{Bonusstärke}.
...
Im Kampf gegen Trolle hat der Wolfskrieger die 10er-Stelle seiner Feldzahl als \hyperref[bonusstaerke]{Bonusstärke}.
...
\fan{Für seine \hyperref[bonusstaerke]{Bonusstärke} gelten auch der Belagerungsturm und die Trolle des Katapults als Trolle.}
...
Ist der Wolfskrieger an Bord des Schiffes, erhält er keine \hyperref[bonusstaerke]{Bonusstärke} durch eine Feldzahl.

Für seine \hyperref[bonusstaerke]{Bonusstärke} gelten Meerestrolle nicht als Trolle.
\supercite{10469}
...
\fan{Für seine \hyperref[bonusstaerke]{Bonusstärke} gelten auch der Urtroll und Wachtrolle als Trolle.}
...
\fan{Ist der Wolfskrieger an Bord des Boots, erhält er keine \hyperref[bonusstaerke]{Bonusstärke} durch eine Feldzahl.}

\fan{Für seine \hyperref[bonusstaerke]{Bonusstärke} gelten auch die drei großen Trolle als Trolle.}
...
\fan{Für seine \hyperref[bonusstaerke]{Bonusstärke} gelten auch Felltrolle als Trolle.}
...
\fan{Für seine \hyperref[bonusstaerke]{Bonusstärke} gelten auch Sumpftrolle und Wachtrolle als Trolle. Der Trollkönig ebenfalls, aber dessen Feld hat keine Zehnerstelle.}
...
\fan{Steht der Wolfskrieger bei oder angrenzend zu Geistern, erhält er keine \hyperref[bonusstaerke]{Bonusstärke} durch Geländekunde und Trollhass. Es ist egal, ob sein Gegner bei oder angrenzend zu Geistern steht.}
...
\label{zwerg}
\heldenfigur{kram.jpg}{yellow}
\vspace*{-1.8\baselineskip}
\begin{center}
    \footnotesize
    Aus Die Legenden von Andor (2012), Die letzte Hoffnung (2016), Das Geheimnis des Königs (2019), Die ewige Kälte (2022), Big Box (2023) und Herz aus Eis (2023).
\end{center}
...
\bullet{} \textbf{Feld 71} (nur auf Grundspiel-Spielplänen geeignet):
...
Der Zwerg darf im Kampf, direkt nach seinem Würfeln, beliebig viele Willenspunkte abgeben, um nur in dieser Kampfrunde so viel \hyperref[bonusstaerke]{Bonusstärke} zu erhalten. 
\supercite{gdk}
...
Steht der Zwerg auf einem Höhlenfeld, hat er +5 \hyperref[bonusstaerke]{Bonusstärke} und 3 Würfel, egal wie viele Willenspunkte er hat.
\supercite{dlh-begleitheft,dlh11-heldenkarte-zwerg}
...
\fan{Steht der Zwerg bei oder angrenzend zu Geistern, kann er seine Sonderfähigkeit nicht nutzen.}
...
\label{seekrieger}
\heldenfigur{stinner.jpg}{Wheat1}
\vspace*{-1.8\baselineskip}
\begin{center}
    \footnotesize
    Aus Die Reise in den Norden (2014).
\end{center}
...
\fan{Falls keine Trinkschläuche bereitgelegt würden, legt alle Trinkschläuche der Box bereit.}
...
\href{https://legenden-von-andor.de/forum/viewtopic.php?p=126785#p126785}
{\blacktriangleright \fan{\enquote{Fan-Stinner in anderen Andor-Teilen}}}
...
\fan{Jeder Seekrieger erhält am Anfang einen treuen Streifenmarder. Die treuen Streifenmarder sind alle ununterscheidbar. Jeder Seekrieger darf jeden treuen Streifenmarder nutzen. Pro Kampfrunde kann insgesamt nur ein treuer Streifenmarder genutzt werden. Bei Sonnenaufgang dürfen mehrere Streifenmarder demselben Seekrieger je einen halbvollen Trinkschlauch geben.}
...
Der Seekrieger darf einmal pro Zug, vor oder nach seiner Aktion, wenn er an Bord des Schiffs ist, das Schiff auf ein angrenzendes Meeresfeld versetzen (\fan{auch über eine Eisbrücke des \hyperref[eis-daemon]{Eis-Dämons}}). Das kostet ihn keine Stunden.
...
\subsection{\fan{Bonus-Legende "Die vierte Statue":}}

\fan{Legt am Anfang zusätzlich einen halbvollen Trinkschlauch bereit. Der Streifenmarder kann dem Seekrieger nur genau dieses Plättchen geben, keinen der 4 anderen Trinkschläuche. Nach der Benutzung wird dieser halbvolle Trinkschlauch jeweils wieder bereitgelegt.}

\fan{Spielt ihr mit mehreren Seekriegern: Jeden Sonnenaufgang kann nur einer der Seekrieger den halbvollen Trinkschlauch erhalten.}
...
\label{krieger}
\heldenfigur{thorn.jpg}{RoyalBlue}
\vspace*{-1.8\baselineskip}
\begin{center}
    \footnotesize
    Aus Die Legenden von Andor (2012), Das Geheimnis des Königs (2019), Die ewige Kälte (2022), Big Box (2023) und Herz aus Eis (2023). Siehe auch \hyperref[ritter]{Thorn (Mairen), der \fan{Ritter}}.
\end{center}
...
Erhält er Willenspunkte durch die Sonderfähigkeit der \hyperref[wassermagierin]{Wassermagierin}, erhält er durch seine Sonderfähigkeit keine zusätzlichen Willenspunkte.


\subsection{Feuer:}

Ein brennendes Feuer (auf seinem Feld oder von der \hyperref[feuerwaechterin]{Feuerwächterin} getragen) gibt dem Krieger +2 \hyperref[bonusstaerke]{Bonusstärke} (statt +1).
\supercite{dek-begleitheft}



\subsection{Große blaue Einführungsplättchen:}

\fan{Der Krieger erhält auch bei großen blauen Einführungsplättchen "Brunnen"/"Quelle" 5 Willenspunkte, egal was auf dem Plättchen steht.}
...
\fan{Steht der Krieger bei oder angrenzend zu Geistern, erhält er beim Leeren eines Brunnens nur 3 Willenspunkte und keine \hyperref[bonusstaerke]{Bonusstärke} durch ein Feuer auf der Heldentafel der \hyperref[feuerwaechterin]{Feuerwächterin}.}
...
\label{ritter}
\heldenfigur{thorn-reiter.jpg}{RoyalBlue}
\vspace*{-1.8\baselineskip}
\begin{center}
    \footnotesize
    Aus Die letzte Hoffnung (2016). Siehe auch \hyperref[krieger]{Thorn (Mairen), der Krieger}.
\end{center}
...
Der \fan{Ritter} hat in der ersten Kampfrunde jedes Kampfes +2 \hyperref[bonusstaerke]{Bonusstärke}.
...
Ihr dürft die Summe seiner Stärkepunkte und dieser Bonusstärke durch einen weißen Holzstein markieren.\supercite{dlh-begleitheft,dlh11-heldenkarte-krieger}
...
\label{tarus}
\heldenfigur{bragor.jpg}{brown}
\vspace*{-1.8\baselineskip}
\begin{center}
    \footnotesize
    Aus Neue Helden (2014) und Big Box (2023).
\end{center}
...
Der Tarus ist ein \hyperref[fernkaempfer]{Fernkämpfer}. Die Fernkampf-Regeln gelten aber nur, wenn er einen angrenzenden Gegner bekämpft, keinen Gegner auf demselben Feld.
\supercite{nh-begleitheft}
...
\fan{Wurde das Plättchen an diesem Tag durch die \hyperref[runenmeisterin]{Runenmeisterin} aufgefrischt, kann der Tarus keinen Stärkepunkt statt Willenspunkten erhalten.}
\supercite{137438}

Erhält der Tarus Willenspunkte durch die Sonderfähigkeit der \hyperref[wassermagierin]{Wassermagierin}, kann er keinen Stärkepunkt statt Willenspunkten erhalten.
...
\fan{Hat der Tarus 15 oder mehr Willenspunkte, darf er auch bei großen blauen Einführungsplättchen "Brunnen"/"Quelle" 1 Stärkepunkt statt der Willenspunkte erhalten.}
...
Spricht eine Regel oder Karte von der \hyperref[bogenschuetzin]{Bogenschützin}, ist der Tarus nicht gemeint.
...
Nur der Fährtenleser kann Rabe, Messer und Horn tragen. Sie sind \hyperref[gegenstaende-und-sonderplaettchen]{\fan{Sonderplättchen}}.
\supercite{6952}
...
\supercite{nh-begleitheft}
\fan{Das geht, auch wenn der Würfel zuvor bereits durch einen anderen Effekt neu geworfen wurde.} Im \hyperref[fernkaempfer]{Fernkampf} kann er mit dem Messer nur den zuletzt geworfenen Würfel neu werfen,\supercite{dridn-begleitheft} \fan{bei dem er aufhörte}.
...
Wirft der Fährtenleser statt seiner Heldenwürfel einen Ersatzwürfel (z.B. den großen weißen Würfel der \hyperref[hueterin]{Hüterin}), kann das Messer diesen nicht neu werfen.
\supercite{5460}
...
\hyperref[fernkaempfer]{Fernkämpfer} würfeln ihre Würfel weiterhin nacheinander.
\supercite{nh-begleitheft}
...
\fan{Jeder Fährtenleser erhält am Anfang seine eigenen Raben, Messer und Horn. Er kann mit seinem Messer nur einen eigenen Würfel neu werfen.}
...
Als Bär hat der Hautwandler \hyperref[bonusstaerke]{Bonusstärke}:
...
Die Summe seiner Stärkepunkte und dieser \hyperref[bonusstaerke]{Bonusstärke} wird oberhalb seiner Stärkeleiste angezeigt.
...
\supercite{dh-baer,dh-begleitheft}
...
\supercite{dh-baer,dz-begleitheft}
...
\supercite{dh-baer,dh-begleitheft,46300} 
...
Ist er am Zug und steht nicht auf einem Waldfeld, muss er 1 Schritt in Richtung des nächstgelegenen Waldfelds mit der kleinsten Feldzahl laufen. Dafür darf er auch Eisbrücken des \hyperref[eis-daemon]{Eis-Dämons} nutzen. \fan{Dafür darf er Verbindungen zwischen zwei Feldern überqueren, die von Helden nur mit genug Willenspunkten überquert werden können (z.B. Sprungfelder in "Die letzte Hoffnung" oder der steile Felsen in "Das ferne Land"), egal wie viele Willenspunkte er hat.}
...
\bullet{} In Andor (Spielplan-Vorderseite) die Felder 22–25, 47–60 und 62–63,
\supercite{232}

\bullet{} In Cavern (Spielplan-Rückseite) die Felder 43–47, 49–52, 54–63, 65 und 70.
\supercite{17913}
...
Der Hautwandler erhält den kleinen runden \hyperref[gegenstaende-und-sonderplaettchen]{Gegenstand} Armreif.
...
\supercite{dh11-heldenkarte-hautwandler}

\fan{Spielt ihr mit mehreren Hautwandlern: Jeder Hautwandler mit dieser zweiten Sonderfähigkeit erhält einen Armreif. Alle Armreife sind ununterscheidbar. Ein Hautwandler kann höchstens einen Armreif auf einmal tragen, darf im Laufe einer Legende aber mehrere Armreife nutzen.}
...
\fan{Für die offizielle Erschöpfungskarte "gleich viele Stärkepunkte" gilt: Solange du deine Genesungsaufgabe nicht erfüllt hast, hat der Bär keine \hyperref[bonusstaerke]{Bonusstärke}.}
...
\fan{Der Bär kann das Boot nur fahren, wenn er 10 bis 14 Willenspunkte hat.}
...
\bullet{} \fan{In Andor (Spielplan-Rückseite) die Felder 22–25, 47–60 und 62–63.}
...
\fan{Der Bär kann kann Seefelder nicht betreten, egal ob dort Eisplättchen liegen. Nur wenn er bereits auf einem Seefeld oder Feld 460 steht, darf er Seefelder auf einem kürzesten Weg zum Ufer betreten, erneut egal ob dort Eisplättchen liegen.}
...
\bullet{} \fan{In Azturien (Spielplan-Vorderseite) alle Felder mit 3 oder mehr Baumkronen, also die Felder 500, 502, 506, 508, 513–514, 516–517, 519, 521–522, 535, 539–541, 551, 556–557 und 559–562,}

\bullet{} \fan{Im Land der Steppe (Spielplan-Rückseite) die Felder 405, 412, 415–416, 424 und 443.}
...
\fan{Steht der Bär bei oder angrenzend zu Geistern, hat er keine \hyperref[bonusstaerke]{Bonusstärke}. Alle Regeln zum Hautwandel und den anderen Bäreneffekten gelten, auch wenn er bei oder angrenzend zu Geistern steht.}
...
\label{heilerin}
\heldenfigur{avida.jpg}{RoyalBlue}
\vspace*{-1.8\baselineskip}
\begin{center}
    \footnotesize
    Aus Das ferne Land (2025).
\end{center}
...
Hat die Heilerin 7 bis 20 Willenspunkte\supercite{135228}, darf sie in jeder Kampfrunde (nicht im \hyperref[fernkaempfer]{Fernkampf}\supercite{dfl-begleitheft}) direkt nach ihrem Würfeln einen ihrer nicht zu ihrem Kampfwert addierten Würfel wählen und \fan{bis zu} so viele Willenspunkte auf die kämpfenden Helden verteilen (auch auf Helden, die durch \hyperref[fernkaempfer]{Fernkampf} mitkämpfen).

\fan{Der gewählte Würfel darf gedreht (z.B. von der \hyperref[zauberin]{Zauberin}) oder neu geworfen (z.B. mit Messer) worden sein. Danach kann er nicht mehr gedreht oder neu geworfen werden. Er kann nicht auf andere Arten (z.B. mit Helm) zu ihrem Kampfwert addiert werden. Er kann nicht mit dem Trank der Hexe verdoppelt werden}.
...
Hat die Heilerin 14 bis 20 Willenspunkte, darf sie im Kampf (nicht im \hyperref[fernkaempfer]{Fernkampf}\supercite{dfl-begleitheft}) zwei gleiche Würfelwerte zu ihrem Kampfwert addieren.
...
\fan{Wirft die Heilerin im Kampf einen Gegnerwürfel gemeinsam mit ihren Heldenwürfeln (z.B. durch den Streifenmarder in "Die Reise in den Norden" oder Meres in "Die steinernen Drei"), darf sie für ihre Heilkraft den Gegnerwürfel wählen, und sie darf durch ihre Kampfkraft zwei gleiche Würfelwerte addieren (auch von Gegnerwürfeln), aber nicht drei gleiche Würfelwerte.}
...
\heldenfigur{santa-gor.jpg}{ForestGreen}
\vspace*{-1.8\baselineskip}
\begin{center}
    \footnotesize
    Als Bonus-Held (2021, \url{https://legenden-von-andor.de/zusatzheld-santa-gor/}).
\end{center}
...
Er hat keine kleinen rechteckigen Ablagefelder (statt 3).
...
\fan{Es gibt keine Ausrüstungstafel. Legt am Anfang alle Trinkschläuche bereit. Der Weihnachts-Gor darf Trinkschläuche bescheren.}
...
\bullet{} \fan{Auf den Nebelinseln (Spielplan-Vorderseite) die Felder 91, 100, 103, 107–109 und 113–114,}
...
\bullet{} \fan{Im Grauen Gebirge (Spielplan-Vorderseite) die Felder 223, 228, 242, 245, 247–249, 252 und 267–268.}

\bullet{} \fan{In Krahd (Spielplan-Rückseite) die Felder 320, 330, 350 und 360–370.}



\subsection{\fan{Legende 11, Das Graue Gebirge:}}

\fan{Es gibt keine Ausrüstungstafel. Während der Erzähler auf "b" oder später steht, darf der Weihnachts-Gor Trinkschläuche bescheren.}
...
Es gibt keine Ausrüstungstafel. \fan{Der Weihnachts-Gor beschert Gegenstände von Feld 71.}
...
\fan{\bullet{} Im Land der Steppe (Spielplan-Rückseite) die Felder 401, 403, 405, 409, 412–413, 415, 419, 425–426, 437, 442 und 453.}

\fan{Im Schachtelboden gelten keine Felder als Feld mit Gebäude.}
...
\label{bogenschuetzin}
\heldenfigur{chada.jpg}{ForestGreen}
\vspace*{-1.8\baselineskip}
\begin{center}
    \footnotesize
    Aus Die Legenden von Andor (2012), Die letzte Hoffnung (2016), Das Geheimnis des Königs (2019) und Big Box (2023).
\end{center}
...
Die Bogenschützin ist eine \hyperref[fernkaempfer]{Fernkämpferin}.
...
\supercite{dlva-ausruestungstafel,dlva2-hexe,dlva-begleitheft}
...
Die Bogenschützin erhält den Kessel. Der Kessel ist ein kleiner rechteckiger \hyperref[gegenstaende-und-sonderplaettchen]{Gegenstand}.
...
\supercite{dlh-begleitheft,dlh11-heldenkarte-bogenschuetze}
...
\label{takuri-hueterin}
\heldenfigur{ach.jpg}{orange}
\vspace*{-1.8\baselineskip}
\begin{center}
    \footnotesize
    Aus Magische Helden (2021).
...
Die Takuri-Hüterin hat einen \hyperref[helfer]{\fan{Helfer}}, die Figur "Takuri", den sie aber nicht als eigene Aktion bewegen kann.

Steht der Takuri auf dem Feld eines kämpfenden Helden, gibt er den Wert des Takuri-Markers als \hyperref[bonusstaerke]{Bonusstärke}.
\supercite{mh-takuri}
...
Die Steinflöte ist ein kleiner rechteckiger \hyperref[gegenstaende-und-sonderplaettchen]{Gegenstand}.
...
Im Spiel mit neutralen Zeitsteinen darf die Takuri-Hüterin vor dem Auffrischen der Flöte auswählen, welchen ihrer möglichen Zeitsteine sie 2 Stunden vorsetzt.



\subsection{\fan{Mehrere Takuri-Hüterinnen:}}

\fan{Jede Takuri-Hüterin erhält am Anfang eine Steinflöte. Alle Steinflöten sind ununterscheidbar und dürfen von allen Takuri-Hüterinnen genutzt oder aufgefrischt werden. Jede Takuri-Hüterin hat ihren eigenen Takuri-Marker und eigenen Takuri, den nur sie bewegen oder besänftigen kann. Ihr dürft den Takuri Standfüße in unterschiedlichen Farben geben.}




\subsection{Keine Hüterin der Flusslande:}

Spricht eine Regel oder Karte aus "Magische Helden" von der Hüterin, ist die Takuri-Hüterin gemeint. Spricht eine andere Regel oder Karte von der Hüterin, ist die \hyperref[hueterin]{Hüterin} gemeint und nicht die Takuri-Hüterin.
...
Die Takuri-Hüterin erhält die zwei \hyperref[gegenstaende-und-sonderplaettchen]{\fan{Gegenstände}} Takuri-Federn, welche auf der Goldablage getragen werden. Nur die Takuri-Hüterin kann 1 Takuri-Feder abgeben, damit sie alle Überstunden an diesem Tag keine Willenspunkte kosten.
\supercite{mh11-heldenkarte-takuri-hueterin}

\fan{Spielt ihr mit mehreren Takuri-Hüterinnen: Jede Takuri-Hüterin mit dieser zweiten Sonderfähigkeit erhält 2 Takuri-Federn. Alle Takuri-Federn sind ununterscheidbar und dürfen von jeder Takuri-Hüterin genutzt werden. Eine Takuri-Hüterin darf im Laufe einer Legende auch mehr als zweimal Takuri-Federn nutzen.}
...
\fan{Auch festgehaltene Helden (z.B. durch Skelette oder Spornen) dürfen versetzt werden.}
\fan{Gegner können nicht über Eisbrücken des \hyperref[eis-daemon]{Eis-Dämons} versetzt werden.}

\fan{Spielt ihr mit mehreren Takuri-Hüterinnen, darf jede Takuri-Hüterin Spiegelscherben nutzen, unabhängig von ihrer Hoffnungskarte.}
...
\fan{Steht die Takuri-Hüterin bei oder angrenzend zu Geistern, kann sie die Steinflöte nicht nutzen. Steht der Takuri bei oder angrenzend zu Geistern, gibt er keine \hyperref[bonusstaerke]{Bonusstärke}. Für seine Bonusstärke ist es egal, ob die Takuri-Hüterin bei oder angrenzend zu Geistern steht.}

\fan{Der Takuri-Marker wird bewegt, wenn der Erzähler vorgesetzt wird, egal ob der Takuri bei oder angrenzend zu Geistern steht. Die Takuri-Hüterin darf den Takuri-Marker von +7 auf +5 zurücksetzen und die Steinflöte auf die Vorderseite drehen, auch wenn sie oder der Takuri bei oder angrenzend zu Geistern stehen.}
...
Ein Held, der mit dem Feld des Wassergeists steht, darf im Kampf, \fan{wenn er 1 oder mehr seiner Heldenwürfel werfen würde}, stattdessen den großen weißen Würfel statt all seiner Heldenwürfel werfen.
...
Das Messer des \hyperref[faehrtenleser]{Fährtenlesers} kann ihn nicht neu werfen.
\supercite{5460}
...
\subsection{Keine Takuri-Hüterin:}

Spricht eine Regel oder Karte aus "Magische Helden" von der Hüterin, ist damit die \hyperref[takuri-hueterin]{Takuri-Hüterin} gemeint und nicht Kheela (Kheelan).
...
Er darf Meeres- und Klippenfelder betreten.
\supercite{10815,dridn-begleitheft,dridn-faq} 

Das Schiff kann er nicht betreten.
\supercite{dridn-begleitheft}
...
\label{bergkrieger}
\heldenfigur{grent.jpg}{Fuchsia}
\vspace*{-1.8\baselineskip}
\begin{center}
    \footnotesize
    Als Bonus-Held (2023) und aus Das ferne Land (2025).
\end{center}
...
\supercite{114035,dfl-begleitheft}
...
\fan{Diese Effekte werden aktiviert, egal ob der Würfel durch den Wurf des Bergkriegers auf dieser Zahl landete oder weil er auf diese Seite gedreht (z.B. von der \hyperref[zauberin]{Zauberin}) oder neu geworfen (z.B. mit Messer) wurde.}

\fan{Effekte 1 und 3 gelten nur, wenn der Würfel des Bergkriegers am Ende eine 1 bzw. 3 zeigt, nicht, wenn dieser Würfel später weggedreht oder neu geworfen wird. Effekte 2 und 4 wirken sofort, auch wenn dieser Würfel später weggedreht oder neu geworfen wird.}
...
\fan{Im \hyperref[fernkaempfer]{Fernkampf} muss er zuerst seinen Heldenwürfel werfen und sich danach entschieden, ob er aufhört oder den Gegnerwürfel wirft.}

\fan{Wirft der Bergkrieger statt seiner Heldenwürfel einen Ersatzwürfel (z.B. den großen weißen Würfel der \hyperref[hueterin]{Hüterin}), werden keine Effekte aktiviert.}
...
\fan{Wird der Zeitstein durch Würfeleffekt 4 rückwärts von der 4. Stunde verschoben, wird kein Bewegungsplättchen aktiviert. Es ist durch Würfeleffekt 4 aber möglich, dass der Bergkrieger mehrere Bewegungsplättchen am selben Tag aktiviert.}
...
\supercite{ag-begleitheft}
\fan{Es ist durch Würfeleffekt 4 aber möglich, dass der Bergkrieger mehrere Kartographie-Marker am selben Tag aktiviert.}

\fan{Wird der Zeitstein durch Würfeleffekt 4 rückwärts auf eine Überstunde mit Gold und Kreatur verschoben, erhält er das Gold und die Kreatur wird eingewürfelt.}
...
\label{zauberin}
\heldenfigur{eara.jpg}{Fuchsia}
\vspace*{-1.8\baselineskip}
\begin{center}
    \footnotesize
    Aus Die Legenden von Andor (2012), Die letzte Hoffnung (2016), Adventures of Hadria (2017), Das Geheimnis des Königs (2019), Die ewige Kälte (2022), Big Box (2023) und Herz aus Eis (2023). Siehe auch \hyperref[dunkle-magierin]{Eara (Liphardus), die Dunkle Magierin}.
\end{center}
...
Das darf ein (z.B. mit Messer) neu geworfener Würfel sein.
...
Die Zauberin darf auch einen Ersatzwürfel drehen (z.B. den großen weißen Würfel der \hyperref[hueterin]{Hüterin}\supercite{5335}).
\supercite{dlva-begleitheft,dlva2-runensteine,dridn-begleitheft}

Sie darf auch den Runenwürfel der \hyperref[runenmeisterin]{Runenmeisterin} drehen\supercite{88563} (aber nicht für ihre Aktion "Runen befragen"), oder den nächsten Würfel der Würfelleiste des \hyperref[seher]{Sehers} (aber nicht für sein Sehendes Auge)\supercite{dh-faq}, oder einen rosa Würfel des \hyperref[steppennomade]{Steppennomaden}. Den Pyramidenwürfel des \hyperref[eis-daemon]{Eis-Dämons} kann sie nicht drehen.
\supercite{91842}
...
Nutzt Varkur die Dunkle Magie "Die Schwächung der Helden", kann die Zauberin im Endkampf keinen Würfel auf die gegenüberliegende Seite drehen.
\supercite{dlva3-die-schwaechung-der-helden}


\subsection{Ereigniskarte "Geheimer See" 9:}

Die Zauberin darf ihren Würfel auf die gegenüberliegende Seite drehen.
\supercite{dlva-ereigniskarte-geheimer-see-9}
...
Die Zauberin kann die großen schwarzen Würfel des Seeriesen\supercite{dridn10-turm-bewahrt} und den kleinen roten Geisterflammen-Würfel der Feuerzauberer\supercite{dridn10-geisterflammen} nicht drehen.
...
Die Zauberin erhält die 3 verschiedenen \hyperref[gegenstaende-und-sonderplaettchen]{Gegenstände} Zauberbücher mit der geschlossenen Seite oben.
...
\supercite{dlh-begleitheft,dlh11-heldenkarte-zauberer}
...
Versetzt eine Kreatur, einen Krahder, oder beliebig viele Skelette, die auf dem Feld der Zaubererin stehen, auf ein einzelnes angrenzendes Feld. Das geht nicht über Sprungfelder und nicht über Eisbrücken des \hyperref[eis-daemon]{Eis-Dämons}. Wird eine Kreatur versetzt, darf auf dem Zielfeld keine Kreatur sein.
\supercite{dlh11-heldenkarte-zauberer}
...
\subsection{\fan{Mehrere Zauberinnen:}}
\fan{Jede Zauberin mit ihrer offiziellen zweiten Sonderfähigkeit erhält 3 verschiedene Zauberbücher. Zauberbücher verschiedener Zauberinnen sind ununterscheidbar. Zauberinnen dürfen beliebige Zauberbücher, die sie tragen, nachlesen oder nutzen.}
...
\heldenfigur{eara-dunkel.jpg}{Fuchsia}
\vspace*{-1.8\baselineskip}
\begin{center}
    \footnotesize
    Als Bonus-Heldin (2016, \url{https://legenden-von-andor.de/zusatzheld-die-dunkle-eara/}). Siehe auch \hyperref[zauberin]{Eara (Liphardus), die Zauberin}.
\end{center}
...
Können nicht genug Willenspunkte abgeben werden, gibt stattdessen niemand Willenspunkte ab, die Heldenfigur und der Schatten werden nicht getauscht und der Schatten wird bis zum nächsten Sonnenaufgang hingelegt. Solange kann er nicht bewegt werden.
\supercite{dunkle-eara-regelkarte,dunkle-eara-heldenkarte}


\fan{Bringen mehrere Dunkle Magierinnen oder \hyperref[zauberin]{Zauberinnen} durch ihre offiziellen Heldenkarten einen Schatten ins Spiel, nutzt verschiedene Figuren. Jede Dunkle Magierin oder Zauberin kann nur ihren eigenen Schatten bewegen und nur mit ihrem eigenen Schatten die Position tauschen. Ihr dürft den Schatten unterschiedlich farbige Standfüße geben.}
...
\fan{Ist eine Blockade entlang der Pfeile (z.B. eine mit rotem X abgedeckte Brücke), überspringt die Kreatur den Halbskral nicht, sondern bleibt auf seinem Feld.}
...
\supercite{dh11-heldenkarte-halbskral}
...
Der Steppennomade ist ein \hyperref[fernkaempfer]{Fernkämpfer}.



\subsection{Kein Bogenschütze der Bewahrer:}

Spricht eine Regel oder Karte von der \hyperref[bogenschuetzin]{Bogenschützin}, ist der Steppennomade nicht gemeint.



\subsection{Treues Lasttier Sabri:}

Der Steppennomade hat eine \hyperref[helfer]{\fan{Helferin}}, die Figur "Sabri", die er aber nicht als eigene Aktion bewegen kann. Bewegt sich der Erzähler (\fan{egal ob vorwärts oder rückwärts}), läuft Sabri 1 Schritt auf dem kürzesten Weg zum Steppennomaden.
\supercite{mh-steppennomade}
Sie ignoriert Kreaturen.
\supercite{mh-begleitheft}
\fan{Gibt es keinen Weg zum Steppennomaden oder steht sie bereits bei ihm, läuft Sabri nicht.}
...
Die Pulver sind \hyperref[gegenstaende-und-sonderplaettchen]{\fan{Sonderplättchen}}.

Steht der Steppennomade auf Sabris Feld, darf er Pulver von seiner Heldentafel mit Sabri tauschen.
...
\supercite{mh-begleitheft}
Er kann jedes Pulver höchstens 1x pro Tag nutzen, benutzte Pulver aber immer noch tragen oder mit Sabri tauschen.
\supercite{88552}
\fan{So abgegebene Würfel fehlen ihm, auch wenn der \hyperref[faehrtenleser]{Fährtenleser} sein Horn nutzt}.
...
\supercite{mh-pulver}
Der Steppennomade und alle späteren Helden entscheiden einzeln, ob sie den Kampf verlassen wollen. Der Steppennomade muss immer für die Kampfstunde zahlen. Spätere Helden müssen dies nur, wenn sie weiterkämpfen. Eröffnete der Steppennomade den Kampf und verlassen alle Helden den Kampf, wird er abgebrochen. Wird der Kampf nicht abgebrochen, bestimmen alle späteren Helden, die den Kampf nicht verlassen haben, in Zugreihenfolge ihren Kampfwert (üblicherweise durch Würfeln), und der Gesamtkampfwert der Helden wird wie üblich mit dem (bereits bestimmten) Kampfwert des Gegners verglichen.
...
Der Steppennomade gibt einen \hyperref[gegenstaende-und-sonderplaettchen]{Gegenstand} aus dem Spiel, den er auf einem kleinen rechteckigen Ablagefeld oder seiner Helmablage trägt, \fan{egal auf welcher Seite der Gegenstand liegt}. Danach darf er einen anderen \fan{(z.B. nicht einen vollen für einen halbvollen Trinkschlauch)} Gegenstand von der Ausrüstungstafel erhalten. 
\supercite{mh-pulver}
...
Am Anfang der ersten Kampfrunde eines Kampfs, an dem der Steppennomade beteiligt ist, gegen eine Kreatur (keinen Endgegner\supercite{89624,90008}), die 4 oder mehr Willenspunkte hat\supercite{88552,89625}: Sie verliert 3 Willenspunkte. Der Steppennomade darf dann \fan{bis zu} 3 Willenspunkte auf die kämpfenden Helden verteilen. 
\supercite{mh-pulver}
...
Der Steppennomade kann keinen Gegnerwürfel (z.B. durch den Streifenmarder in "Die Reise in den Norden" oder Meres in "Die steinernen Drei") und keinen Ersatzwürfel (z.B. den großen weißen Würfel der \hyperref[hueterin]{Hüterin}) für Pulver abgeben.
...
\fan{Jeder Steppennomade wählt am Anfang, welche 3 verschiedenen Pulver er erhält und welche 2 anderen verschiedene Pulver er auf seine Sabri steckt. Jeder Steppennomade kann Pulver nur mit seiner Sabri tauschen, nicht mit anderen Steppennomaden oder anderen Sabris.}

\fan{Hat eine durch Schwächungspulver geschwächte Kreatur danach 4 oder mehr Willenspunkte, darf sie von einem anderen Schwächungspulver weiter geschwächt werden.}
...
\fan{Es gibt keine Ausrüstungstafel. Das Umwandlungspulver hat keinen Effekt.}
...
\fan{Nutzt Varkur die Dunkle Magie "Die Schwächung der Helden", wirft der Steppennomade genau einen rosa Würfel, außer er gab er bereits alle Würfel ab.}
...
\fan{Das Bannfeuer kann den Trunkenen Troll nicht hinlegen.}
...
Sabri darf Bootsstrecken in einem Schritt nutzen.
\supercite{mh-begleitheft}
...
\fan{Die drei magischen Waffen können nicht umgewandelt werden.}
...
\supercite{mh11-heldenkarte-steppennomade,94521}
...
Es gibt keine Ausrüstungstafel. \fan{Mit dem Umwandlungspulver kann der Steppennomade nur Trinkschläuche erhalten, und das erst, während der Erzähler auf "b" oder später steht.}
...
Es gibt keine Ausrüstungstafel. \fan{Mit dem Umwandlungspulver darf der Steppennomade einen Gegenstand von Feld 71 erhalten.}
...
\fan{Die Spitzhacke kann nicht umgewandelt werden.}
...
\fan{Das Händlerfeld wird blockiert. Das Umwandlungspulver hat keinen Effekt.}
...
Der Steppenreiter ist ein \hyperref[fernkaempfer]{Fernkämpfer}.
...
Spricht eine Regel oder Karte von der \hyperref[bogenschuetzin]{Bogenschützin}, ist der Steppenreiter nicht gemeint.


\subsection{Nicht Barz:}

Spricht eine Regel oder Karte vom \hyperref[steppennomade]{Steppennomaden}, ist der Steppenreiter nicht gemeint.
...
Der Bewahrer ist ein \hyperref[fernkaempfer]{Fernkämpfer}.


\subsection{Nur der drittbeste Bogenschütze:}

Spricht eine Regel oder Karte von der \hyperref[bogenschuetzin]{Bogenschützin}, ist der Bewahrer nicht gemeint.
...
Der Bewahrer darf sich vor der ersten Kampfrunde jedes Kampfes gegen einen auf der Kreaturenanzeige abgebildeten Gegner (keinen Endgegner) entscheiden, den Gegner zu schwächen. 
\supercite{nh-begleitheft}
Verschiebt den Stärkestein des Gegners auf das nächst linke Stärkefeld der Kreaturenanzeige \fan{mit einer kleineren Zahl}. Seine Stärkepunkte und Belohnung folgen nun diesem Feld. Ist da keine Belohnung abgebildet, gilt die nächst linke Belohnung der Kreaturenanzeige\supercite{dridn-begleitheft} (bzw. gar keine Belohnung, wenn er ganz links ist).
Wird der Gegner nicht besiegt, ist er im nächsten Kampf nicht mehr geschwächt (außer er wird erneut geschwächt).
...
\fan{Der Bewahrer kann Koram und von Koram gestärkte Gors schwächen. Die beiden Stärkestein-Verschiebungen heben sich auf und der Gor hat seine normalen Werte.}
...
\fan{In Krahd (Spielplan-Rückseite) sinken geschwächte Skelette von 1 Stärkepunkt auf 0 (keine Belohnung) und von 3 Stärkepunkten auf 1 (normale Belohnung).}
...
\subsection{\fan{Wargors:}}

\fan{Geschwächte Wargors sinken auf 0 Stärkepunkte und geben keine Belohnung. }
...
\fan{Das Horn des \hyperref[faehrtenleser]{Fährtenlesers} hat keinen Effekt auf die Runenmeisterin.}
...
\fan{Im \hyperref[fernkaempfer]{Fernkampf} muss sie zuerst ihre Runenscheibe drehen und sich danach entschieden, ob sie beim erhaltenen Speichenwert aufhört oder den Gegnerwürfel wirft.}


\fan{Wirft die Runenmeisterin statt ihres Heldenwürfels einen Ersatzwürfel (z.B. den großen weißen Würfel der \hyperref[hueterin]{Hüterin}), wird die Runenscheibe nicht gedreht und kein Speichenwert gewertet, sondern der Wert des Ersatzwürfels.} 
...
\subsection{\fan{Zu viel Wasser bringt keine Stärke:}}

\fan{An einem von der Runenmeisterin aufgefrischten Brunnen-/Quellenplättchen kann der \hyperref[tarus]{Tarus} bis Tagesende keinen Stärkepunkt statt Willenspunkten erhalten.}
\supercite{137438}
...
\fan{Die Runenmeisterin kann große blaue Einführungsplättchen nicht mit dem Brunnen-Symbol auffrischen.}
...
\fan{Ihr dürft am Anfang mancher Legenden, in denen keine Runensteine eingewürfelt würden, dennoch Runensteine einwürfeln. Mischt dann verdeckt drei zusätzliche Runensteine (blau, gelb und grün; wie üblich kleine rechteckige \hyperref[gegenstaende-und-sonderplaettchen]{Gegenstände}). Bestimmt mit je 1 Kreaturenwürfel (10er-Stelle) und Heldenwürfel (1er-Stelle) die Positionen von 2 dieser Runensteine. Nehmt den dritten Runenstein verdeckt aus dem Spiel.}
\supercite{128652}
...
Hat das Schiff den zweiten Mast, darf sie bis zu doppelt so weit segeln.
\supercite{90070}
...
\fan{Für Kenvilars Tücke "nur gerade Würfelwerte" geht es nicht um den Wert des Runenwürfels, sondern den Speichenwert der Runenscheibe. Ist dieser ungerade, zählt er nicht.}
...
In Legende 11 wird die Runenscheibe bei der Erfüllung der Heldenaufgabe auf ihre Rückseite gedreht.\supercite{mh11-heldenkarte-runenmeisterin} Für Legenden 12 bis 17 liegt die Runenscheibe vom Anfang an auf der Rückseite.\supercite{mh-begleitheft} Die Speichenreihenfolge der Rückseite ist:
...
\bullet{} Anzahl Willenspunkte: Ein beliebiger\supercite{mh11-heldenkarte-runenmeisterin} Held erhält \fan{bis zu} so viele Willenspunkte, egal wo er steht und ob er seinen Tag bereits beendet hat.
...
Die Runenmeisterin kann die Quelle auf Feld 37 nicht mit dem Brunnen-Symbol auffrischen.
...
\fan{Ein von der \hyperref[feuerwaechterin]{Feuerwächterin} getragenes Feuer kann so nicht entfacht werden.}
...
\label{feuerwaechterin}
\heldenfigur{tenaya-feuerwaechterin.jpg}{ForestGreen}
\vspace*{-1.8\baselineskip}
\begin{center}
    \footnotesize
    Aus Die ewige Kälte (2022). Siehe auch \hyperref[feuerbezwingerin]{Tenaya (Teyan), die Feuerbezwingerin}.
\end{center}
...
\fan{Das Hadrische Brennholz ist ein kleiner rechteckiger \hyperref[gegenstaende-und-sonderplaettchen]{Gegenstand}. Nur die Feuerwächterin kann es als freie Handlungsmöglichkeit nutzen, und nur, wenn ihr großes Ablagefeld frei ist. Dann muss sie das Hadrische Brennholz aus dem Spiel geben und 2 Willenspunkte abgeben und darf ein Feuerplättchen mit der brennenden Seite oben als \hyperref[gegenstaende-und-sonderplaettchen]{\fan{Sonderplättchen}} auf ihr großes Ablagefeld legen.}

\fan{Das Hadrische Brennholz kann nicht genutzt werden, um ein Feuer auf ein Spielplanfeld zu legen.}
...
Solange die Feuerwächterin ein brennendes Feuer trägt, haben alle Helden, die auf ihrem Feld stehen, je +1 \hyperref[bonusstaerke]{Bonusstärke}. Der \hyperref[krieger]{Krieger} hat +2 \hyperref[bonusstaerke]{Bonusstärke} (statt +1).
\supercite{dek-begleitheft} 

Die Feuerwächterin darf ein von ihr getragenes erloschenes Feuer entfachen, indem sie 2 Willenspunkte abgibt.\supercite{dek-begleitheft} Andere Helden können dies nicht.\supercite{105294}

Die Feuerwächterin darf ein von ihr getragenes Feuer jederzeit aus dem Spiel nehmen.
\supercite{117803}

Während die Feuerwächterin Feuer trägt, ist ihr großes Ablagefeld besetzt. \fan{Erhält die Feuerwächterin einen großen ovalen Gegenstand, darf sie sich entscheiden, ob sie das Feuer aus dem Spiel nimmt oder den großen Gegenstand auf ihrem Feld zurücklässt.}

\fan{Die \hyperref[wassermagierin]{Wassermagierin} kann sich nicht von oder zu einem von der Feuerwächterin getragenen Feuer teleportieren.}


\columnbreak
\subsection{\fan{Mehrere Feuerwächterinnen:}}

\fan{Legt am Anfang 1 Feuerplättchen pro Feuerwächterin bereit. Jede Feuerwächterin erhält ein Hadrisches Brennholz. Alle Hadrischen Brennhölzer sind ununterscheidbar und dürfen von allen Feuerwächterinnen genutzt werden. Eine Feuerwächterin darf mehrmals pro Legende ein Hadrisches Brennholz nutzen.}

\fan{Auch wenn mehrere Feuerwächterinnen auf demselben Feld stehen und brennende Feuer tragen, erhält jeder Helden nur einmal \hyperref[bonusstaerke]{Bonusstärke} und bei Sonnenaufgang nur einmal 5 Willenspunkte.}
...
\fan{Trägt die Feuerwächterin ein Feuer, geht dieses aus dem Spiel. Für den Rest der Legende kann sie kein Feuer mehr tragen.}
...
\fan{Die Eule kann nicht an die Feuerwächterin geschickt werden, während sie Feuer trägt, da ihr großes Ablagefeld dann nicht frei ist.}
...
Ist das große Ablagefeld der Feuerwächterin frei, darf sie ein normales Brennholz und 2 Willenspunkte abgeben, um ein Feuerplättchen mit der brennenden Seite oben als \hyperref[gegenstaende-und-sonderplaettchen]{\fan{Sonderplättchen}} auf ihr großes Ablagefeld zu legen. Sie kann keine Feuer vom Spielplan aufnehmen.

Andere Helden können kein Feuer auf das große Ablagefeld der Feuerwächterin legen, auch nicht durch Abgabe von Brennholz und Willenspunkten.
\supercite{105294}
...
Steht die Feuerwächterin bereits auf dem Feld eines brennenden Feuers, gibt ein von ihr getragenes Feuer weder Willenspunkte noch \hyperref[bonusstaerke]{Bonusstärke}.
\supercite{101489}

\fan{Das Brunnen-Symbol der \hyperref[runenmeisterin]{Runenmeisterin} kann ein von der Feuerwächterin getragenes Feuer nicht entfachen.}



\subsection{Legende 4, Die Pranken des Winters:}

Auch für ein von der Feuerwächterin getragenes brennendes Feuer dürft ihr Takotas Stärkestein um 1 nach links verschieben.
...
Steht die Feuerwächterin auf der Zeltstadt (Feld 401), der Pfahlbausiedlung (Feld 460) oder dem Greifenfelsen (Feld 425), während sie ein brennendes Feuer trägt, wirkt der Effekt dieses Orts, auch wenn kein brennendes Feuer auf dem Feld liegt.
...
\subsection{\fan{Checkliste:}}

\fan{Die Feuerwächterin erhält keine Feuerzauber.}


\subsection{\fan{Geister:}}

\fan{Steht die Feuerwächterin bei oder angrenzend zu Geistern, kann sie kein Feuer auf ihr großes Ablagefeld legen, kann sie kein von ihr getragenes erloschenes Feuer entfachen und gibt ein von ihr getragenes Feuer weder Willenspunkte noch \hyperref[bonusstaerke]{Bonusstärke}.}

\fan{Ein von ihr getragenes Feuer wird beim Sonnenaufgang auf die erloschene Seite gedreht, auch wenn sie bei oder angrenzend zu Geistern steht.}
...
\heldenfigur{tenaya.jpg}{ForestGreen}
\vspace*{-1.8\baselineskip}
\begin{center}
    \footnotesize
    Aus Das ferne Land (2025). Siehe auch \hyperref[feuerwaechterin]{Tenaya (Teyan), die Feuerwächterin}.
\end{center}
...
Die 3 Feuerzauber sind \hyperref[gegenstaende-und-sonderplaettchen]{\fan{Sonderplättchen}}.
...
Bei Sonnenaufgang, direkt vor dem Erzähler-Symbol, werden alle Feuerzauber auf die gelöschte Seite gedreht, egal ob das Erzähler-Symbol ausgeführt wird.


\subsection{Bannfeuer (violett):}

Steht die Feuerwächterin mit brennendem Bannfeuer auf dem Feld einer Kreatur (keines Endgegners), läuft diese bei ihrem Sonnenaufgang-Feld-Symbol nicht. \fan{Durch einen Ereigniskarten-Effekt kann sie weiterhin laufen.}
...
Die Feuerbezwingerin kann den Feuerstoß nur direkt vor einer Kampfrunde, in der sie mitkämpft, entfachen. Die Feuerbezwingerin hat nur in dieser Kampfrunde +2 \hyperref[bonusstaerke]{Bonusstärke}.
...
\fan{Jede Feuerbezwingerin erhält am Anfang ihre eigenen 3 Feuerzauber.}
...
Ein eigenes Symbol "Feuerzauber" auf dem Sonnenaufgang-Feld erinnert ans Erlöschen der Feuerzauber.
...
\fan{Feuerzauber werden bei Sonnenaufgang gelöscht, auch wenn sie bei oder angrenzend zu Geistern steht.}
...
\label{zeitzauberer}
\heldenfigur{kirr.jpg}{Fuchsia}
\vspace*{-1.8\baselineskip}
\begin{center}
    \footnotesize
    Als Bonus-Held (2015, \url{https://legenden-von-andor.de/bonus-legende-die-rueckkehr-der-schwarzen-kogge/}).
\end{center}
...
Hat der Zeitzauberer 10 oder mehr Willenspunkte, erhält er pro Stunde, die sein Zeitstein (nachdem er für die Kampfrunde vorgesetzt wurde) von der 4. Stunde entfernt ist, +1 \hyperref[bonusstaerke]{Bonusstärke}. Zum Beispiel hat er +3 \hyperref[bonusstaerke]{Bonusstärke}, wenn sein Zeitstein auf der 1. oder 7. Stunde liegt.
\supercite{bl-rdsk-kirr}
...
\fan{Nutzt der Zeitzauberer in einer Kampfrunde Merriks neutralen Zeitstein, zählt für die Bonusstärke dessen Endposition (nach etwaigen Bewegungen durch andere Helden) statt die des farbigen Zeitsteins.}
...
\fan{Steht der Zeitzauberer bei oder angrenzend zu Geistern, erhält er keine \hyperref[bonusstaerke]{Bonusstärke} durch Zeitzauberei. Es ist egal, ob der Gegner bei oder angrenzend zu Geistern steht.}
...
Steht der Knochen-Golem im Kampf auf dem Feld des Gegners, gibt er +6 \hyperref[bonusstaerke]{Bonusstärke}.
\supercite{dh-knochen-golem}


Legt den Knochen-Golem, während er nicht im Spiel ist, auf das Feld für besiegte Kreaturen.
\supercite{dh-knochen-golem}
Er darf erst bewegt werden, nachdem er durch eine Beschwörung aufgestellt wurde, \fan{auch wenn das Feld für besiegte Kreaturen durch eine Eisbrücke des \hyperref[eis-daemon]{Eis-Dämons} angrenzend an ein anderes Feld gemacht wurde.}
...
Ist die Beschwörerin am Sieg über eine Kreatur (keinen Endgegner) beteiligt, während der Knochen-Golem nicht im Spiel ist, darf sie nach einer etwaigen Belohnung, aber vor einer etwaigen Erzählerbewegung, den Knochen-Golem beschwören. Dazu wirft sie einen Kreaturenwürfel (10er-Stelle) und einen Heldenwürfel (1er-Stelle) und stellt die Kreatur und den Knochen-Golem auf das so ermittelte Feld.
\supercite{dh-knochen-golem}
...
Wie Helden kann der Knochen-Golem die Rietburg erst betreten, nachdem sie von Kreaturen befreit wurde.
\supercite{dh-faq}
...
\supercite{dh11-heldenkarte-beschwoerer}
...
Der Knochen-Golem kann das Lager der Trolle nicht betreten.
\supercite{dz-begleitheft}
...
\fan{Der Knochen-Golem gibt keine \hyperref[bonusstaerke]{Bonusstärke}, wenn er bei oder angrenzend zu Geistern steht. Sofern er selbst nicht bei oder angrenzend zu Geistern steht, gibt er seine Bonusstärke, auch wenn die Beschwörerin bei oder angrenzend zu Geistern steht.}
...
\chapter{Regeln für Ablagen/Leisten}
...
Manche Helden können nicht so viele Stärkepunkte oder Willenspunkte haben wie andere. Manche Effekte (z.B. der Feuerschild in "Die letzte Hoffnung" oder der Casamatuc in "Alte Geister") können sie im Laufe einer Legende beschränken.

Würde ein Held mehr Stärkepunkte oder Willenspunkte erhalten, als er haben kann, verfallen die überschüssigen Punkte. 

Manche Legenden sind ohne Spielvarianten kaum zu gewinnen, wenn ihr nur Helden mit zu kurzen Stärkeleisten spielt. Ein Beispiel ist Legende 17 mit der \hyperref[zauberin]{Zauberin} und dem \hyperref[eis-daemon]{Eis-Dämon}. \fan{Nutzt in solchen Fällen Spielvarianten für zusätzliche \hyperref[bonusstaerke]{Bonusstärke}:}

\href{https://legenden-von-andor.de/mini-erweiterung-das-licht-der-fuenften-stunde/}
{\blacktriangleright Mini-Erweiterung \enquote{Das Licht der fünften Stunde}}

\href{https://legenden-von-andor.de/forum/viewtopic.php?p=129669#p129669}
{\blacktriangleright \fan{Fan-Spielvarianten-Sammlung \enquote{Fan-Spielvarianten für für Siege fast erforderliche Sonderstärke}}}
...
\fan{Ein Held, der seine höchste Anzahl Stärkepunkte hat, darf einen einzelnen Holzstamm tragen, auch wenn dieser links über seine Stärkeleiste hinausragt. Er kann dann aber nicht mehrere Holzstämme gleichzeitig tragen. Das geht nicht, wenn ein Effekt (z.B. der \hyperref[hautwandler]{Hautwandler} als Bär) ihm das Tragen verbietet.} 
...
\fan{Kann ein Feld von Helden nur mit genug Willenspunkten betreten werden (z.B. das Lager der Trolle in "Düstere Zeiten" oder die Höhle der Verwandlung in "Die ewige Kälte"), darf ein Held, der die höchste Willenspunkte-Anzahl seiner Heldentafel hat, dieses Feld immer betreten, auch wenn diese Anzahl nicht genug wäre.}

\fan{Kann eine Verbindung zwischen zwei Feldern von Helden nur mit genug Willenspunkten überquert werden (z.B. Sprungfelder in "Die letzte Hoffnung" oder der steile Felsen in "Das ferne Land"), darf ein Held, der die höchste Willenspunkte-Anzahl seiner Heldentafel hat, dieses Verbindung immer überqueren, auch wenn diese Anzahl nicht genug wäre.}
...
\fan{Haben alle (!) Helden kein großes Ablagefeld, gilt folgendes (die \hyperref[feuerwaechterin]{Feuerwächterin} und der \hyperref[hautwandler]{Hautwandler} gelten hierfür immer als ein großes Ablagefeld habend):}
...
\bullet{} die Kampfblitze des \hyperref[eis-daemon]{Eis-Dämons},

\bullet{} das Feuer der \hyperref[feuerwaechterin]{Feuerwächterin},
...
\bullet{} andere Kampfstärke ändernden Effekte, die Stärkesteine nicht verschieben (z.B. durch Gegenstände, unterstützende Figuren wie \hyperref[helfer]{\fan{Helfer}}, das Licht der fünften Stunde, den Bannkreis von Choranat oder die Bruderfeuer).
...
\supercite{dlva3-der-verhexte-gor}
...
\supercite{dridn9-kenvilars-tuecke}
...
\chapter{Regeln für Gegenstände/\fan{Sonderplättchen}}
\label{gegenstaende-und-sonderplaettchen}
...
Als \textbf{Gegenstände} gelten:


\bullet{} der Kessel der \hyperref[bogenschuetzin]{Bogenschützin} (zweite Sonderfähigkeit),

\bullet{} die Rietgraskrone der \hyperref[bogenschuetzin]{Bogenschützin} (Hoffnungskarte),

\bullet{} \fan{das Hadrische Brennholz der \hyperref[feuerwaechterin]{Feuerwächterin},}

\bullet{} der Armreif des \hyperref[hautwandler]{Hautwandlers} (zweite Sonderfähigkeit),

\bullet{} \fan{zusätzliche Runensteine der \hyperref[runenmeisterin]{Runenmeisterin},}

\bullet{} der Runenhelm der \hyperref[runenmeisterin]{Runenmeisterin} (Hoffnungskarte),

\bullet{} \fan{der treue Streifenmarder des \hyperref[seekrieger]{Seekriegers},}

\bullet{} die Steinflöte der \hyperref[takuri-hueterin]{Takuri-Hüterin},

\bullet{} die Scherben der \hyperref[takuri-hueterin]{Takuri-Hüterin} (Hoffnungskarte),

\bullet{} die Takuri-Federn der \hyperref[takuri-hueterin]{Takuri-Hüterin} (zweite Sonderfähigkeit),

\bullet{} die Zauberbücher der \hyperref[zauberin]{Zauberin} (zweite Sonderfähigkeit).
\bigskip




Als \textbf{\fan{Sonderplättchen}} gelten:

\bullet{} die Eisblitze des \hyperref[eis-daemon]{Eis-Dämons},

\bullet{} Rabe, Messer und Horn des \hyperref[faehrtenleser]{Fährtenlesers},

\bullet{} ein von der \hyperref[feuerwaechterin]{Feuerwächterin} getragenes Feuer,

\bullet{} die Feuerzauber der \hyperref[feuerbezwingerin]{Feuerbezwingerin},

\bullet{} die Pulver des \hyperref[steppennomade]{Steppennomaden}.
...
\subsection{Spielplan-Felder:}
Gegenstände dürfen auf einem Feld abgelegt und von einem Feld aufgenommen werden.

Sonderplättchen können nicht auf einem Feld abgelegt oder von einem Feld aufgenommen werden.
\supercite{117803}

\subsection{Andere Helden:}
Gegenstände dürfen von anderen Helden getragen werden, sofern sie ein passendes Ablagefeld haben, selbst wenn sie dessen Fähigkeit nicht nutzen können.

Ausnahme: Die Rietgraskrone kann nur von ihrer \hyperref[bogenschuetzin]{Bogenschützin} getragen werden.

Nur der \hyperref[hautwandler]{Hautwandler} hat ein Armreif-Ablagefeld.

Nur die \hyperref[zauberin]{Zauberin} hat Ablagefelder für Zauberbücher.

Kleine Gegenstände dürfen per Falke/Eule verschickt werden.

Sonderplättchen können nicht von anderen Helden getragen und nicht verschickt werden. \fan{Auch im Spiel mit mehreren gleichen Helden kann ein Held Sonderplättchen nicht einem anderen Helden derselben Sonderfähigkeit geben.}
...
Scheidet ein Held aus (z.B. weil er in Cavern auf 0 Willenspunkte fiel), werden von ihm getragene Gegenstände auf sein Feld gelegt. \fan{Von ihm getragene Sonderplättchen gehen aber aus dem Spiel.}


\subsection{Legende 5, Der Zorn des Drachens:}

Bei der Drachenkampfkarte „Gegenstand in 2 Stärkepunkte tauschen“ darf ein Held von ihm getragene Gegenstände in Stärke tauschen. Sonderplättchen können nicht in Stärke getauscht werden.
\supercite{6952}

\subsection{Bonus-Legende "Die Befreiung der Mine":}

Taucht Varkur bei der Karte "Varkurs Versteck" in der Waffenkammer auf, können Helden im Kampf gegen ihn keine Gegenstände nutzen. Sonderplättchen dürfen weiterhin genutzt werden.
\supercite{6952}
...
Wird der verhexte Held enttarnt, darf er von ihm getragene Gegenstände in Stärke tauschen.
\supercite{dlh15-verhext}

\fan{Von ihm getragene Sonderplättchen gehen aber aus dem Spiel und werden nicht zu Stärke.}
...
\subsection{Weiße Ereigniskarte 8:}

Ein Gegenstand darf eingetauscht werden.
\fan{Der Streifenmarder und} die Steinflöte können nur auf ihrer Vorderseite (d.h. unbenutzt/aufgefrischt) eingetauscht werden. 
\supercite{bb-ereigniskarte-8}

\fan{Ein Sonderplättchen kann nicht eingetauscht werden.}
...
Gegenstände dürfen bei Händlern getauscht werden.
\fan{Der Streifenmarder und die Steinflöte können nur auf ihrer Vorderseite (d.h. unbenutzt/aufgefrischt) getauscht werden.}

\fan{Sonderplättchen können nicht getauscht werden.}
...
\bullet{} den Knochen-Golem der \hyperref[beschwoererin]{Beschwörerin},

\bullet{} den Wassergeist der \hyperref[hueterin]{Hüterin},

\bullet{} die Sabri des \hyperref[steppennomade]{Steppennomaden},

\bullet{} den Takuri der \hyperref[takuri-hueterin]{Takuri-Hüterin},

\bullet{} den Schatten der \hyperref[zauberin]{Zauberin} (Hoffnungskarte),

\bullet{} den Schatten der \hyperref[dunkle-magierin]{Dunklen Magierin} (zweite Sonderfähigkeit),

\bullet{} den Radan des \hyperref[zwerg]{Zwergs} (Hoffnungskarte).
...
Ein Held darf als eigene Aktion 1 oder mehr Stunden ausgeben und seinen Helfer pro Stunde bis zu 4 Felder weit bewegen.\supercite{nh-begleitheft,dlh17-hoffnungskarte-zwerg,dunkle-eara-regelkarte}

Ausnahme: Sabri kann nicht als eigene Aktion bewegt werden. Bewegt der Erzähler sich (egal ob vorwärts oder rückwärts), läuft Sabri 1 Schritt auf dem kürzesten Weg zum \hyperref[steppennomade]{Steppennomaden}. \fan{Gibt es keinen Weg zum Steppennomaden oder steht sie bereits bei ihm, läuft Sabri nicht.}

Ausnahme: Der Takuri kann nicht als eigene Aktion bewegt werden. Nur die \hyperref[takuri-hueterin]{Takuri-Hüterin} darf die Steinflöte von der Vorderseite auf die Rückseite drehen, um den Takuri auf ein beliebiges Spielplanfeld zu versetzen.

Helfer dürfen Eisbrücken des \hyperref[eis-daemon]{Eis-Dämons} nutzen.
\supercite{88780}

Helfer können keine Plättchen oder Karten aufdecken oder aktivieren.
\supercite{nh-begleitheft,dlh17-hoffnungskarte-zwerg,dh-begleitheft,mh-begleitheft}
...
Kann eine Verbindung zwischen zwei Feldern von Helden nur mit genug Willenspunkten überquert werden (z.B. Sprungfelder in "Die letzte Hoffnung" oder der steile Felsen in "Das ferne Land"), darf ein Helfer diese Verbindung immer nutzen.
\supercite{dlh17-hoffnungskarte-zwerg,dh-begleitheft,94521}


\subsection{Festhaltende Plättchen und Figuren:}

Helfer werden von festhaltenden Plättchen und Figuren (z.B. Skeletten in "Die letzte Hoffnung" oder Spornen in "Das ferne Land") nicht verfolgt oder festgehalten.\supercite{dlh17-hoffnungskarte-zwerg,ag-begleitheft,mh-begleitheft}
...
Besagt eine Aufgabe oder Regel, dass ein Held einen Gegner alleine bekämpfen oder besiegen soll oder dass ein Held nicht gemeinsam kämpfen darf, darf er dennoch \hyperref[bonusstaerke]{Bonusstärke} und Kampf-Effekte durch Helfer erhalten.
\supercite{stsch-varkurs-triumph,5623,17369}

Besagt eine Aufgabe oder Regel, dass ein Held am Sieg über einen Gegner beteiligt sein soll, muss der Held selbst mitkämpfen. Es genügt nicht, wenn sein Helfer den Kampf beeinflusst.
\supercite{28472}
...
Helfer dürfen durch ein rotes X oder Geröll blockierte Brücken weiterhin überqueren.
\supercite{15332,ag-begleitheft,mh-begleitheft}


\subsection{Geröll:}

Helfer dürfen Geröll ignorieren und Geröllfelder betreten.
\supercite{6937,97438,ag-begleitheft,mh-begleitheft}

\fan{Helfer geben ihre \hyperref[bonusstaerke]{Bonusstärke} auch gegen Geröll. Der Knochen-Golem ausnahmsweise auch, wenn er angrenzend steht.}



\subsection{Ausscheiden:}

Scheidet ein Held aus (z.B. weil er in Cavern auf 0 Willenspunkte fiel), geht sein Helfer aus dem Spiel.
\supercite{35653}

\fan{Auch von Sabri getragene Pulver gehen aus dem Spiel.}
...
\fan{Helfer dürfen die Rietburg (Feld 0) immer betreten, auch wenn sie von Kreaturen besetzt ist.}
\supercite{mh-begleitheft}

\fan{Ausnahme:} Wie Helden kann der Knochen-Golem die Rietburg erst betreten, nachdem sie von Kreaturen befreit wurde.
\supercite{dh-faq}
...
Ausnahme: Der Wassergeist darf Meeres- und Klippenfelder betreten.
\supercite{10815,dridn-begleitheft,dridn-faq} 


\subsection{Schiff:}

\fan{Helfer dürfen das Schiff mit einem Schritt betreten oder verlassen (von/zu einem Landfeld).}
\supercite{mh-begleitheft}

\fan{Ausnahme:} Der Wassergeist kann das Schiff nicht betreten.
\supercite{dridn-begleitheft}

\fan{Ausnahme:} Der Takuri darf das Schiff betreten und verlassen, auch wenn es nicht an ein Landfeld angrenzt.
\supercite{88939}

Helfer können nicht segeln.
\supercite{32649}

\fan{Der Knochen-Golem gibt seine \hyperref[bonusstaerke]{Bonusstärke} auch, wenn er auf dem Schiff angrenzend zum Gegner steht.}

\fan{Nur Helden können Schiffsausbauten bemannen, keine Helfer.}


\subsection{Bootsstrecken:}

\fan{Helfer dürfen für je 2 Schritte Bootsstrecken benutzen.}
\supercite{bl-rdsk-der-unbekannte-krieger}

\fan{Ausnahme:} Sabri darf Bootsstrecken für je 1 Schritt nutzen (statt 2).
\supercite{mh-begleitheft}
...
\fan{Wird der verhexte Held enttarnt, geht sein Helfer aus dem Spiel.}
...
Ein Helfer darf mit dem Casamatuc versetzt werden, wenn er mit dem Helden, der den Casamatuc nutzt, auf demselben Feld steht. 
\supercite{ag-begleitheft}
...
\fan{Auch der Wassergeist darf das Boot betreten.}
...
Helfer dürfen für je 1 Schritt zwischen zwei offenen Zwergentüren mit passenden Symbolen laufen.



\subsection{Lager der Trolle:}

Helfer dürfen das Lager der Trolle betreten.
\supercite{dz-begleitheft,mh-begleitheft,130389}

Ausnahme: Der Knochen-Golem kann das Lager der Trolle nicht betreten.
\supercite{dz-begleitheft}
...
\fan{Helfer dürfen Seefelder betreten, egal ob dort Eisplättchen liegen.}

\fan{Ausnahme: Sabri kann Seefelder nicht betreten, egal ob dort Eisplättchen liegen. Nur wenn sie bereits auf einem Seefeld oder Feld 460 steht, darf sie Seefelder auf einem kürzesten Weg zum Ufer betreten, erneut egal ob dort Eisplättchen liegen.}
...
\fan{Die Schwarzen Ritter verfolgen keine Helfer.}


\subsection{Schachtelboden:}

\fan{Helfer dürfen die Pfahlbausiedlung und die geheime Trollhöhle betreten.}
...
\href{https://legenden-von-andor.de/forum/viewtopic.php?p=132952#p132952}
{\blacktriangleright \fan{Mithasis, erquickendes Kraut} (Butterbrotbär\&Mivo)}
...
\href{https://legenden-von-andor.de/forum/viewtopic.php?p=130491#p130491}
{\blacktriangleright \fan{Farbige Zeitsteine bei 5 bis 6 Helden} (Mivo)}
...
\fan{Spielt am Anfang ganz ohne Spielvarianten für 5 oder 6 Helden. Erreicht der Erzähler "C", wählt eine (!) der Spielvarianten "Erschwerte Kämpfe" für den Rest der Legende. Es kommt in dieser Legende keine Spielvariante "Weniger Zeit" ins Spiel.}
...
\supercite{dh-sporne,dh17-a0-5-6}
...
\supercite{dh13-e-5-6,mh-dlh-5-6}
...
\supercite{dh14-c-5-6,mh-dlh-5-6}
...
\supercite{dh-begleitheft}
Spielt ihr mit dem Schwarzen Augenwürfel, wirft Nomion diesen nicht.
\supercite{dh14-der-einsame-turm-2}


\subsection{Legende 15, Der vergiftete Geist:}

Es gibt wie üblich 1 goldenen Schild, obwohl es bei 4 Helden ausnahmsweise 2 goldene Schilde gäbe.
\supercite{dlh15-a4-5-6,mh-dlh-5-6}
...
Die Bewegung des Trosswagens kostet:
\supercite{dh16-a2-5-6,mh-dlh-5-6}
...
\supercite{dh17-a0-5-6,mh-dlh-5-6}
...
\fan{Spielt am Anfang ganz ohne Spielvarianten für 5 oder 6 Helden. Erreicht der Erzähler "D", wählt eine (!) der Spielvarianten "Erschwerte Kämpfe" für den Rest der Legende. Es kommt in dieser Legende keine Spielvariante "Weniger Zeit" ins Spiel.}
...
\begin{tabular}[t]{|c|c|c|c|}
    ...
    \multicolumn{2}{|c|}{(Rabe des \hyperref[faehrtenleser]{Fährtenlesers}, Flaps Flederfuchs, Kapuze)}
    & \multicolumn{2}{|c|}{}\\
    \hline
    ...
    \begin{minipage}[t][][t]{0.22\textwidth}
        ...
        \bullet{} Kreaturenplättchen (auf dem Spielfeld)\supercite{bl-bdm-a}
        ...
        \bullet{} Pergamente\supercite{bl-kuc-a}
    ...
    \begin{minipage}[t][][t]{0.22\textwidth}
        ...
        \bullet{} Höhlenplättchen\supercite{dlh-begleitheft,dlh-ausruestungstafel}
        
        \bullet{} Schneeplättchen\supercite{dridn-begleitheft}\\(Die Reise in den Norden)

        \bullet{} Pilze\footnote{Deckt \fan{der Rabe des \hyperref[faehrtenleser]{Fährtenlesers} oder} Flaps Flederfuchs den "-3" Pilz auf, geht er für den Rest der Legende aus dem Spiel.\supercite{dfl-begleitheft}}\\(Das ferne Land)
    ...
    \begin{minipage}[t][][t]{0.22\textwidth}
        ...
        \bullet{} \fan{Eisplättchen\supercite{dek-begleitheft,dek2-gegenstaende}\\(Die ewige Kälte)}
    ...
    \begin{minipage}[t][][t]{0.23\textwidth}
        ...
        \bullet{} Bauern\footnote{Ausnahme: In der Bonus-Legende "Die Eskorte des Königs" sind Bauern von fern aufdeckbar.\supercite{bl-edk-a}}/Iquar
...
\bullet{} Der Rabe des \hyperref[faehrtenleser]{Fährtenlesers} darf \fan{beliebig viele} von nah aufdeckbare Plättchen auf einem Feld aufdecken.
...
\supercite{dlh-ausruestungstafel}
\bigskip
