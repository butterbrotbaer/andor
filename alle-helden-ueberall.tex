...
\begin{titlepage}
    ...
    \heldenfigurenlink{ijsdur.jpg}{white}{Eis-Dämon}
    ...
    \heldenfigurenlink{fenn.jpg}{orange}{Fährtenleser}
    ...
    \heldenfigurenlink{chada.jpg}{ForestGreen}{Bogenschützin}
    \heldenfigurenlink{ach.jpg}{orange}{Takuri-Hüterin}
    \heldenfigurenlink{kheela.jpg}{white}{Hüterin}
    ...
    \heldenfigurenlink{tenaya-feuerwaechterin.jpg}{ForestGreen}{Feuerwächterin}
    \heldenfigurenlink{tenaya.jpg}{ForestGreen}{Feuerbezwingerin}
    \heldenfigurenlink{kirr.jpg}{Fuchsia}{Zeitzauberer}
    \heldenfigurenlink{darh.jpg}{Wheat1}{Beschwörerin}
\end{titlepage}
...
\bullet{} Die \hyperref[Gegenstände und Sonderplättchen]{Regeln für Gegenstände/\fan{Sonderplättchen}}.
...
Eisblitze sind \hyperref[Gegenstände und Sonderplättchen]{\fan{Sonderplättchen}}. 
...
\fan{Steht der Wolfskrieger bei oder angrenzend zu Geistern, erhält er keine \hyperref[Bonusstärke]{Bonusstärke} durch Geländekunde und Trollhass. Es ist egal, ob sein Gegner bei oder angrenzend zu Geistern steht.}
...
Der Zwerg darf im Kampf, direkt nach seinem Würfeln, beliebig viele Willenspunkte abgeben, um nur in dieser Kampfrunde so viel \hyperref[Bonusstärke]{Bonusstärke} zu erhalten. 
\supercite{gdk}
...
Ein brennendes Feuer (auf seinem Feld oder von der \hyperref[Feuerwächterin]{Feuerwächterin} getragen) gibt dem Krieger +2 \hyperref[Bonusstärke]{Bonusstärke} (statt +1).
...
Nur der Fährtenleser kann Rabe, Messer und Horn tragen. Sie sind \hyperref[Gegenstände und Sonderplättchen]{\fan{Sonderplättchen}}.
\supercite{6952}
...
Ist er am Zug und steht nicht auf einem Waldfeld, muss er 1 Schritt in Richtung des nächstgelegenen Waldfelds mit der kleinsten Feldzahl laufen. Dafür darf er auch Eisbrücken des \hyperref[Eis-Dämon]{Eis-Dämons} nutzen. \fan{Dafür darf er Verbindungen zwischen zwei Feldern überqueren, die von Helden nur mit genug Willenspunkten überquert werden können (z.B. Sprungfelder in "Die letzte Hoffnung" oder der steile Felsen in "Das ferne Land"), egal wie viele Willenspunkte er hat.}
...
Der Hautwandler erhält den kleinen runden \hyperref[Gegenstände und Sonderplättchen]{Gegenstand} Armreif.
...
\fan{Für die offizielle Erschöpfungskarte "gleich viele Stärkepunkte" gilt: Solange du deine Genesungsaufgabe nicht erfüllt hast, hat der Bär keine \hyperref[Bonusstärke]{Bonusstärke}.}
...
Hat die Heilerin 7 bis 20 Willenspunkte\supercite{135228}, darf sie in jeder Kampfrunde (nicht im \hyperref[Fernkämpfer]{Fernkampf}\supercite{dfl-begleitheft}) direkt nach ihrem Würfeln einen ihrer nicht zu ihrem Kampfwert addierten Würfel wählen und \fan{bis zu} so viele Willenspunkte auf die kämpfenden Helden verteilen (auch auf Helden, die durch \hyperref[Fernkämpfer]{Fernkampf} mitkämpfen).
...
Hat die Heilerin 14 bis 20 Willenspunkte, darf sie im Kampf (nicht im \hyperref[Fernkämpfer]{Fernkampf}\supercite{dfl-begleitheft}) zwei gleiche Würfelwerte zu ihrem Kampfwert addieren.
...
Die Bogenschützin erhält den Kessel. Der Kessel ist ein kleiner rechteckiger \hyperref[Gegenstände und Sonderplättchen]{Gegenstand}.
...
Die Steinflöte ist ein kleiner rechteckiger \hyperref[Gegenstände und Sonderplättchen]{Gegenstand}.
...
Spricht eine Regel oder Karte aus "Magische Helden" von der Hüterin, ist die Takuri-Hüterin gemeint. Spricht eine andere Regel oder Karte von der Hüterin, ist die \hyperref[Hüterin]{Hüterin} gemeint und nicht die Takuri-Hüterin.
...
Die Takuri-Hüterin erhält die zwei \hyperref[Gegenstände und Sonderplättchen]{\fan{Gegenstände}} Takuri-Federn, welche auf der Goldablage getragen werden. Nur die Takuri-Hüterin kann 1 Takuri-Feder abgeben, damit sie alle Überstunden an diesem Tag keine Willenspunkte kosten.
...
\fan{Gegner können nicht über Eisbrücken des \hyperref[Eis-Dämon]{Eis-Dämons} versetzt werden.}
...
\fan{Steht die Takuri-Hüterin bei oder angrenzend zu Geistern, kann sie die Steinflöte nicht nutzen. Steht der Takuri bei oder angrenzend zu Geistern, gibt er keine \hyperref[Bonusstärke]{Bonusstärke}. Für seine Bonusstärke ist es egal, ob die Takuri-Hüterin bei oder angrenzend zu Geistern steht.}
...
Spricht eine Regel oder Karte aus "Magische Helden" von der Hüterin, ist damit die \hyperref[Takuri-Hüterin]{Takuri-Hüterin} gemeint und nicht Kheela (Kheelan).
...
Die Zauberin erhält die 3 verschiedenen \hyperref[Gegenstände und Sonderplättchen]{Gegenstände} Zauberbücher mit der geschlossenen Seite oben.
...
Die Pulver sind \hyperref[Gegenstände und Sonderplättchen]{\fan{Sonderplättchen}}.
...
\fan{Ihr dürft am Anfang mancher Legenden, in denen keine Runensteine eingewürfelt würden, dennoch Runensteine einwürfeln. Mischt dann verdeckt drei zusätzliche Runensteine (blau, gelb und grün; wie üblich kleine rechteckige \hyperref[Gegenstände und Sonderplättchen]{Gegenstände}). Bestimmt mit je 1 Kreaturenwürfel (10er-Stelle) und Heldenwürfel (1er-Stelle) die Positionen von 2 dieser Runensteine. Nehmt den dritten Runenstein verdeckt aus dem Spiel.}
\supercite{128652}
...
\fan{Ein von der \hyperref[Feuerwächterin]{Feuerwächterin} getragenes Feuer kann so nicht entfacht werden.}
...
Steht die Feuerwächterin bereits auf dem Feld eines brennenden Feuers, gibt ein von ihr getragenes Feuer weder Willenspunkte noch \hyperref[Bonusstärke]{Bonusstärke}.
\supercite{101489}
...
\fan{Steht die Feuerwächterin bei oder angrenzend zu Geistern, kann sie kein Feuer auf ihr großes Ablagefeld legen, kann sie kein von ihr getragenes erloschenes Feuer entfachen und gibt ein von ihr getragenes Feuer weder Willenspunkte noch \hyperref[Bonusstärke]{Bonusstärke}.}
...
\begin{center}
    \footnotesize
    Aus Das ferne Land (2025). Siehe auch \hyperref[Feuerwächterin]{Tenaya (Teyan), die Feuerwächterin}.
\end{center}
...
Die 3 Feuerzauber sind \hyperref[Gegenstände und Sonderplättchen]{\fan{Sonderplättchen}}.
...
\label{Gegenstände und Sonderplättchen}
...
\bullet{} der Kessel der \hyperref[Bogenschützin]{Bogenschützin} (zweite Sonderfähigkeit),

\bullet{} die Rietgraskrone der \hyperref[Bogenschützin]{Bogenschützin} (Hoffnungskarte),

\bullet{} \fan{das Hadrische Brennholz der \hyperref[Feuerwächterin]{Feuerwächterin},}
...
\bullet{} die Steinflöte der \hyperref[Takuri-Hüterin]{Takuri-Hüterin},

\bullet{} die Scherben der \hyperref[Takuri-Hüterin]{Takuri-Hüterin} (Hoffnungskarte),

\bullet{} die Takuri-Federn der \hyperref[Takuri-Hüterin]{Takuri-Hüterin} (zweite Sonderfähigkeit),
...
\bullet{} die Eisblitze des \hyperref[Eis-Dämon]{Eis-Dämons},

\bullet{} Rabe, Messer und Horn des \hyperref[Fährtenleser]{Fährtenlesers},

\bullet{} ein von der \hyperref[Feuerwächterin]{Feuerwächterin} getragenes Feuer,
...
Ausnahme: Die Rietgraskrone kann nur von ihrer \hyperref[Bogenschützin]{Bogenschützin} getragen werden.
...
\bullet{} den Knochen-Golem der \hyperref[Beschwörerin]{Beschwörerin},

\bullet{} den Wassergeist der \hyperref[Hüterin]{Hüterin},

\bullet{} die Sabri des \hyperref[Steppennomade]{Steppennomaden},

\bullet{} den Takuri der \hyperref[Takuri-Hüterin]{Takuri-Hüterin},
...
Ausnahme: Der Takuri kann nicht als eigene Aktion bewegt werden. Nur die \hyperref[Takuri-Hüterin]{Takuri-Hüterin} darf die Steinflöte von der Vorderseite auf die Rückseite drehen, um den Takuri auf ein beliebiges Spielplanfeld zu versetzen.
...
\fan{Helfer geben ihre \hyperref[Bonusstärke]{Bonusstärke} auch gegen Geröll. Der Knochen-Golem ausnahmsweise auch, wenn er angrenzend steht.}
...
\fan{Der Knochen-Golem gibt seine \hyperref[Bonusstärke]{Bonusstärke} auch, wenn er auf dem Schiff angrenzend zum Gegner steht.}
