...
\newcommand{\reflegende}[2][]{\hyperref[legende-#1]{#2}}
\newcommand{\refprodukt}[2][]{\hyperref[produkt-#1]{#2}}
\newcommand{\refstorytext}[2][]{\hyperref[storytext-#1]{#2}}
...
\begin{center}
    Erweiterung zu \refprodukt[2020-andor-junior]{Andor Junior (2020)}, von der offiziellen Website oder als Promo
\end{center}
...
\begin{center}
    Erweiterung zu \refprodukt[2020-andor-junior]{Andor Junior (2020)}
\end{center}
...
\begin{multicols}{2}
    \begin{chapterbox}
        ...
        \begin{center}
            Aus \refstorytext[2016-die-rueckkehr]{Die Rückkehr (2016)}:
        \end{center}
...
\begin{chapterbox}
    ...
    \begin{center}
        Aus \refprodukt[2016-die-karte-des-grauen-gebirges]{Die Karte des Grauen Gebirges (2016)}:
    \end{center}
...
\begin{center}
    Aus \refstorytext[2014-der-sturmschild]{Der Sturmschild (2014)}:
\end{center}
...
\begin{chapterbox}
    ...
    \begin{center}
        Aus \refstorytext[2014-die-zwei-orden]{Die Zwei Orden (2014)}:
    \end{center}
...
[Link auf \refprodukt[2019-feuer-und-wasser]{Feuer und Wasser (2019)}]\bigskip
...
\begin{center}
    Aus \refstorytext[2020-hoffnung-und-schicksal]{Hoffnung und Schicksal (2020)}:
\end{center}
...
[Link zu \refstorytext[2016-der-weisse-falke]{Der weiße Falke (2016)}]\bigskip
...
\begin{chapterbox}
    ...
    \begin{center}
        Aus \reflegende[2020-der-marsch-der-trolle]{Der Marsch der Trolle (2020)}:
    \end{center}
...
\begin{center}
    Aus \refprodukt[2019-das-geheimnis-des-koenigs]{Das Geheimnis des Königs (2019)}:
\end{center}
...
\begin{center}
    Aus \refstorytext[2015-besuch-bei-melkart]{Besuch bei Melkart (2015)}:
\end{center}
...
\begin{center}
    Aus \refprodukt[2015-das-lied-des-koenigs]{Das Lied des Königs (2015)}:
\end{center}
...
\begin{center}
    Aus \refstorytext[2012-die-helden]{Die Helden (2012)}:
\end{center}
...
\begin{center}
    Aus \refstorytext[online-tavernen-weihnachts-party-2017]{Online-Tavernen-Weihnachts-Party 2017}:
\end{center}
...
\begin{center}
    Aus \refstorytext[2020-feuer-und-metall]{Feuer und Metall (2020)}
\end{center}
...
Rudnars Schar, Helden und zwei junge Bewahrer erscheinen aus der Zukunft, siehe \reflegende[2020-schatten-ueber-cavern]{Schatten über Cavern (2020)}.
...
\begin{center}
    Legende aus \refprodukt[2020-duestere-zeiten]{Düstere Zeiten (2020)}
\end{center}
...
\begin{center}
    Legende zu \refprodukt[2020-duestere-zeiten]{Düstere Zeiten (2020)}, von der offiziellen Website
\end{center}
...
\bildlinks[width=0.06\textwidth]{zeitportal-rund.png} 
Helden und zwei junge Bewahrer reisen zurück in die Zukunft. Weiter geht es mit \refstorytext[2020-zwei-junge-bewahrer]{Zwei junge Bewahrer (2020)}.
...
\begin{center}
    Beilage einer Edition von \refprodukt[2012-die-legenden-von-andor]{Die Legenden von Andor (2012)}
\end{center}
...
\begin{center}
    Beilage einer Edition von \refprodukt[2017-die-bonus-box]{Die Bonus-Box (2017)}
\end{center}
...
\begin{chapterbox}
    ...
    \begin{center}
        Aus \refstorytext[2013-ken-dorr-merrik-und-gilda]{Ken Dorr, Merrik und Gilda (2013)}:
    \end{center}
...
\begin{center}
     Brief von Hademar an Varkur  aus \refprodukt[2019-das-geheimnis-des-koenigs]{Das Geheimnis des Königs (2019)}:
\end{center}
...
\begin{center}
     Aus \refstorytext[2022-tenaya-die-waechterin-des-feuers]{Tenaya, die Wächterin des Feuers (2022)}:
\end{center}
...
\begin{center}
    Aus \refstorytext[2019-in-einem-fremden-land]{In einem fremden Land (2019)}:
\end{center}
...
\begin{center}
    Erweiterung zu \refprodukt[2012-die-legenden-von-andor]{Die Legenden von Andor (2012)}, von der offiziellen Website oder als Promo
\end{center}
...
\begin{center}
    Aus \reflegende[2015-die-jagd]{Die Jagd (2015)}:
\end{center}
...
\begin{center}
    Aus \reflegende[2016-im-schatten-der-winterburg]{Im Schatten der Winterburg (2016)}:
\end{center}
...
\begin{center}
    Aus \refstorytext[2012-die-trolle]{Die Trolle (2012)}:
\end{center}
...
\begin{center}
    Aus \refstorytext[2019-ein-rabe-entscheidet-sich]{Ein Rabe entscheidet sich (2019)}:
\end{center}
...
"Stell' es dir nicht zu leicht vor.", widersprach Vann. "Ich habe es dir schon die letzten Male gesagt: Es gibt viele gute Kämpfer unter den Andori. Wir hatten hier auch eine Schlacht. Und da standen Menschen und Zwerge Seite an Seite."\footnote{BBB: Dies klingt zwar nach der Schlacht um die Rietburg vom Ende von \refprodukt[2015-das-lied-des-koenigs]{Das Lied des Königs (2015)}. Es kann aber nicht jene Schlacht sein: Dieser Storytext spielt laut seinem letzten Abschnitt vor \refstorytext[2019-die-geschichte-des-drittbesten-bogenschuetzen]{Die Geschichte des drittbesten Bogenschützen (2019)} und in jenem Storytext kommt der Angriff auf den Baum der Lieder vom Anfang von \refprodukt[2015-das-lied-des-koenigs]{Das Lied des Königs (2015)} vor.}
...
\begin{center}
    Aus \refstorytext[2020-zwei-junge-bewahrer]{Zwei junge Bewahrer (2020)}:
\end{center}
...
\begin{itemize}[topsep=0pt,itemsep=-1ex,partopsep=1ex,parsep=1ex]
    ...
    \item Die Taverne von Andor aus \refprodukt[2015-das-lied-des-koenigs]{Das Lied des Königs (2015)}
...
\begin{center}
    Legende aus \refprodukt[2012-die-legenden-von-andor]{Die Legenden von Andor (2012)} oder \refprodukt[2023-big-box]{Big Box (2023)}
\end{center}
...
\begin{center}
    Aus dem Trailer zu \refprodukt[2012-die-legenden-von-andor]{Die Legenden von Andor (2012)}:
\end{center}
...
\textit{Die folgende Geschichte beginnt wenige Tage nach dem Ende der Geschichte "Vara, der Wassergeist" von Stefanie Schmitt, siehe:} [Link zu \refstorytext[2014-vara-der-wassergeist]{Vara, der Wassergeist (2014)}]
...
"Das ist nicht wahr!", rief Janis mit der alles wissenden Überzeugung der Jugend. "Vara hatte sich in Etore verliebt, deshalb ist sie bei uns. Das war der Großvater von meinem Großvater. Und von dem noch mal der Großvater."\footnote{BBB: Dies ist ein "Ur-" weniger als in \refstorytext[2014-vara-der-wassergeist]{Vara, der Wassergeist (2014)}.} 
...
\begin{center}
    Erweiterung zu \refprodukt[2012-die-legenden-von-andor]{Die Legenden von Andor (2012)}
\end{center}
...
\begin{center}
    Aus \reflegende[2012-die-heilung-des-koenigs]{Die Heilung des Königs (2012)}:
\end{center}
...
\begin{center}
    Aus \reflegende[2012-die-tage-des-widerstands]{Die Tage des Widerstands (2012)}:
\end{center}
...
\begin{center}
    Legende aus \refprodukt[2017-2024-die-bonus-box]{Die Bonus-Box (2017/2024)} oder \refprodukt[2023-big-box]{Big Box (2023)}
\end{center}
...
\begin{chapterbox}
    ...
    \begin{center}
        Aus \refstorytext[tavernen-party-2022]{Tavernen-Party 2022}:
    \end{center}
...
[Link zu \refstorytext[2022-tenaya-die-waechterin-des-feuers]{Tenaya, die Wächterin des Feuers (2022)}]
...
[Musik: The Vigilant Woods aus \refprodukt[2019-legends-of-andor-original-board-game-soundtrack]{Legends of Andor: Original Board Game Soundtrack (2019)}]\bigskip
...
[Musik: The Vigilant Woods aus \refprodukt[2019-legends-of-andor-original-board-game-soundtrack]{Legends of Andor: Original Board Game Soundtrack (2019)}]

\bildmitts{tenayas-reise-teil-2-cover.jpeg}

[Musik: The Abandoned Tower aus \refprodukt[2019-legends-of-andor-original-board-game-soundtrack]{Legends of Andor: Original Board Game Soundtrack (2019)}]\bigskip
...
[Musik: The Tavern Song aus \refprodukt[2019-legends-of-andor-original-board-game-soundtrack]{Legends of Andor: Original Board Game Soundtrack (2019)}]
...
\begin{center}
    Legende aus \refprodukt[2022-die-ewige-kaelte]{Die ewige Kälte (2022)}
\end{center}
...
\begin{center}
    Erweiterung zu \refprodukt[2022-die-ewige-kaelte]{Die ewige Kälte (2022)}, als Promo
\end{center}
...
\begin{center}
    Legende zu \refprodukt[2022-die-ewige-kaelte]{Die ewige Kälte (2022)}, als Promo
\end{center}
...
[Link auf \refprodukt[2019-der-feuerkrieger]{Der Feuerkrieger (2019)}]
...
\begin{center}
    Erweiterung für \refprodukt[2012-die-legenden-von-andor]{Die Legenden von Andor (2012)} oder \refprodukt[2023-big-box]{Big Box (2023)}
\end{center}
...
[Seit 2023 gibt es mit Trieest aus \refprodukt[2023-herz-aus-eis]{Herz aus Eis (2023)} eine offizielle Feuerkrieger-Sonderfähigkeit.]
...
\begin{center}
    Erweiterung zu \refprodukt[2019-das-geheimnis-des-koenigs]{Das Geheimnis des Königs (2019)}
\end{center}
...
\begin{center}
    Legende aus \refprodukt[2023-herz-aus-eis]{Herz aus Eis (2023)}
\end{center}
...
\chapter{Das ferne Land}
    ...
    \begin{center}
        Aus \refstorytext[2024-2025]{2025! (2024)}:
    \end{center}
...
\begin{center}
    Legende aus \refprodukt[2025-das-ferne-land]{Das ferne Land (2025)}
\end{center}
...
\chapter{Magier, Nekromant und Drache}
    ...
    \begin{center}
        Aus \reflegende[2013-die-eskorte-des-koenigs]{Die Eskorte des Königs (2013)}:
    \end{center}
...
\begin{itemize}[topsep=0pt,itemsep=-1ex,partopsep=1ex,parsep=1ex]
    ...
    \item Bonus-Legendenkarten "Dunkler Magier" aus \refprodukt[2022-varkurs-erwachen]{Varkurs Erwachen (2022)}
\end{itemize}
...
\begin{center}
    Legende aus \refprodukt[2019-das-geheimnis-des-koenigs]{Das Geheimnis des Königs (2019)}
\end{center}
...
\begin{center}
    Legende von der offiziellen Website oder aus \refprodukt[2017-2024-die-bonus-box]{Die Bonus-Box (2017/2024)} oder \refprodukt[2023-big-box]{Big Box (2023)}
\end{center}
...
\begin{center}
    Blanko-Legende aus \refprodukt[2012-die-legenden-von-andor]{Die Legenden von Andor (2012)} oder von der offiziellen Website
\end{center}
...
\begin{chapterbox}
    ...
    \begin{center}
        Aus \reflegende[2018-die-vierte-statue]{Die vierte Statue (2018)}:
    \end{center}
...
\begin{center}
    Erweiterung zu \refprodukt[2012-die-legenden-von-andor]{Die Legenden von Andor (2012)} oder \refprodukt[2023-big-box]{Big Box (2023)}
\end{center}
...
\begin{center}
    Legende aus \refprodukt[2018-alte-geister]{Alte Geister (2018)}
\end{center}
...
\begin{center}
     Legende zu \refprodukt[2018-alte-geister]{Alte Geister (2018)}, von der offiziellen Website oder als Promo
\end{center}
...
\begin{chapterbox}
    ...
    \begin{center}
        Aus \refprodukt[2013-der-sternenschild]{Der Sternenschild (2013)}:
    \end{center}
...
\begin{center}
    Legende aus \refprodukt[2013-der-sternenschild]{Der Sternenschild (2013)}
\end{center}
...
\begin{center}
    Aus \refstorytext[2016-3-jahre-taverne-von-andor]{3 Jahre Taverne von Andor! (2016)}:
\end{center}
...
\begin{center}
    Aus \refstorytext[2016-darh]{Darh (2016)}:
\end{center}
...
\begin{center}
    Aus \refstorytext[2014-der-kampf-um-cavern-comic-zur-vorgeschichte]{Der Kampf um Cavern: Comic zur Vorgeschichte (2014)}:
\end{center}
...
\chapter{Geschichten von überall und nirgendwo}
    ...
    \begin{center}
        Aus \refstorytext[2022-forschungsstand-zum-bannkreis-von-choranat]{Forschungsstand zum Bannkreis von Choranat (2022)}:
    \end{center}
    ...
    [Dieses Kapitel umfasst neben Ereignissen aus der Zeit zwischen der Ära des Sternenschildes und dem Kampf um Cavern pauschal alle chronologisch schwer einzuordnenden Werke wie \refprodukt[2021-dunkle-pfade]{Dunkle Pfade (2021)} oder \refprodukt[2021-magische-helden]{Magische Helden (2021)}.]
...
Die Figur ist bereits in der großen Erweiterung [\refprodukt[2014-die-reise-in-den-norden]{Die Reise in den Norden (2014)}] enthalten.
...
\begin{center}
    Wettbewerb aus dem offiziellen Forum, aufgelöst mit \refstorytext[2017-grenolins-geschichte]{Grenolins Geschichte (2017)}
\end{center}
...
[Link auf \refstorytext[2012-der-sternenschild]{Der Sternenschild (2012)}]
...
[\refstorytext[2014-die-taverne-zum-trunkenen-troll]{Die Taverne zum Trunkenen Troll (2014)}] [...]
...
[\refstorytext[2014-der-bruderschild]{Der Bruderschild (2014)}]
...
die neuen Helden sind prima. Ich habe einige Zeit mit Orfen im Süden des Landes verbracht: [Link zu \refstorytext[2013-ken-dorr-merrik-und-gilda]{Ken Dorr, Merrik und Gilda (2013)}]
...
\begin{center}
    Erweiterung zu \refprodukt[2012-die-legenden-von-andor]{Die Legenden von Andor (2012)}, \refprodukt[2016-die-letzte-hoffnung]{Die letzte Hoffnung (2016)} oder \refprodukt[2023-big-box]{Big Box (2023)}
\end{center}
...
\begin{center}
    Legende zu \refprodukt[2021-magische-helden]{Magische Helden (2021)}, von der offiziellen Website   
\end{center}
...
\begin{center}
    Legende zu \refprodukt[2012-die-legenden-von-andor]{Die Legenden von Andor (2012)} oder \refprodukt[2023-big-box]{Big Box (2023)}, von der offiziellen Website oder als Promo
\end{center}
...
\begin{center}
    Aus \refstorytext[2016-treffen-mit-mart]{Treffen mit Mart (2016)}:
\end{center}
...
Erfahrt mehr über Thogger in: [Link auf \refprodukt[2020-duestere-zeiten]{Düstere Zeiten (2020)}]
...
Erfahrt mehr über Shan in: [Link auf \refprodukt[2020-duestere-zeiten]{Düstere Zeiten (2020)}]
...
Erfahrt mehr über Kjall in ... [Link auf \refprodukt[2020-duestere-zeiten]{Düstere Zeiten (2020)}]
...
\begin{center}
    Legende aus \refprodukt[2020-duestere-zeiten]{Düstere Zeiten (2020)}\bigskip
\end{center}
...
Rudnars Schar, Helden und zwei junge Bewahrer reisen in die Vergangenheit. Weiter geht es mit \reflegende[2020-fremde-heimat]{Fremde Heimat (2020)}.\bigskip


\bildlinks[width=0.06\textwidth]{zeitportal-rund.png} 

Helden und zwei junge Bewahrer erscheinen wieder aus der Vergangenheit, siehe \reflegende[2020-der-letzte-schatten]{Der letzte Schatten (2020)}.
...
Wie wir seit dem Kampf um Cavern (Bonus-Legende: [\reflegende[2014-der-kampf-um-cavern]{Der Kampf um Cavern (2014)}]) wissen, wird der gute Kram nicht mit in den Norden reisen. Stattdessen tritt ein neuer Held an seine Stelle: Stinner, der Seekrieger!
...
\begin{center}
    Legende aus \refprodukt[2014-die-reise-in-den-norden]{Die Reise in den Norden (2014)}
\end{center}
...
\begin{center}
    Wettbewerb aus dem offiziellen Forum, aufgelöst mit \refstorytext[2015-illustre-crew]{Illustre Crew (2015)}
\end{center}
...
\begin{center}
    Beiträge aus dem offiziellen Forum, Auflösung des Wettbewerbs \refprodukt[2015-der-schatz-des-nordens]{Der Schatz des Nordens (2015)}
\end{center}
...
\begin{center}
    Legende zu \refprodukt[2014-die-reise-in-den-norden]{Die Reise in den Norden (2014)}, von der offiziellen Website   
\end{center}
...
[Link auf \refprodukt[2015-die-karte-der-insel-hadria]{Die Karte der Insel Hadria (2015)}]
...
Sagte ich alle Helden reisten in den Norden? Nein, nicht alle! Denn Kram, der Zwerg, wurde nach der großen Schlacht [\reflegende[2014-der-kampf-um-cavern]{Der Kampf um Cavern (2014)}] zum neuen Fürsten der Schildzwerge ernannt und musste zurückbleiben. Sein neues Reich hatte stark unter der Schlacht gelitten.
...
[\refstorytext[2015-abenteuer-andor-mp3]{Abenteuer Andor MP3 (2015)}]
...
Harthalt erwies sich der Ehre würdig und vollbrachte noch viele Heldentaten. Man sprach von seiner Stärke, dem Schwert und seinem schwarzen Schild*. Tapfer focht er in allen drei Trollkriegen\footnote{BBB: \reflegende[2020-der-marsch-der-trolle]{Der Marsch der Trolle (2020)} behandelt den mutmaßlich ersten der drei Trollkriege.} und in der grässlichen Flussschlacht. Über Letzteres erfährt man freilich mehr im Lied von "Blutstrom".\bigskip
...
\begin{center}
    Legende zu \refprodukt[2013-der-sternenschild]{Der Sternenschild (2013)}, von der offiziellen Website oder als Promo
\end{center}
...
[Link auf \refstorytext[2015-besuch-bei-melkart]{Besuch bei Melkart (2015)}]
...
Spannend!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! Und damit ich ja nichts vergesse, erzähle ich es euch gerne hier ausführlich: [Link auf \refstorytext[2015-besuch-bei-melkart]{Besuch bei Melkart (2015)}] 
...
[Link auf \refstorytext[2013-seltsame-tafel-aufgetaucht]{Seltsame Tafel aufgetaucht (2013)}]
...
[Link zu \reflegende[2015-die-jagd]{Die Jagd (2015)}]
...
[\refstorytext[2015-die-fuenf-erlasse-des-neuen-regenten-ken-dorr]{Die fünf Erlasse des neuen Regenten Ken Dorr (2015)}]
...
[Link zu \refstorytext[2015-die-fuenf-erlasse-des-neuen-regenten-ken-dorr]{Die fünf Erlasse des neuen Regenten Ken Dorr (2015)}]
...
\refstorytext[2015-reka-gefunden]{Reka gefunden (2015)}
...
[\refprodukt[2015-das-lied-des-koenigs]{Das Lied des Königs (2015)}]
...
\begin{chapterbox}
    ...
    \begin{center}
        Aus \refstorytext[2016-juna-ist-gefunden]{Juna ist gefunden! (2016)}:
    \end{center}
...
\begin{center}
    Abenteuer aus \refprodukt[2017-adventures-of-hadria]{Adventures of Hadria (2017)}
\end{center}
...
\begin{center}
    Aus \refprodukt[2016-die-dunkle-magierin]{Die Dunkle Magierin (2016)}:
\end{center}
...
\fillbreak
\produkt[2015-chada-und-thorn]{Chada und Thorn (2015)}
...
\begin{center}
    Erweiterung zu \refprodukt[2015-chada-und-thorn]{Chada und Thorn (2015)}, von der offiziellen Website oder als Promo
\end{center}
...
\begin{center}
    Abenteuer aus \refprodukt[2015-chada-und-thorn]{Chada und Thorn (2015)}
\end{center}
...
\begin{center}
    Abenteuer zu \refprodukt[2015-chada-und-thorn]{Chada und Thorn (2015)}, von der offiziellen Website
\end{center}
...
\begin{center}
    Blanko-Abenteuer zu \refprodukt[2015-chada-und-thorn]{Chada und Thorn (2015)},  von der offiziellen Website
\end{center}
...
[Link zu \refprodukt[2015-das-lied-des-koenigs]{Das Lied des Königs (2015)}]
...
da kann ich die Zusammenfassung als MP3 empfehlen. Die wichtigsten Dinge werden dort zusammengefasst: [Link zu \refstorytext[2015-abenteuer-andor-mp3]{Abenteuer Andor MP3 (2015)}]
...
[Hörprobe zu \refprodukt[2015-das-lied-des-koenigs]{Das Lied des Königs (2015)}]
...
[\refstorytext[2016-der-statthalter-von-andor]{Der Statthalter von Andor (2016)}]
...
\begin{center}
    Aus \reflegende[2016-die-treibholzbucht]{Die Treibholzbucht (2016)}:
\end{center}
...
\begin{center}
    Aus \refstorytext[2016-juna-ist-gefunden]{Juna ist gefunden! (2016)} und \refstorytext[2016-an-land-gehen]{An Land gehen (2016)}:
\end{center}
...
[Link zu \refprodukt[2016-juna]{Juna (2016)}]
...
[Link zu \reflegende[2016-die-treibholzbucht]{Die Treibholzbucht (2016)}]
...
[Hörspiel \refstorytext[2016-der-letzte-der-vier-schilde]{Der letzte der vier Schilde (2016)}]
...
[fusssohle:] [Link zu \refstorytext[2015-reka-gefunden]{Reka gefunden (2015)}]
...
[Link zu \refstorytext[2016-die-rueckkehr]{Die Rückkehr (2016)}]
...
Ja! Unsere Helden (mittlerweile hatte sich auch der hellseherisch nicht unbegabte ChrisW + Familie zu uns gesellt) spielten den Prototypen der Bonus-Mini-Legende "[\reflegende[2016-die-rueckkehr]{Die Rückkehr (2016)}]".
...
[Link zum neuen Trailer zu \refprodukt[2016-die-letzte-hoffnung]{Die letzte Hoffnung (2016)}]
...
Einen ausführlichen Bericht findet ihr in unserem Forum [Link auf \refstorytext[2016-die-suche-nach-dem-letzten-schild]{Die Suche nach dem letzten Schild (2016)}].
...
\begin{center}
    Legende zu \refprodukt[2013-der-sternenschild]{Der Sternenschild (2013)}, von der offiziellen Website
\end{center}
...
[Link zu \refstorytext[2016-der-weisse-falke]{Der weiße Falke (2016)}]
...
\begin{center}
    Legende aus \refprodukt[2016-die-letzte-hoffnung]{Die letzte Hoffnung (2016)} mit Bonus-Legendenkarten aus \refprodukt[2016-die-dunkle-magierin]{Die Dunkle Magierin (2016)}, \refprodukt[2017-dunkle-helden]{Dunkle Helden (2017)} und \refprodukt[2021-magische-helden]{Magische Helden (2021)}
\end{center}
...
\begin{center}
    Legende aus \refprodukt[2016-die-letzte-hoffnung]{Die letzte Hoffnung (2016)}
\end{center}
...
\begin{center}
    Beiträge aus dem offiziellen Forum, Auflösung des Wettbewerbs \refprodukt[2017-die-feinde]{Die Feinde (2017)}
\end{center}
...
%\footnote{\reflegende[2022-die-pranken-des-winters]{Die Pranken des Winters (2022)}}

\textit{Hadranoston} – Winterstein (gehoben)
%\footnote{\refstorytext[2022-ein-beunruhigender-fund]{Ein beunruhigender Fund (2022)}}

\textit{[Lamanio mau]} – ?
%\footnote{\refprodukt[2024-die-magischen-minen]{Teil 6: Die magischen Minen (2024)}\label{fn-aj6}}
...
\textit{[Lamoko dotom]} – ?
%\footnote{\refprodukt[2024-die-daemonen-im-eis]{Teil 7: Die Dämonen im Eis (2024)}\label{fn-aj7}}
...
%\footnote{\refprodukt[2021-der-fluch-des-roten-drachen]{Teil 1: Der Fluch des roten Drachen (2021)}\label{fn-aj1}}

\textit{Narkon} – Falle, Hinterhalt
%\footnote{\refstorytext[2015-varatans-fluch]{Varatans Fluch (2015)}}\textsuperscript{,}\footnote{\reflegende[2015-die-sturmweiden]{Die Sturmweiden (2015)}}

\textit{[Prituro]} – ?
%\footnote{\refprodukt[2023-das-fluestern-im-wald]{Teil 3: Das Flüstern im Wald (2023)} (nur Hörspiel)\label{fn-aj3-hoerspiel}}

\textit{Qurun est to} – Das Ende ist nah
%\footnote{\reflegende[2014-hadria]{Hadria (2014)}\label{fn-l10}}
...
\textit{Rumuno earim} – ?
%\footnote{\refprodukt[2024-das-wesen-im-wasser]{Teil 5: Das Wesen im Wasser (2024)}\label{fn-aj5}}
...
%\footnote{\refstorytext[2014-die-zwei-orden]{Die Zwei Orden (2014)}\label{fn-st-zo}}
...
%\footnote{\refstorytext[2015-kapitel-2-die-rechte-hand-des-koenigs]{Kapitel 2: Die rechte Hand des Königs (2015)}}\textsuperscript{,}\footnote{\reflegende[2015-die-jagd]{Die Jagd (2015)}}
...
%\footnote{\refstorytext[2013-michael-menzel-im-interview]{Michael Menzel im Interview (2013)}\label{fn-andori}} 
(Bewahrer-Wort)
%\footnote{\refstorytext[2020-feuer-und-metall]{Feuer und Metall (2020)}\label{fn-st-fum}}

\textit{Andori} – Angekommener
%\footref{fn-andori}\textsuperscript{,}\footnote{\refstorytext[2022-tenayas-reise]{Tenayas Reise (2022)}} 
(Bewahrer-Wort)
%\footref{fn-st-fum}

\textit{Arbak} – Geist des Waldes
%\footnote{\reflegende[2018-die-spur-des-drachen]{Die Spur des Drachen (2018)}}

\textit{Forn} – scheu
%\footnote{\refstorytext[2016-ein-dunkler-held]{Ein dunkler Held (2016)}\label{fn-st-edh}}
...
%\footnote{\refstorytext[2012-reka-die-hexe]{Reka die Hexe (2012)}}

\textit{Krahder} – Unsterblicher
%\footnote{\refstorytext[2016-die-winterburg]{Die Winterburg (2016)}}

\textit{Ruoor} – Immerwütende
%\footnote{\reflegende[2016-die-letzte-hoffnung]{Die letzte Hoffnung (2016)}}
...
\textit{Grate} – groß
%\footnote{\refstorytext[2020-hoffnung-und-schicksal]{Hoffnung und Schicksal (2020)}\label{fn-st_hus}}

\textit{Mamoru} – Beschützer
%\footnote{\refstorytext[2024-die-bezwingerin-des-feuers]{Die Bezwingerin des Feuers (2024)}}\textsuperscript{,}\footnote{\refprodukt[2025-das-ferne-land]{Das ferne Land (2025)}}

\textit{Yjotege} – Büffel
%\footref{fn-st-hus}\textsuperscript{,}\footnote{\refstorytext[2019-ein-rabe-entscheidet-sich]{Ein Rabe entscheidet sich (2019)}\label{fn-st-eres}}
...
%\footnote{\refprodukt[2022-der-sturm-auf-die-rietburg]{Teil 2: Der Sturm auf die Rietburg (2022)}\label{fn-aj2}}

\textit{[Fito]} – ?
%\footref{fn-aj7}

\textit{Haamun} – Licht des Morgens
%\footnote{\refstorytext[2018-tulgor]{Tulgor (2018)}\label{fn-st-tulgor}}

\textit{Karra} – ?
%\footnote{\refprodukt[2023-das-fluestern-im-wald]{Teil 3: Das Flüstern im Wald (2023)}\label{fn-aj3}}
...
%\footnote{\refprodukt[2015-chada-und-thorn]{Chada und Thorn (2015)}\label{fn-cut}}

\textit{Lonas} – Gezähmter
%\footnote{\refprodukt[2015-das-lied-des-koenigs]{Das Lied des Königs (2015)}}
...
\begin{chapterbox}
    ...
    \begin{center}
        Aus \refprodukt[die-taverne-von-andor]{Die Taverne von Andor}:
    \end{center}
