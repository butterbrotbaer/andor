%!LW recipe = chronik-der-andorversen-recipe
...
\usepackage{fontspec}
    \newfontfamily{\andorfont}{andor-schriftart.otf}[Path=chronik-der-andorversen/]
    \newfontfamily{\webdings}{Webdings}
    \newfontfamily{\wingdings}{Wingdings}
    % Zeichen für Nejas Fluchen
    \newcommand{\webdingsspider}{{\webdings\char"F021}}
    \newcommand{\webdingsratingviolence}{{\webdings\char"F095}}
    \newcommand{\wingdingsskullcrossbones}{{\wingdings\char"F04E}}
    \newcommand{\wingdingsfrownface}{{\wingdings\char"F04C}}
    \newcommand{\webdingstwister}{{\webdings\char"F0DD}}

%entferne Einrücken im Inhaltsverzeichnis
...
\newcommand{\legende}[2][]{%
    \section[#2]{%
        \parbox{24px}{\centering\includegraphics[width=24px]{chronik-der-andorversen/legenden-icons/#1.png}}%
        #2%
    }%
    \label{legende-#1}%
}

\newcommand{\legendensymbol}[2][]{%
    \hyperref[legende-#1]{%
        \parbox{24px}{\centering\includegraphics[width=24px]{chronik-der-andorversen/legenden-icons/#1.png}}%
    }%
}%
...
\newcommand{\az}[1]{%
    \begin{center}
        \includegraphics[width=180px]{chronik-der-andorversen/verzierung-2.png}\\
        {\Huge #1} \\
        {nach andorischer Zeitrechnung}\\
        \includegraphics[width=180px]{chronik-der-andorversen/verzierung-1.png}
    \end{center}
    \extramarks{}{#1 a.Z.}
}
...
\title{Chronik der Andorversen\\Stand ????}
\author{Werke von Michael Menzel, Stefanie Schmitt,\\Christoph Kling, Dorothea Michels, Andreas Kälber, Matthias Miller,\\Jens Baumeister, Timo Grubing, Peter Gustav Bartschat,\\Gerhard Hecht, Inka und Markus Brand, Stefan Blanck,\\Alex Zbiek, Jörg Ihle, Thorsten Suckow, Julian Colbus,\\ELANE, Zapf, Silke Lukas, Arne S. Reismueller,\\und allen anderen andorischen Autor*innen,\\zusammengestellt von Butterbrotbär}
\date{\vfill Chronik der Andorversen v??.?\\Dieses Dokument wurde erstellt mit \LaTeX{}.\\Für den Quelltext siehe \url{https://butterbrotbaer.github.io}.\\Für die neuste Version siehe \url{https://legenden-von-andor.de/forum/viewtopic.php?f=11&t=10314}.}
...
\begin{center}
    \begin{tikzpicture}
        ...
        % Define box styles.
        \tikzset{box/.style={inner sep=0px,line width=3px}}

        % Define arrow style.
        \tikzset{arr/.style={->,-latex,line width=3px,>={Stealth[scale=10]}}}

        % Draw boxes.
        \node[box] (DLvA) at (0,0){\hyperref[produkt-2012-die-legenden-von-andor]{\includegraphics[height=72px]{chronik-der-andorversen/bilder/2012-die-legenden-von-andor.png}}};
        \node[box] (DRidN) at (4.1,-1.4){\hyperref[produkt-2014-die-reise-in-den-norden]{\includegraphics[height=72px]{chronik-der-andorversen/bilder/2014-die-reise-in-den-norden.png}}};
        \node[box] (DlH) at (0,-2.7){\hyperref[produkt-2016-die-letzte-hoffnung]{\includegraphics[height=72px]{chronik-der-andorversen/bilder/2016-die-letzte-hoffnung.png}}};
        \node[box] (DLvA-Erweiterungen) at (9.7,0.3)
        {
            \hyperref[produkt-2013-der-sternenschild]{\includegraphics[height=72px]{chronik-der-andorversen/bilder/2013-der-sternenschild.png}}
            \hyperref[produkt-2024-die-bonus-box]{\includegraphics[height=72px]{chronik-der-andorversen/bilder/2024-die-bonus-box.jpeg}}
            \hyperref[produkt-2018-alte-geister]{\includegraphics[height=72px]{chronik-der-andorversen/bilder/2018-alte-geister.png}}
            \hyperref[produkt-2020-duestere-zeiten]{\includegraphics[height=72px]{chronik-der-andorversen/bilder/2020-duestere-zeiten.png}}
        };
        \node[box] (NH) at (8.1,-2.6) {\hyperref[produkt-2014-neue-helden]{\includegraphics[height=72px]{chronik-der-andorversen/bilder/2014-neue-helden.png}}};   
        \node[box] (MH) at (9.7,-2.8) {\hyperref[produkt-2021-magische-helden]{\includegraphics[height=72px]{chronik-der-andorversen/bilder/2021-magische-helden.png}}}; 
        \node[box] (DH) at (11.3,-3) {\hyperref[produkt-2017-dunkle-helden]{\includegraphics[height=72px]{chronik-der-andorversen/bilder/2017-dunkle-helden.png}}}; 
        \node[box] (AJ) at (0,3.1){\hyperref[produkt-2020-andor-junior]{\includegraphics[height=72px]{chronik-der-andorversen/bilder/2020-andor-junior.png}}};
        \node[box] (GadS) at (4.7,3.1){\hyperref[produkt-2022-die-gefahr-aus-dem-schatten]{\includegraphics[height=72px]{chronik-der-andorversen/bilder/2022-die-gefahr-aus-dem-schatten.png}}};
        \node[box] (DeK) at (0,-5.8){\hyperref[produkt-2022-die-ewige-kaelte]{\includegraphics[height=72px]{chronik-der-andorversen/bilder/2022-die-ewige-kaelte.png}}};
        \node[box] (DfL) at (0,-8.5) {\hyperref[produkt-2025-das-ferne-land]{\includegraphics[height=72px]{chronik-der-andorversen/bilder/2025-das-ferne-land.png}}}; 
        \node[box] (LdD) at (4.8,-5.8){\hyperref[produkt-2022-die-ewige-kaelte]{\includegraphics[height=44px]{chronik-der-andorversen/bilder/2026-das-licht-der-dunkelklinge}}};
        \node[box] (CuT) at (8.8,-8.9) {\hyperref[produkt-2015-chada-und-thorn]{\includegraphics[height=48px]{chronik-der-andorversen/bilder/2015-chada-und-thorn.png}}};  
        \node[box] (BdR) at (10.6,-8.6) {\hyperref[produkt-2019-die-befreiung-der-rietburg]{\includegraphics[height=66px]{chronik-der-andorversen/bilder/2019-die-befreiung-der-rietburg.png}}};  
        \node[box] (SQ-DP) at (12.1,-9) {\hyperref[produkt-2021-dunkle-pfade]{\includegraphics[height=44px]{chronik-der-andorversen/bilder/2021-dunkle-pfade.png}}};  
        
        % Write text.
        \node[anchor=north west] (Trilogie) at (1.7,1.3) {Die Original-Trilogie};
        \node[anchor=north west] (Junior) at (1.7,4.4) {Andor Junior};
        \node[anchor=north west] (Neue Ära) at (1.7,-4.5) {Die neue Ära};
        \node[] (Eigenständige Spiele) at (0,5.6) {Eigenständige};
        \node[] at (0,5.1) {große Spiele};
        \node[] (Spin-Offs) at (8.8,-7.7) {Spin-Offs};

        % Draw rectangles.
        \node[box,inner sep=9px,draw=orange,fit=(DLvA-Erweiterungen)(NH)(MH)(DH)] (DLvA-Ergänzungen) {};
        \node[box,inner sep=3px,draw=teal,fit=(NH)(MH)] (DRidN-Ergänzungen) {};
        \node[box,inner sep=3px,draw=darkgray,fit=(MH)(DH)] (DlH-Ergänzungen) {};
        \node[box,inner sep=9px,draw=white,fit=(AJ)(DLvA)(DlH)(DeK)(DfL)(Eigenständige Spiele)] {};
        \node[box,inner sep=3px,draw=brown,fit=(DLvA)(DRidN)(DlH)(Trilogie)] {};
        \node[box,inner sep=3px,draw=brown,fit=(AJ)(GadS)(Junior)] {};
        \node[box,inner sep=3px,draw=brown,fit=(DeK)(DfL)(LdD)(Neue Ära)] {};
        \node[box,inner sep=3px,draw=brown,fit=(CuT)(BdR)(SQ-DP)(Spin-Offs)] {};

        % Draw arrows.
        \draw[arr,orange] ($(DLvA.east)+(0,0.5)$) to [out=0,in=180]($(DLvA-Ergänzungen.west)+(0,1.5)$);
        \draw[arr,teal] ($(DLvA.east)+(0,-0.5)$) to [out=0,in=180](DRidN.west);
        \draw[arr,teal] (DRidN.east) to [out=0,in=180](DRidN-Ergänzungen.west);
        \draw[arr,darkgray] (DlH.east) to [out=0,in=-90](DlH-Ergänzungen.south);  
        \draw[arr,brown] (AJ.east) to [out=0,in=180](GadS.west); 
        \draw[arr,brown] (DeK.east) to [out=0,in=180](LdD.west);
...
\produkt[2021-der-fluch-des-roten-drachen]{Teil 1: Der Fluch des roten Drachen (2021)}

\begin{center}
    Buch oder Hörspiel
\end{center}

\bildmitts{2021-der-fluch-des-roten-drachen.png}
...
\produkt[2022-der-sturm-auf-die-rietburg]{Teil 2: Der Sturm auf die Rietburg (2022)}

\begin{center}
    Buch oder Hörspiel
\end{center}

\bildmitts{2022-der-sturm-auf-die-rietburg.png}
...
\fillbreak
\produkt[2025-die-geheime-botschaft]{Bücherhelden: Die geheime Botschaft (2025)}

\begin{center}
    Buch
\end{center}

\bildmitts{2025-die-geheime-botschaft.jpeg}
...
\fillbreak
\produkt[2026-der-drachenwald]{Bücherhelden: Der Drachenwald (2026)}

\begin{center}
    Buch
\end{center}

\bildmitts{2026-der-drachenwald.jpeg}

Kram kann es kaum glauben: Ein Baby-Drache schlüpft in der Burg! Wie ist er nur dahin gekommen? Die Freunde wollen den kleinen Drachen zu seinen Eltern bringen. Doch der böse Magier Varkur hat andere Pläne ...
...
\produkt[2023-das-fluestern-im-wald]{Teil 3: Das Flüstern im Wald (2023)}

\begin{center}
    Buch oder Hörspiel
\end{center}

\bildmitts{2023-das-fluestern-im-wald.png}
...
\fillbreak
\produkt[2024-die-spur-aus-der-vergangenheit]{Teil 4: Die Spur aus der Vergangenheit (2024)}

\begin{center}
    Hörspiel
\end{center}

\bildmitts{2024-die-spur-aus-der-vergangenheit.jpeg}
...
\fillbreak
\produkt[2024-das-wesen-im-wasser]{Teil 5: Das Wesen im Wasser (2024)}

\begin{center}
    Hörspiel
\end{center}

\bildmitts{2024-das-wesen-im-wasser.jpeg}
...
\fillbreak
\produkt[2024-die-magischen-minen]{Teil 6: Die magischen Minen (2024)}

\begin{center}
    Hörspiel
\end{center}

\bildmitts{2024-die-magischen-minen.jpeg}
...
\produkt[2024-die-daemonen-im-eis]{Teil 7: Die Dämonen im Eis (2024)}

\begin{center}
    Hörspiel
\end{center}

\bildmitts{2024-die-daemonen-im-eis.jpeg}
...
\fillbreak
\produkt[2020-andor-junior]{Andor Junior (2020)}
...
\bildmitts{2020-andor-junior.png}
...
\fillbreak
\produkt[2020-die-faehrtenleserin-fennah]{Die Fährtenleserin Fennah (2020)}

\begin{center}
    Erweiterung zu \hyperref[produkt-2020-andor-junior]{Andor Junior (2020)}, von der offiziellen Website oder als Promo
\end{center}
...
\produkt[2021-die-steine-des-schicksals]{Die Steine des Schicksals (2021)}

\begin{center}
    Erweiterung zu \hyperref[produkt-2020-andor-junior]{Andor Junior (2020)}, von der offiziellen Website oder als Promo
\end{center}

\bildmitts{2024-die-steine-des-schicksals-promo.jpg}
...
\fillbreak
\produkt[2022-die-gefahr-aus-dem-schatten]{Die Gefahr aus dem Schatten (2022)}

\begin{center}
    Erweiterung zu \hyperref[produkt-2020-andor-junior]{Andor Junior (2020)}
\end{center}

\bildmitts{2022-die-gefahr-aus-dem-schatten.png}
...
\begin{multicols}{2}
    \begin{chapterbox}
        ...
        \begin{center}
            Aus \hyperref[storytext-2016-die-rueckkehr]{Die Rückkehr (2016)}:
        \end{center}
...
\produkt[2012-die-karte-von-andor]{Die Karte von Andor (2012)}
...
\newpage
\produkt[2014-die-karte-von-cavern]{Die Karte von Cavern (2014)}
...
\newpage
\produkt[2023-die-karte-vom-land-der-steppe]{Die Karte vom Land der Steppe (2023)}
...
\newpage
\produkt[2026-die-karte-vom-fernen-land]{Die Karte vom fernen Land (2026)}
...
\newpage
\produkt[2014-die-karte-des-nordens]{Die Karte des Nordens (2014)}
...
\newpage
\produkt[2015-die-karte-der-insel-hadria]{Die Karte der Insel Hadria (2015)}
...
\newpage
\produkt[2015-die-karte-von-narkon]{Die Karte von Narkon (2015)}
...
\newpage
\produkt[2016-die-karte-des-grauen-gebirges]{Die Karte des Grauen Gebirges (2016)}
...
\newpage
\produkt[2017-die-karte-des-landes-krahd]{Die Karte des Landes Krahd (2017)}
...
\begin{chapterbox}
    ...
    \begin{center}
        Aus \hyperref[produkt-2016-die-karte-des-grauen-gebirges]{Die Karte des Grauen Gebirges (2016)}:
    \end{center}
...
\fillbreak
\storytext[2012-der-sternenschild]{Der Sternenschild (2012)}
...
\fillbreak
\storytext[2014-der-bruderschild]{Der Bruderschild (2014)}
...
\fillbreak
\storytext[zum-silberschild]{Zum Silberschild}

\begin{center}
    Aus \hyperref[storytext-2014-der-sturmschild]{Der Sturmschild (2014)}:
\end{center}
...
\fillbreak
\storytext[2016-der-letzte-der-vier-schilde]{Der letzte der vier Schilde (2016)}
...
\fillbreak
\storytext[2012-die-kreaturen]{Die Kreaturen (2012)}
...
\storytext[2012-die-trolle]{Die Trolle (2012)}
...
\fillbreak
\storytext[2016-das-volk-der-krahder]{Das Volk der Krahder (2016)}
...
\begin{chapterbox}
    ...
    \begin{center}
        Aus \hyperref[storytext-2014-die-zwei-orden]{Die Zwei Orden (2014)}:
    \end{center}
...
\fillbreak
\storytext[2019-die-geschichte-von-danwar]{Die Geschichte von Danwar (2019)}
...
\bildmitts{2019-die-geschichte-von-danwar.jpg}
...
[Link auf \hyperref[produkt-2019-feuer-und-wasser]{Feuer und Wasser (2019)}]\bigskip
...
\fillbreak
\storytext[2015-varatans-fluch]{Varatans Fluch (2015)}
...
\begin{center}
    Aus \hyperref[storytext-2020-hoffnung-und-schicksal]{Hoffnung und Schicksal (2020)}:
\end{center}
...
\fillbreak
\storytext[2016-andor-newsletter]{Andor-Newsletter (2016)}

\begin{center}
    Storytext aus dem offiziellen Forum
\end{center}

\bildmitts{2016-der-andor-newsletter.jpeg}
...
[Link zu \hyperref[storytext-2016-der-weisse-falke]{Der weiße Falke (2016)}]\bigskip
...
\fillbreak
\storytext[2014-die-zwei-orden]{Die Zwei Orden (2014)}
...
\bildmitts{2014-die-zwei-orden.jpeg}
...
\begin{chapterbox}
    ...
    \begin{center}
        Aus \hyperref[legende-2020-der-marsch-der-trolle]{Der Marsch der Trolle (2020)}:
    \end{center}
...
\fillbreak
\az{um –40}
\storytext[2012-reka-die-hexe]{Reka die Hexe (2012)}
...
\fillbreak
\az{um –20}
\storytext[2012-die-vorgeschichte]{Die Vorgeschichte (2012)}
...
\begin{center}
    Aus \hyperref[produkt-2019-das-geheimnis-des-koenigs]{Das Geheimnis des Königs (2019)}:
\end{center}
...
\begin{center}
    Aus \hyperref[storytext-2015-besuch-bei-melkart]{Besuch bei Melkart (2015)}:
\end{center}
...
\begin{center}
    Aus \hyperref[produkt-2015-das-lied-des-koenigs]{Das Lied des Königs (2015)}:
\end{center}
...
\begin{center}
    Aus \hyperref[storytext-2012-die-helden]{Die Helden (2012)}:
\end{center}
...
\begin{center}
    Aus \hyperref[storytext-online-tavernen-weihnachts-party-2017]{Online-Tavernen-Weihnachts-Party 2017}:
\end{center}
...
\begin{center}
    Aus \hyperref[storytext-2020-feuer-und-metall]{Feuer und Metall (2020)}
\end{center}
...
\fillbreak
\storytext[2013-michael-menzel-im-interview]{Michael Menzel im Interview (2013)}
...
\storytext[2014-die-taverne-zum-trunkenen-troll]{Die Taverne zum Trunkenen Troll (2014)}
...
\bildlinks[width=0.06\textwidth]{zeitportal-rund.png} 
Rudnars Schar, Helden und zwei junge Bewahrer erscheinen aus der Zukunft, siehe \hyperref[legende-2020-schatten-ueber-cavern]{Schatten über Cavern (2020)}.




\legende[2020-fremde-heimat]{Fremde Heimat (2020)}

\begin{center}
    Legende aus \hyperref[produkt-2020-duestere-zeiten]{Düstere Zeiten (2020)}
\end{center}
...
\legende[2020-der-marsch-der-trolle]{Der Marsch der Trolle (2020)}

\begin{center}
    Legende zu \hyperref[produkt-2020-duestere-zeiten]{Düstere Zeiten (2020)}, von der offiziellen Website
\end{center}

\bildmitts{2020-der-marsch-der-trolle.jpeg}
...
\legende[2020-der-letzte-schatten]{Der letzte Schatten (2020)}
...
\bildlinks[width=0.06\textwidth]{zeitportal-rund.png} 
Helden und zwei junge Bewahrer reisen zurück in die Zukunft. Weiter geht es mit \hyperref[storytext-2020-zwei-junge-bewahrer]{Zwei junge Bewahrer (2020)}.
...
\fillbreak
\az{ab 0}
\produkt[2016-die-chronik]{Die Chronik (2016)}
\begin{center}
    Beilage einer Edition von \hyperref[produkt-2012-die-legenden-von-andor]{Die Legenden von Andor (2012)}
\end{center}

\bildmitts{2016-die-chronik.jpg}
...
\produkt[2017-die-chronik]{Die Chronik (2017)}

\begin{center}
    Beilage einer Edition von \hyperref[produkt-2017-die-bonus-box]{Die Bonus-Box (2017)}
\end{center}

\bildmitts{2017-die-chronik.jpeg}
...
\begin{chapterbox}
    ...
    \begin{center}
        Aus \hyperref[storytext-2013-ken-dorr-merrik-und-gilda]{Ken Dorr, Merrik und Gilda (2013)}:
    \end{center}
    ...
    \bildmitts[width=\textwidth]{erzaehlerin.jpg}
...
\storytext[2014-der-sturmschild]{Der Sturmschild (2014)}

\begin{center}
    Storytext von der offiziellen Website
\end{center}

\bildmitts{2014-der-sturmschild.jpeg}
...
\fillbreak
\az{um 10}
\storytext[2012-der-dunkle-magier-varkur]{Der Dunkle Magier Varkur (2012)}
...
\begin{center}
     Brief von Hademar an Varkur  aus \hyperref[produkt-2019-das-geheimnis-des-koenigs]{Das Geheimnis des Königs (2019)}:
\end{center}
...
\begin{center}
     Aus \hyperref[storytext-2022-tenaya-die-waechterin-des-feuers]{Tenaya, die Wächterin des Feuers (2022)}:
\end{center}
...
\fillbreak
\produkt[2022-varkurs-erwachen]{Varkurs Erwachen (2022)}

\begin{center}
    Graphic Novel
\end{center}

\bildmitts{2022-varkurs-erwachen}
...
\bildmitts{varkurs-erwachen-maechte-des-meeres.jpg}
...
\begin{center}
    Aus \hyperref[storytext-2019-in-einem-fremden-land]{In einem fremden Land (2019)}:
\end{center}
...
\fillbreak
\produkt[2012-der-wolfskrieger]{Der Wolfskrieger (2012)}

\begin{center}
    Erweiterung zu \hyperref[produkt-2012-die-legenden-von-andor]{Die Legenden von Andor (2012)}, von der offiziellen Website oder als Promo
\end{center}
...
\begin{center}
    Aus \hyperref[legende-2015-die-jagd]{Die Jagd (2015)}:
\end{center}
...
\begin{center}
    Aus \hyperref[legende-2016-im-schatten-der-winterburg]{Im Schatten der Winterburg (2016)}:
\end{center}
...
\begin{center}
    Aus \hyperref[storytext-2012-die-trolle]{Die Trolle (2012)}:
\end{center}
...
\begin{center}
    Aus \hyperref[storytext-2019-ein-rabe-entscheidet-sich]{Ein Rabe entscheidet sich (2019)}:
\end{center}
...
\fillbreak
\az{diverse Jahre}
\storytext[2013-ken-dorr-merrik-und-gilda]{Ken Dorr, Merrik und Gilda (2013)}
...
\produkt[die-taverne-von-andor]{Die Taverne von Andor}
...
\fillbreak
\storytext[2012-die-helden]{Die Helden (2012)}
...
\fillbreak
\storytext[2018-die-helden-von-andor]{Die Helden von Andor (2018)}
...
\storytext[2019-echte-helden-halten-zusammen]{Echte Helden halten zusammen! (2019)}
...
\storytext[2019-ein-rabe-entscheidet-sich]{Ein Rabe entscheidet sich (2019)}
...
"Stell' es dir nicht zu leicht vor.", widersprach Vann. "Ich habe es dir schon die letzten Male gesagt: Es gibt viele gute Kämpfer unter den Andori. Wir hatten hier auch eine Schlacht. Und da standen Menschen und Zwerge Seite an Seite."\footnote{BBB: Dies klingt zwar nach der Schlacht um die Rietburg vom Ende von \hyperref[produkt-2015-das-lied-des-koenigs]{Das Lied des Königs (2015)}. Es kann aber nicht jene Schlacht sein: Dieser Storytext spielt laut seinem letzten Abschnitt vor \hyperref[storytext-2019-die-geschichte-des-drittbesten-bogenschuetzen]{Die Geschichte des drittbesten Bogenschützen (2019)} und in jenem Storytext kommt der Angriff auf den Baum der Lieder vom Anfang von \hyperref[produkt-2015-das-lied-des-koenigs]{Das Lied des Königs (2015)} vor.}
...
"\webdingsspider\webdingsratingviolence\wingdingsskullcrossbones\wingdingsfrownface\wingdingsskullcrossbones\webdingsspider\webdingstwister!", brummelte Neja unter ihrem Knebel.
...
\fillbreak
\storytext[2019-die-geschichte-des-drittbesten-bogenschuetzen]{Die Geschichte des drittbesten Bogenschützen (2019)}

\begin{center}
    Storytext von der offiziellen Website
\end{center}

\bildmitts{die-geschichte-des-drittbesten-bogenschuetzen-bild-1.jpg}
...
"Und jetzt zum dritten Preis", sagte Melkart und fügte nach einem kleinen Zögern hinzu: "Und ich bin sicher, dass sein Gewinner keine Einwände dagegen geltend machen wird. Arbon, du bist zwar erst wenige Jahre bei uns, und es gibt Stimmen, die sich bisweilen kritisch über das mangelnde Ausmaß deiner Selbstdisziplin äußern. Aber du hast heute respektable Schießkünste bewiesen, und es steht außer Frage, dass man zum Umgang mit Pfeil und Bogen Disziplin besitzen muss. Also nimm diese Waffe als deinen Gewinn entgegen, und nutze sie, um die Sicherheit der Archive zu garantieren. Folla wird dich später in den Gebrauch der Waffe einweisen. Sie hatte schon Gelegenheit, sich näher damit zu beschäftigen."
...
\bildmitts{die-geschichte-des-drittbesten-bogenschuetzen-bild-2.jpg}
...
Aber damit hatte ich gerechnet. Während ich aufschrie, streckte ich gleichzeitig die Hand aus und ergriff die Arcuballiste. Eine zweite Rolle auf dem Boden – wegen einer vermutlich angebrochenen Rippe wesentlich weniger elegant ausgeführt – endete damit, dass ich wieder auf den Beinen stand. Noch in der Bewegung hatte ich den Spannhebel umgelegt. Da ich einen Rahmen mit fünf Bolzen in der Arcuballiste stecken hatte, war sie gespannt und geladen, als ich wieder aufrecht stand – und auf Melkarts Brust gerichtet.
...
Ich warf ihm nur einen kurzen Blick zu, dann lief ich nach draußen. Dort kämpften und starben die Bewohner des Wachsamen Waldes. Auch wenn ich meinen Eid gebrochen und sogar den unbewaffneten Melkart als Geisel bedroht hatte: Ich hatte Jahre lang bei diesen Menschen gelebt, und sie bedeuteten mir mehr als die geheimen Schriften in den Schwarzen Archiven.
...
In genau diesem Augenblick schlug ein Pfeil neben mir in einen Ast, wo sich eben noch mein Kopf befunden hatte. 
...
\fillbreak
\produkt[2015-das-lied-des-koenigs]{Das Lied des Königs (2015)}

\begin{center}
    Roman oder Hörbuch
\end{center}

\bildmitts{2015-das-lied-des-koenigs.png}
...
\bildmitts{das-lied-des-koenigs-chada-lonas.jpg}
...
\begin{center}
    Aus \hyperref[storytext-2020-zwei-junge-bewahrer]{Zwei junge Bewahrer (2020)}:
\end{center}
...
\storytext[2019-in-einem-fremden-land]{In einem fremden Land (2019)}
...
Nachdenklich blickten beide auf Bragor herunter. Der lag immer noch auf der Lichtung und verdaute. Was weder Gända noch Tion in den Sinn kam war, dass Bragon soeben in der Tat an Informationen gekommen war, \textit{weil} ihm niemand etwas zutraute. 
...
\newpage
\produkt[2012-die-legenden-von-andor]{Die Legenden von Andor (2012)}
...
\bildmitts{2012-die-legenden-von-andor.png}


\begin{center}
    \legendensymbol[2012-die-ankunft-der-helden]{Die Ankunft der Helden (2012)}
    \legendensymbol[2012-die-heilung-des-koenigs]{Die Heilung des Königs (2012)}
    \legendensymbol[2012-die-tage-des-widerstands]{Die Tage des Widerstands (2012)}
    \legendensymbol[2012-das-geheimnis-der-mine]{Das Geheimnis der Mine (2012)}
    \legendensymbol[2012-der-zorn-des-drachens]{Der Zorn des Drachens (2012)}
    \legendensymbol[2012-das-erbe-des-drachens]{Das Erbe des Drachens (2012)}
\end{center}
...
\begin{itemize}[topsep=0pt,itemsep=-1ex,partopsep=1ex,parsep=1ex]
    ...
    \item Die Taverne von Andor aus \hyperref[produkt-2015-das-lied-des-koenigs]{Das Lied des Königs (2015)}
...
\fillbreak
\produkt[2023-big-box]{Big Box (2023)}
...
\bildmitts{2023-big-box.png}

\begin{center}
    \legendensymbol[2012-die-ankunft-der-helden]{Die Ankunft der Helden (2012)}
    \legendensymbol[2012-die-heilung-des-koenigs]{Die Heilung des Königs (2012)}
    \legendensymbol[2017-der-angriff-der-barbaren]{Der Angriff der Barbaren (2017)}
    \legendensymbol[2012-die-tage-des-widerstands]{Die Tage des Widerstands (2012)}
    \legendensymbol[2013-die-eskorte-des-koenigs]{Die Eskorte des Königs (2013)}
    \legendensymbol[2012-das-geheimnis-der-mine]{Das Geheimnis der Mine (2012)}
    \legendensymbol[2012-die-befreiung-der-mine]{Die Befreiung der Mine (2012)}
    \legendensymbol[2017-der-vorbote-des-feuers]{Der Vorbote des Feuers (2017)}
    \legendensymbol[2012-der-zorn-des-drachens]{Der Zorn des Drachens (2012)}
\end{center}
...
\fillbreak
\legende[2012-die-ankunft-der-helden]{Die Ankunft der Helden (2012)}

\begin{center}
    Legende aus \hyperref[produkt-2012-die-legenden-von-andor]{Die Legenden von Andor (2012)} oder \hyperref[produkt-2023-big-box]{Big Box (2023)}
\end{center}
...
\begin{center}
    Aus dem Trailer zu \hyperref[produkt-2012-die-legenden-von-andor]{Die Legenden von Andor (2012)}:
\end{center}
...
\fillbreak
\storytext[2014-vara-der-wassergeist]{Vara, der Wassergeist (2014)}
...
\fillbreak
\storytext[2019-die-hueterin-und-die-hexe]{Die Hüterin und die Hexe (2019)}

\begin{center}
    Storytext von der offiziellen Website
\end{center}

\bildmitts{die-hueterin-und-die-hexe-bild-1.jpg}
...
\textit{Die folgende Geschichte beginnt wenige Tage nach dem Ende der Geschichte "Vara, der Wassergeist" von Stefanie Schmitt, siehe:} [Link zu \hyperref[storytext-2014-vara-der-wassergeist]{Vara, der Wassergeist (2014)}]
...
"Das ist nicht wahr!", rief Janis mit der alles wissenden Überzeugung der Jugend. "Vara hatte sich in Etore verliebt, deshalb ist sie bei uns. Das war der Großvater von meinem Großvater. Und von dem noch mal der Großvater."\footnote{BBB: Dies ist ein "Ur-" weniger als in \hyperref[storytext-2014-vara-der-wassergeist]{Vara, der Wassergeist (2014)}.} 
...
\fillbreak
\produkt[2014-neue-helden]{Neue Helden (2014)}

\begin{center}
    Erweiterung zu \hyperref[produkt-2012-die-legenden-von-andor]{Die Legenden von Andor (2012)}
\end{center}

\bildmitts{2014-neue-helden.png}
...
\legende[2012-die-heilung-des-koenigs]{Die Heilung des Königs (2012)}
...
\storytext[2018-heilkraut]{Heilkraut (2018)}
...
\bildmitts{die-heilung-des-koenigs.jpg}
...
\begin{center}
    Aus \hyperref[legende-2012-die-heilung-des-koenigs]{Die Heilung des Königs (2012)}:
\end{center}
...
\begin{center}
    Aus \hyperref[legende-2012-die-tage-des-widerstands]{Die Tage des Widerstands (2012)}:
\end{center}
...
\fillbreak
\produkt[2017-die-bonus-box]{Die Bonus-Box (2017)}
\label{produkt-2017-2024-die-bonus-box}
...
\bildmitts{2017-die-bonus-box.png}
...
\fillbreak
\produkt[2024-die-bonus-box]{Die Bonus-Box (2024)}
...
\bildmitts{2024-die-bonus-box.jpeg}
...
\legende[2017-der-angriff-der-barbaren]{Der Angriff der Barbaren (2017)}

\begin{center}
    Legende aus \hyperref[produkt-2017-2024-die-bonus-box]{Die Bonus-Box (2017/2024)} oder \hyperref[produkt-2023-big-box]{Big Box (2023)}
\end{center}
...
\begin{chapterbox}
    ...
    \begin{center}
        Aus \hyperref[storytext-tavernen-party-2022]{Tavernen-Party 2022}:
    \end{center}
    ...
    \bildmitts[width=\textwidth]{die-ewige-kaelte-helden.jpeg}
...
\fillbreak
\az{Jahr 64}
\produkt[abenteuer-andor-2022]{Abenteuer Andor 2022}
...
\storytext[2022-ein-beunruhigender-fund]{Ein beunruhigender Fund (2022)}
...
[Link zu \hyperref[storytext-2022-tenaya-die-waechterin-des-feuers]{Tenaya, die Wächterin des Feuers (2022)}]
...
\fillbreak
\storytext[2022-tenaya-die-waechterin-des-feuers]{Tenaya, die Wächterin des Feuers (2022)}
...
\bildmitts{tenaya-die-waechterin-des-feuers-bild-1.jpg} 
...
\bildmitts{tenaya-die-waechterin-des-feuers-bild-2.jpg}
...
\bildmitts{tenaya-die-waechterin-des-feuers-bild-3.jpg}
...
%\bildmitts{tenaya-die-waechterin-des-feuers-bild-4.jpg}
...
\fillbreak
\storytext[tavernen-party-2022]{Tavernen-Party 2022}
...
\fillbreak
\storytext[2022-das-raetsel-um-die-tafel-der-schlafenden-katze]{Das Rätsel um die Tafel der Schlafenden Katze (2022)}
...
\bildmitts{aa2022-raetsel-um-tafel-1.png}

Und was sehen wir da Schönes in der unteren linken Ecke?

\bildmitts{aa2022-raetsel-um-tafel-2.png}
...
\bildmitts{aa2022-raetsel-um-tafel-3.jpeg}

[...] Habe auf Seite 38 der Spielbox noch die fehlende Ecke gefunden. :lol: :lol: :lol:

\bildmitts{aa2022-raetsel-um-tafel-4.png}




\fillbreak
\storytext[2022-tenayas-reise]{Tenayas Reise (2022)}

\bildmitts{2022-tenayas-reise.jpg}

\begin{center}
    Inoffizielle Abschrift eines Hörspiels
\end{center}

[Musik: The Vigilant Woods aus \hyperref[produkt-2019-legends-of-andor-original-board-game-soundtrack]{Legends of Andor: Original Board Game Soundtrack (2019)}]\bigskip
...
[Musik: The Vigilant Woods aus \hyperref[produkt-2019-legends-of-andor-original-board-game-soundtrack]{Legends of Andor: Original Board Game Soundtrack (2019)}]

\bildmitts{tenayas-reise-teil-2-cover.jpeg}

[Musik: The Abandoned Tower aus \hyperref[produkt-2019-legends-of-andor-original-board-game-soundtrack]{Legends of Andor: Original Board Game Soundtrack (2019)}]\bigskip
...
[Musik: The Tavern Song aus \hyperref[produkt-2019-legends-of-andor-original-board-game-soundtrack]{Legends of Andor: Original Board Game Soundtrack (2019)}]





\storytext[2022-tranuk-vom-stamm-der-yetohe]{Tranuk, vom Stamm der Yetohe (2022)}
...
\fillbreak
\storytext[2022-der-weite-weg-zum-weissen-fels]{Der weite Weg zum Weißen Fels (2022)}
...
\fillbreak
\produkt[2022-die-ewige-kaelte]{Die ewige Kälte (2022)}

\begin{center}
    Eigenständiges Spiel
\end{center}

\bildmitts{2022-die-ewige-kaelte.png}

\begin{center}
    \legendensymbol[2022-der-winterstein]{Der Winterstein (2022)}
    \legendensymbol[2022-das-land-der-drei-brueder]{Das Land der drei Brüder (2022)}
    \legendensymbol[2022-die-spur-der-macht]{Die Spur der Macht (2022)}
    \legendensymbol[2022-die-pranken-des-winters]{Die Pranken des Winters (2022)}
\end{center}
...
\legende[2022-der-winterstein]{Der Winterstein (2022)}

\begin{center}
    Legende aus \hyperref[produkt-2022-die-ewige-kaelte]{Die ewige Kälte (2022)}
\end{center}
...
\fillbreak
\storytext[2023-grent-der-bergkrieger-von-greifenfels]{Grent, der Bergkrieger von Greifenfels (2023)}
...
\fillbreak
\produkt[2023-der-bergkrieger]{Der Bergkrieger (2023)}

\begin{center}
    Erweiterung zu \hyperref[produkt-2022-die-ewige-kaelte]{Die ewige Kälte (2022)}, als Promo
\end{center}

\bildmitts{2023-grent.jpeg}
...
\legende[2022-das-land-der-drei-brueder]{Das Land der drei Brüder (2022)}
...
\legende[2022-die-spur-der-macht]{Die Spur der Macht (2022)}
...
\fillbreak
\legende[2024-orennah]{Orennah (2024)}

\begin{center}
    Legende zu \hyperref[produkt-2022-die-ewige-kaelte]{Die ewige Kälte (2022)}, als Promo
\end{center}

\bildmitts{2024-orennah.jpeg}
...
\bildmitts{orennah-avida.jpg}





\legende[2022-die-pranken-des-winters]{Die Pranken des Winters (2022)}
...
\fillbreak
\produkt[2019-feuer-und-wasser]{Feuer und Wasser (2019)}
...
[Link auf \hyperref[produkt-2019-der-feuerkrieger]{Der Feuerkrieger (2019)}]
...
\produkt[2019-die-wassermagierin]{Die Wassermagierin (2019)}

\begin{center}
    Erweiterung für \hyperref[produkt-2012-die-legenden-von-andor]{Die Legenden von Andor (2012)} oder \hyperref[produkt-2023-big-box]{Big Box (2023)}
\end{center}
...
\produkt[2019-der-feuerkrieger]{Der Feuerkrieger (2019)}

\begin{center}
    Blanko-Held und -Heldin von der offiziellen Website
\end{center}

[Seit 2023 gibt es mit Trieest aus \hyperref[produkt-2023-herz-aus-eis]{Herz aus Eis (2023)} eine offizielle Feuerkrieger-Sonderfähigkeit.]




\fillbreak
\produkt[2023-herz-aus-eis]{Herz aus Eis (2023)}



\begin{center}
    \legendensymbol[2023-wintereinbruch]{Wintereinbruch (2023)}
    \legendensymbol[2023-drohende-kaelte]{Drohende Kälte (2023)}
    \legendensymbol[2023-herz-aus-eis]{Herz aus Eis (2023)}
\end{center}

\bildmitts{2023-herz-aus-eis.png}

\begin{center}
    Erweiterung zu \hyperref[produkt-2019-das-geheimnis-des-koenigs]{Das Geheimnis des Königs (2019)}
\end{center}
...
\legende[2023-wintereinbruch]{Wintereinbruch (2023)}

\begin{center}
    Legende aus \hyperref[produkt-2023-herz-aus-eis]{Herz aus Eis (2023)}
\end{center}
...
\legende[2023-drohende-kaelte]{Drohende Kälte (2023)}
...
\fillbreak
\legende[2023-herz-aus-eis]{Herz aus Eis (2023)}
...
\storytext[2023-gilda-ist-wieder-da]{Gilda ist wieder da! (2023)}
...
\fillbreak
\produkt[2023-die-kreaturen-des-ava]{Die Kreaturen des Ava (2023)}
...
\chapter{Das ferne Land}
    ...
    \begin{center}
        Aus \hyperref[storytext-2024-2025]{2025! (2024)}:
    \end{center}
...
\fillbreak
\az{Jahr 64}
\storytext[2024-die-bezwingerin-des-feuers]{Die Bezwingerin des Feuers (2024)}
...
\storytext[2025-zum-glueck-sind-helden-dabei]{Zum Glück sind Helden dabei (2025)}
...
\storytext[2025-die-rueckkehr-der-gorlots]{Die Rückkehr der Gorlots (2025)}

\begin{center}
    Beitrag aus dem offiziellen Forum
\end{center}

\bildmitts{2025-die-rueckkehr-der-gorlots.jpeg}
...
\fillbreak
\produkt[2025-das-ferne-land]{Das ferne Land (2025)}

\begin{center}
    Eigenständiges Spiel
\end{center}

\bildmitts{2025-das-ferne-land.png}

\begin{center}
    \legendensymbol[2025-der-wahre-meister]{Der wahre Meister (2025)}
    \legendensymbol[2025-hinter-den-flammen]{Hinter den Flammen (2025)}
    \legendensymbol[2025-ein-neues-heim]{Ein neues Heim (2025)}
    \legendensymbol[2025-aus-dem-schatten]{Aus dem Schatten (2025)}
    \legendensymbol[2025-das-beben]{Das Beben (2025)}
    \legendensymbol[2025-die-hoehle]{Die Höhle (2025)}
    \legendensymbol[2025-der-bueffel-die-schlange-und-der-greif]{Der Büffel, die Schlange und der Greif (2025)}
\end{center}
...
\legende[2025-der-wahre-meister]{Der wahre Meister (2025)}

\begin{center}
    Legende aus \hyperref[produkt-2025-das-ferne-land]{Das ferne Land (2025)}
\end{center}



\legende[2025-hinter-den-flammen]{Hinter den Flammen (2025)}
...
\legende[2025-ein-neues-heim]{Ein neues Heim (2025)}
...
\legende[2025-aus-dem-schatten]{Aus dem Schatten (2025)}
...
\produkt[2026-die-trolle-des-fernen-landes]{Die Trolle des Fernen Landes (2026)}
...
\bildmitts{die-trolle-des-fernen-landes-gewinn.jpg}
...
\legende[2025-das-beben]{Das Beben (2025)}
...
\legende[2025-die-hoehle]{Die Höhle (2025)}
...
\legende[2025-der-bueffel-die-schlange-und-der-greif]{Der Büffel, die Schlange und der Greif (2025)}
...
\chapter{Magier, Nekromant und Drache}
    ...
    \begin{center}
        Aus \hyperref[legende-2013-die-eskorte-des-koenigs]{Die Eskorte des Königs (2013)}:
    \end{center}
...
\fillbreak
\az{Jahr 64}
\legende[2012-die-tage-des-widerstands]{Die Tage des Widerstands (2012)}
...
\begin{itemize}[topsep=0pt,itemsep=-1ex,partopsep=1ex,parsep=1ex]
    ...
    \item Bonus-Legendenkarten "Dunkler Magier" aus \hyperref[produkt-2022-varkurs-erwachen]{Varkurs Erwachen (2022)}
\end{itemize}
...
\fillbreak
\storytext[2018-usmos-siliciumweisheiten]{Usmos Siliciumweisheiten (2018)}
...
\fillbreak
\produkt[2019-das-geheimnis-des-koenigs]{Das Geheimnis des Königs (2019)}
...
\bildmitts{2019-das-geheimnis-des-koenigs.png}

\begin{center}
    \legendensymbol[2019-tutorial-legende]{Tutorial-Legende (2019)}
    \legendensymbol[2019-die-grosse-jagd]{Die große Jagd (2019)}
    \legendensymbol[2019-die-hilfe-der-hexe]{Die Hilfe der Hexe (2019)}
    \legendensymbol[2019-die-heilung-des-prinzen]{Die Heilung des Prinzen (2019)}
    \legendensymbol[2019-die-fee-im-wald]{Die Fee im Wald (2019)}
    \legendensymbol[2019-der-riesengor]{Der Riesengor (2019)}
    \legendensymbol[2019-durch-die-mine]{Durch die Mine (2019)}\\
    \legendensymbol[2019-gipfelstuermer]{Gipfelstürmer (2019)}
    \legendensymbol[2019-ein-alter-bekannter-und-neue-freunde]{Ein alter Bekannter und neue Freunde (2019)}
    \legendensymbol[2019-der-tross-des-koenigs]{Der Tross des Königs (2019)}
    \legendensymbol[2019-schatten-der-vergangenheit]{Schatten der Vergangenheit (2019)}
    \legendensymbol[2019-der-ueberfall-auf-das-rietland]{Der Überfall auf das Rietland (2019)}
    \legendensymbol[2019-sturm-auf-die-winterburg]{Sturm auf die Winterburg (2019)}
\end{center}
...
\legende[2019-tutorial-legende]{Tutorial-Legende (2019)}

\begin{center}
    Legende aus \hyperref[produkt-2019-das-geheimnis-des-koenigs]{Das Geheimnis des Königs (2019)}
\end{center}



\legende[2019-die-grosse-jagd]{Die große Jagd (2019)}
...
\fillbreak
\legende[2019-die-hilfe-der-hexe]{Die Hilfe der Hexe (2019)}
...
\legende[2019-die-heilung-des-prinzen]{Die Heilung des Prinzen (2019)}
...
\legende[2019-die-fee-im-wald]{Die Fee im Wald (2019)}
...
\legende[2019-der-riesengor]{Der Riesengor (2019)}
...
\legende[2019-durch-die-mine]{Durch die Mine (2019)}
...
\legende[2019-gipfelstuermer]{Gipfelstürmer (2019)}
...
\legende[2019-ein-alter-bekannter-und-neue-freunde]{Ein alter Bekannter und neue Freunde (2019)}
...
\legende[2019-der-tross-des-koenigs]{Der Tross des Königs (2019)}
...
\legende[2019-schatten-der-vergangenheit]{Schatten der Vergangenheit (2019)}
...
\legende[2019-der-ueberfall-auf-das-rietland]{Der Überfall auf das Rietland (2019)}
...
\legende[2019-sturm-auf-die-winterburg]{Sturm auf die Winterburg (2019)}
...
\fillbreak
\az{Jahr 65}
\legende[2013-die-eskorte-des-koenigs]{Die Eskorte des Königs (2013)}

\begin{center}
    Legende von der offiziellen Website oder aus \hyperref[produkt-2017-2024-die-bonus-box]{Die Bonus-Box (2017/2024)} oder \hyperref[produkt-2023-big-box]{Big Box (2023)}
\end{center}

\bildmitts{2013-die-eskorte-des-koenigs.jpeg}
...
\fillbreak
\legende[2012-das-geheimnis-der-mine]{Das Geheimnis der Mine (2012)}
...
\legende[2012-die-befreiung-der-mine]{Die Befreiung der Mine (2012)}
...
\legende[2017-der-vorbote-des-feuers]{Der Vorbote des Feuers (2017)}
...
\fillbreak
\produkt[2019-die-befreiung-der-rietburg]{Die Befreiung der Rietburg (2019)}

\begin{center}
    Eigenständiges Spiel
\end{center}

\bildmitts{2019-die-befreiung-der-rietburg.png}
...
\fillbreak
\legende[2012-der-zorn-des-drachens]{Der Zorn des Drachens (2012)}
...
\legende[2012-das-erbe-des-drachens]{Das Erbe des Drachens (2012)}

\begin{center}
    Blanko-Legende aus \hyperref[produkt-2012-die-legenden-von-andor]{Die Legenden von Andor (2012)} oder von der offiziellen Website
\end{center}
...
\fillbreak
\az{ab 65}
\storytext[2012-ausblick]{Ausblick (2012)}
...
\begin{chapterbox}
    ...
    \begin{center}
        Aus \hyperref[legende-2018-die-vierte-statue]{Die vierte Statue (2018)}:
    \end{center}
...
\fillbreak
\az{spätestens 65}
\storytext[online-tavernen-weihnachts-party-2017]{Online-Tavernen-Weihnachts-Party 2017}
...
\bildmitts{2017-leander-sieht-verschollene-legenden.jpg}
...
\fillbreak
\az{Jahr 65}
\storytext[2018-tulgor]{Tulgor (2018)}

\begin{center}
    Storytext von der offiziellen Website
\end{center}

\bildmitts{2018-tulgor.jpg}
...
\fillbreak
\storytext[2018-siantari]{Siantari (2018)}

\begin{center}
    Storytext von der offiziellen Website
\end{center}

\bildmitts{2018-siantari.jpg}
...
\fillbreak
\produkt[2018-alte-geister]{Alte Geister (2018)}
\begin{center}
    Erweiterung zu \hyperref[produkt-2012-die-legenden-von-andor]{Die Legenden von Andor (2012)} oder \hyperref[produkt-2023-big-box]{Big Box (2023)}
\end{center}

\bildmitts{2018-alte-geister.png}


\begin{center}
    \legendensymbol[2018-die-spur-des-drachen]{Die Spur des Drachen (2018)}
    \legendensymbol[2018-der-hexer-aus-andor]{Der Hexer aus Andor (2018)}
    \legendensymbol[2018-die-steinernen-drei]{Die steinernen Drei (2018)}
\end{center}
...
\legende[2018-die-spur-des-drachen]{Die Spur des Drachen (2018)}

\begin{center}
    Legende aus \hyperref[produkt-2018-alte-geister]{Alte Geister (2018)}
\end{center}
...
\legende[2018-der-hexer-aus-andor]{Der Hexer aus Andor (2018)}
...
\legende[2018-die-steinernen-drei]{Die steinernen Drei (2018)}
...
\fillbreak
\legende[2018-die-vierte-statue]{Die vierte Statue (2018)}

\begin{center}
     Legende zu \hyperref[produkt-2018-alte-geister]{Alte Geister (2018)}, von der offiziellen Website oder als Promo
\end{center}

\bildmitts{2018-die-vierte-statue.jpeg}
...
\begin{chapterbox}
    ...
    \begin{center}
        Aus \hyperref[produkt-2013-der-sternenschild]{Der Sternenschild (2013)}:
    \end{center}
...
\fillbreak
\az{Jahr 65}
\storytext[2013-die-gaben-der-andori]{Die Gaben der Andori (2013)}
...
\bildmitts{2013-die-gaben-der-andori.jpg}
...
\fillbreak
\produkt[2013-der-sternenschild]{Der Sternenschild (2013)}
...
\bildmitts{2013-der-sternenschild.png}

\begin{center}
    \legendensymbol[2013-die-aera-des-sternenschildes]{Die Ära des Sternenschildes (2013)}
\end{center}
...
\legende[2013-die-aera-des-sternenschildes]{Die Ära des Sternenschildes (2013)}

\begin{center}
    Legende aus \hyperref[produkt-2013-der-sternenschild]{Der Sternenschild (2013)}
\end{center}
...
\begin{center}
    Aus \hyperref[storytext-2016-3-jahre-taverne-von-andor]{3 Jahre Taverne von Andor! (2016)}:
\end{center}
...
\begin{center}
    Aus \hyperref[storytext-2016-darh]{Darh (2016)}:
\end{center}
...
\fillbreak
\produkt[2018-neue-bedrohungen]{Neue Bedrohungen (2018)}
...
\begin{center}
    Aus \hyperref[storytext-2014-der-kampf-um-cavern-comic-zur-vorgeschichte]{Der Kampf um Cavern: Comic zur Vorgeschichte (2014)}:
\end{center}
...
\chapter{Geschichten von überall und nirgendwo}
    ...
    \begin{center}
        Aus \hyperref[storytext-2022-forschungsstand-zum-bannkreis-von-choranat]{Forschungsstand zum Bannkreis von Choranat (2022)}:
    \end{center}
    ...
    [Dieses Kapitel umfasst neben Ereignissen aus der Zeit zwischen der Ära des Sternenschildes und dem Kampf um Cavern pauschal alle chronologisch schwer einzuordnenden Werke wie \hyperref[produkt-2021-dunkle-pfade]{Dunkle Pfade (2021)} oder \hyperref[produkt-2021-magische-helden]{Magische Helden (2021)}.]
...
\fillbreak
\az{diverse Jahre}
\produkt[2013-der-fremde]{Der Fremde (2013)}

\begin{center}
    Blanko-Held und -Heldin von der offiziellen Website
\end{center}

\bildmitts{der-fremde.jpeg}
...
\fillbreak
\produkt[2014-das-geheimnis-des-verlassenen-turms]{Das Geheimnis des Verlassenen Turms (2014)}
...
\produkt[2014-der-unbekannte-krieger]{Der Unbekannte Krieger (2014)}
...
Die Figur ist bereits in der großen Erweiterung [\hyperref[produkt-2014-die-reise-in-den-norden]{Die Reise in den Norden (2014)}] enthalten.


\fillbreak
\produkt[2015-naraven]{Naraven (2015)}
...
\fillbreak
\produkt[2017-die-feinde]{Die Feinde (2017)}

\begin{center}
    Wettbewerb aus dem offiziellen Forum, aufgelöst mit \hyperref[storytext-2017-grenolins-geschichte]{Grenolins Geschichte (2017)}
\end{center}
...
\produkt[2021-der-weihnachts-gor]{Der Weihnachts-Gor (2021)}
...
\storytext[2013-seltsame-tafel-aufgetaucht]{Seltsame Tafel aufgetaucht (2013)}
...
\storytext[2014-neue-helden-zu-gast-in-der-taverne]{Neue Helden zu Gast in der Taverne (2014)}
...
[Link auf \hyperref[storytext-2012-der-sternenschild]{Der Sternenschild (2012)}]
...
[\hyperref[storytext-2014-die-taverne-zum-trunkenen-troll]{Die Taverne zum Trunkenen Troll (2014)}] [...]
...
[\hyperref[storytext-2014-der-bruderschild]{Der Bruderschild (2014)}]
...
die neuen Helden sind prima. Ich habe einige Zeit mit Orfen im Süden des Landes verbracht: [Link zu \hyperref[storytext-2013-ken-dorr-merrik-und-gilda]{Ken Dorr, Merrik und Gilda (2013)}]
...
\fillbreak
\produkt[2021-dunkle-pfade]{Dunkle Pfade (2021)}

\begin{center} 
    Eigenständiges Spiel
\end{center}

\bildmitts{2021-dunkle-pfade.png}
...
\storytext[2017-eine-episode-im-rietland]{Eine Episode im Rietland (2017)}
...
\produkt[2019-legends-of-andor-original-board-game-soundtrack]{Legends of Andor: Original Board Game Soundtrack (2019)}

\begin{center}
    Album
\end{center}

\bildmitts{2019-obst.jpg}
...
\storytext[2020-mein-wahrer-name]{Mein Wahrer Name (2020)}
...
\fillbreak
\az{spätestens 72}
\storytext[2021-benommen-richtete-sich-barz-auf]{Benommen richtete sich Barz auf ... (2021)}
...
\fillbreak
\produkt[2021-magische-helden]{Magische Helden (2021)}

\begin{center}
    Erweiterung zu \hyperref[produkt-2012-die-legenden-von-andor]{Die Legenden von Andor (2012)}, \hyperref[produkt-2016-die-letzte-hoffnung]{Die letzte Hoffnung (2016)} oder \hyperref[produkt-2023-big-box]{Big Box (2023)}
\end{center}

\bildmitts{2021-magische-helden.png}
...
\fillbreak
\legende[2022-im-bann-von-choranat]{Im Bann von Choranat (2022)}

\begin{center}
    Legende zu \hyperref[produkt-2021-magische-helden]{Magische Helden (2021)}, von der offiziellen Website   
\end{center}
...
\bildmitts[width=\textwidth]{duestere-zeiten-zwergentuer.jpg}
...
\storytext[2014-der-kampf-um-cavern-comic-zur-vorgeschichte]{Der Kampf um Cavern: Comic zur Vorgeschichte (2014)}
...
\bildmitts{2014-der-kampf-um-cavern-zuckerberg.jpeg}
...
\legende[2014-der-kampf-um-cavern]{Der Kampf um Cavern (2014)}

\begin{center}
    Legende zu \hyperref[produkt-2012-die-legenden-von-andor]{Die Legenden von Andor (2012)} oder \hyperref[produkt-2023-big-box]{Big Box (2023)}, von der offiziellen Website oder als Promo
\end{center}

\bildmitts{2014-der-kampf-um-cavern.jpeg}


\fillbreak
\storytext[2016-das-geschenk-des-magiers]{Das Geschenk des Magiers (2016)}

\begin{center}
    Storytext von der offiziellen Website
\end{center}

\bildmitts{2016-das-geschenk-des-magiers.jpg}
...
\begin{center}
    Aus \hyperref[storytext-2016-treffen-mit-mart]{Treffen mit Mart (2016)}:
\end{center}
...
\storytext[2020-duestere-zeiten-comic-zur-vorgeschichte]{Düstere Zeiten: Comic zur Vorgeschichte (2020)}
...
\storytext[2020-hoffnung-und-schicksal]{Hoffnung und Schicksal (2020)}
...
Erfahrt mehr über Thogger in: [Link auf \hyperref[produkt-2020-duestere-zeiten]{Düstere Zeiten (2020)}]




\fillbreak
\storytext[2020-schatten-und-verzweiflung]{Schatten und Verzweiflung (2020)}
...
Sanna stand ganz still – ohne Mimik, ohne Regung. Ihre Finger erschlafften und der Korb fiel zu Boden, wo er umstürzte und seinen Inhalt über den Boden ergoss. Der Dämmerfunken war entflammt und hatte etwas in ihr zerbrochen. Wie aus einem versiegelten Gefäß, das irgendwo tief in ihrem Inneren versteckt gewesen und nun zerborsten war, entströmte der Schatten. Die Farben des Lichts ergrauten, die Sonne schien ohne Wärme. Da spürte Sanna, wie der Schatten sie zum Gehen aufforderte. Wie eine sanfte lockende Stimme flüsterte er ihr ein, was zu tun war. Ohne klaren Gedanken ignorierte sie das Schluchzen ihrer Mutter und schritt an ihr vorbei. Sie wusste, wohin sie gehen musste.\bigskip
...
Erfahrt mehr über Shan in: [Link auf \hyperref[produkt-2020-duestere-zeiten]{Düstere Zeiten (2020)}]
...
\fillbreak
\storytext[2020-feuer-und-metall]{Feuer und Metall (2020)}
...
Erfahrt mehr über Kjall in ... [Link auf \hyperref[produkt-2020-duestere-zeiten]{Düstere Zeiten (2020)}]
...
\produkt[2020-duestere-zeiten]{Düstere Zeiten (2020)}

\begin{center}
    Erweiterung zu \hyperref[produkt-2012-die-legenden-von-andor]{Die Legenden von Andor (2012)} oder \hyperref[produkt-2023-big-box]{Big Box (2023)}
\end{center}

\bildmitts{2020-duestere-zeiten.png}

\begin{center}
    \legendensymbol[2020-schatten-ueber-cavern]{Schatten über Cavern (2020)}
    \legendensymbol[2020-fremde-heimat]{Fremde Heimat (2020)}
    \legendensymbol[2020-der-letzte-schatten]{Der letzte Schatten (2020)}
\end{center}
...
\legende[2020-schatten-ueber-cavern]{Schatten über Cavern (2020)}

\begin{center}
    Legende aus \hyperref[produkt-2020-duestere-zeiten]{Düstere Zeiten (2020)}\bigskip
\end{center}
...
Rudnars Schar, Helden und zwei junge Bewahrer reisen in die Vergangenheit. Weiter geht es mit \hyperref[legende-2020-fremde-heimat]{Fremde Heimat (2020)}.\bigskip


\bildlinks[width=0.06\textwidth]{zeitportal-rund.png} 

Helden und zwei junge Bewahrer erscheinen wieder aus der Vergangenheit, siehe \hyperref[legende-2020-der-letzte-schatten]{Der letzte Schatten (2020)}.
...
\storytext[2020-zwei-junge-bewahrer]{Zwei junge Bewahrer (2020)}

\begin{center}
    Storytext aus dem offiziellen Forum
\end{center}

\bildmitts{2020-zwei-junge-bewahrer.jpg}
...
\fillbreak
\storytext[2022-forschungsstand-zum-bannkreis-von-choranat]{Forschungsstand zum Bannkreis von Choranat (2022)}
...
\fillbreak
\az{Jahr 72}
\produkt[2014-die-reise-in-den-norden]{Die Reise in den Norden (2014)}

\begin{center}
    Erweiterung zu \hyperref[produkt-2012-die-legenden-von-andor]{Die Legenden von Andor (2012)} oder \hyperref[produkt-2023-big-box]{Big Box (2023)}
\end{center}

\bildmitts{2014-die-reise-in-den-norden}

\begin{center}
    \legendensymbol[2014-die-suche-nach-dem-kartographen]{Die Suche nach dem Kartographen (2014)}
    \legendensymbol[2014-ein-sturm-zieht-auf]{Ein Sturm zieht auf (2014)}
    \legendensymbol[2014-die-maechte-des-meeres]{Die Mächte des Meeres (2014)}
    \legendensymbol[2014-hadria]{Hadria (2014)}
\end{center}
...
\storytext[2014-der-seekrieger]{Der Seekrieger (2014)}

\begin{center}
    Beitrag aus dem offiziellen Forum
\end{center}

Wie wir seit dem Kampf um Cavern (Bonus-Legende: [\hyperref[legende-2014-der-kampf-um-cavern]{Der Kampf um Cavern (2014)}]) wissen, wird der gute Kram nicht mit in den Norden reisen. Stattdessen tritt ein neuer Held an seine Stelle: Stinner, der Seekrieger!

\bildmitts{2014-der-seekrieger.jpg}
...
\fillbreak
\legende[2014-die-suche-nach-dem-kartographen]{Die Suche nach dem Kartographen (2014)}

\begin{center}
    Legende aus \hyperref[produkt-2014-die-reise-in-den-norden]{Die Reise in den Norden (2014)}
\end{center}
...
\legende[2014-ein-sturm-zieht-auf]{Ein Sturm zieht auf (2014)}
...
\fillbreak
\az{diverse Jahre}
\storytext[2014-gewinnt-die-mini-erweiterung-die-nixe-irja]{Gewinnt die Mini-Erweiterung "Die Nixe Irja"! (2014)}
...
\fillbreak
\produkt[2015-der-schatz-des-nordens]{Der Schatz des Nordens (2015)}

\begin{center}
    Wettbewerb aus dem offiziellen Forum, aufgelöst mit \hyperref[storytext-2015-illustre-crew]{Illustre Crew (2015)}
\end{center}
...
\fillbreak
\storytext[2015-illustre-crew]{Illustre Crew (2015)}

\begin{center}
    Beiträge aus dem offiziellen Forum, Auflösung des Wettbewerbs \hyperref[produkt-2015-der-schatz-des-nordens]{Der Schatz des Nordens (2015)}
\end{center}
...
\legende[2014-die-maechte-des-meeres]{Die Mächte des Meeres (2014)}
...
\legende[2020-die-suche-nach-grenolin]{Die Suche nach Grenolin (2020)}

\begin{center}
    Legende zu \hyperref[produkt-2014-die-reise-in-den-norden]{Die Reise in den Norden (2014)}, von der offiziellen Website   
\end{center}

\bildmitts{2020-die-suche-nach-grenolin.jpeg}
...
\fillbreak
\az{Jahr 74}
\legende[2014-hadria]{Hadria (2014)}
...
\fillbreak
\storytext[2016-der-sagenumwobene-eismet]{Der sagenumwobene Eismet (2016)}
...
[Link auf \hyperref[produkt-2015-die-karte-der-insel-hadria]{Die Karte der Insel Hadria (2015)}]
...
\fillbreak
\produkt[abenteuer-andor-2015]{Abenteuer Andor 2015}
...
\storytext[2015-prolog-was-bisher-geschah]{Prolog: Was bisher geschah ... (2015)}
...
\bildmitts{aa2015-eroeffnung-der-taverne-1.jpeg}
...
Sagte ich alle Helden reisten in den Norden? Nein, nicht alle! Denn Kram, der Zwerg, wurde nach der großen Schlacht [\hyperref[legende-2014-der-kampf-um-cavern]{Der Kampf um Cavern (2014)}] zum neuen Fürsten der Schildzwerge ernannt und musste zurückbleiben. Sein neues Reich hatte stark unter der Schlacht gelitten.
...
\fillbreak
\storytext[2015-kapitel-1-der-auftrag]{Kapitel 1: Der Auftrag (2015)}
...
\fillbreak
\storytext[2015-kapitel-2-die-rechte-hand-des-koenigs]{Kapitel 2: Die rechte Hand des Königs (2015)}
...
[\hyperref[storytext-2015-abenteuer-andor-mp3]{Abenteuer Andor MP3 (2015)}]
...
\bildmitts{aa2015-die-rechte-hand-des-koenigs-1.jpeg}
...
\bildmitts{aa2015-die-rechte-hand-des-koenigs-2.jpeg}
...
\bildmitts{aa2015-die-rechte-hand-des-koenigs-3.jpeg}
...
\fillbreak
\storytext[2015-besuch-bei-melkart]{Besuch bei Melkart (2015)}
...
Harthalt erwies sich der Ehre würdig und vollbrachte noch viele Heldentaten. Man sprach von seiner Stärke, dem Schwert und seinem schwarzen Schild*. Tapfer focht er in allen drei Trollkriegen\footnote{BBB: \hyperref[legende-2020-der-marsch-der-trolle]{Der Marsch der Trolle (2020)} behandelt den mutmaßlich ersten der drei Trollkriege.} und in der grässlichen Flussschlacht. Über Letzteres erfährt man freilich mehr im Lied von "Blutstrom".\bigskip
...
\fillbreak
\storytext[2015-thronsaal]{Thronsaal (2015)}
...
\fillbreak
\legende[2015-die-jagd]{Die Jagd (2015)}

\begin{center}
    Legende zu \hyperref[produkt-2013-der-sternenschild]{Der Sternenschild (2013)}, von der offiziellen Website oder als Promo
\end{center}
...
\fillbreak
\storytext[2015-kapitel-3-die-jagd]{Kapitel 3: Die Jagd (2015)}
...
[Link auf \hyperref[storytext-2015-besuch-bei-melkart]{Besuch bei Melkart (2015)}]
...
Spannend!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! Und damit ich ja nichts vergesse, erzähle ich es euch gerne hier ausführlich: [Link auf \hyperref[storytext-2015-besuch-bei-melkart]{Besuch bei Melkart (2015)}] 
...
[Link auf \hyperref[storytext-2013-seltsame-tafel-aufgetaucht]{Seltsame Tafel aufgetaucht (2013)}]
...
Unser erster Held ist von seinem Abenteuer wohlbehalten zurückgekehrt! Welche neuen Hinweise er von Melkart bekommen hat und was der Oberste Priester der Bewahrer zur Brosche sagt, erfahrt ihr hier: [Link auf \hyperref[storytext-2015-besuch-bei-melkart]{Besuch bei Melkart (2015)}] Vielen Dank Marco, dass du diese Bürde auf dich genommen hast!!! 

\bildmitts{aa2015-die-rechte-hand-des-koenigs-4.jpeg}

[Sabrina:] Liebe Andori, erst jetzt kann ich euch von den Geschehnissen auf der Rietburg berichten. Ich traf zwar bereits am Morgen dort ein, aber dann vergingen etlichen Stunden, bis ich schließlich das große Tor passieren durfte. Als wäre das nicht genug, nach den Strapazen meines Weges, ließ man mich zu allem Überfluss auch noch im Burginneren warten. Ich zweifelte schon, ob ich wirklich die Richtige für diese Aufgabe war. Endlich ließen mich die Wachen in die Halle des Königs vor. Doch der Thronsaal schien indes dunkel und geradezu verlassen, bis sich plötzlich eine Stimme hinter mir meldete... Wollt ihr wissen, was sich im Thronsaal ereignete, dann folgt diesem Weg hier: [Link auf \hyperref[storytext-2015-thronsaal]{Thronsaal (2015)}]

\bildmitts{aa2015-die-rechte-hand-des-koenigs-5.jpeg}
...
[Link zu \hyperref[legende-2015-die-jagd]{Die Jagd (2015)}]
...
\fillbreak
\storytext[2015-die-fuenf-erlasse-des-neuen-regenten-ken-dorr]{Die fünf Erlasse des neuen Regenten Ken Dorr (2015)}
...
\fillbreak
\storytext[2015-kapitel-4-narne-tat-vyper]{Kapitel 4: Narne tat Vyper (2015)}
...
[\hyperref[storytext-2015-die-fuenf-erlasse-des-neuen-regenten-ken-dorr]{Die fünf Erlasse des neuen Regenten Ken Dorr (2015)}]
...
[Link zu \hyperref[storytext-2015-die-fuenf-erlasse-des-neuen-regenten-ken-dorr]{Die fünf Erlasse des neuen Regenten Ken Dorr (2015)}]
...
\hyperref[storytext-2015-reka-gefunden]{Reka gefunden (2015)}
...
\fillbreak
\storytext[2015-reka-gefunden]{Reka gefunden (2015)}
...
\fillbreak
\storytext[2015-epilog-die-wege-trennen-sich]{Epilog: Die Wege trennen sich ... (2015)}
...
[\hyperref[produkt-2015-das-lied-des-koenigs]{Das Lied des Königs (2015)}]
...
\fillbreak
\storytext[2015-abenteuer-andor-mp3]{Abenteuer Andor MP3 (2015)}
...
\begin{chapterbox}
    ...
    \begin{center}
        Aus \hyperref[storytext-2016-juna-ist-gefunden]{Juna ist gefunden! (2016)}:
    \end{center}
...
\fillbreak
\az{Jahr 74}
\produkt[2017-adventures-of-hadria]{Adventures of Hadria (2017)}
...
\bildmitts{2017-adventures-of-hadria.png}

\begin{center}
    \legendensymbol[2017-der-weg-nach-yra]{Der Weg nach Yra (2017)}
    \legendensymbol[2017-die-zusammenkunft]{Die Zusammenkunft (2017)}
    \legendensymbol[2017-die-feinde-vor-dem-tor]{Die Feinde vor dem Tor (2017)}
    \legendensymbol[2017-die-boten-der-zwei-orden]{Die Boten der zwei Orden (2017)}
    \legendensymbol[2017-der-eremit]{Der Eremit (2017)}
\end{center}
...
\legende[2017-der-weg-nach-yra]{Der Weg nach Yra (2017)}

\begin{center}
    Abenteuer aus \hyperref[produkt-2017-adventures-of-hadria]{Adventures of Hadria (2017)}
\end{center}
...
\legende[2017-die-zusammenkunft]{Die Zusammenkunft (2017)}

\begin{center}
    Abenteuer aus \hyperref[produkt-2017-adventures-of-hadria]{Adventures of Hadria (2017)}
\end{center}

\legende[2017-die-feinde-vor-dem-tor]{Die Feinde vor dem Tor (2017)}

\begin{center}
    Abenteuer aus \hyperref[produkt-2017-adventures-of-hadria]{Adventures of Hadria (2017)}
\end{center}

\legende[2017-die-boten-der-zwei-orden]{Die Boten der zwei Orden (2017)}
...
\legende[2017-der-eremit]{Der Eremit (2017)}
...
\begin{center}
    Aus \hyperref[produkt-2016-die-dunkle-magierin]{Die Dunkle Magierin (2016)}:
\end{center}
...
\fillbreak
\storytext[2015-merriks-brief]{Merriks Brief (2015)}
...
\fillbreak
\produkt[2015-chada-und-thorn]{Chada \& Thorn (2015)}

\begin{center}
    Eigenständiges Spiel
\end{center}

\bildmitts{2015-chada-und-thorn.png}

\begin{center}
    \legendensymbol[2015-das-losspiel-abenteuer]{Das Losspiel-Abenteuer (2015)}
    \legendensymbol[2015-die-stachelklippen]{Die Stachelklippen (2015)}
    \legendensymbol[2015-die-sturmweiden]{Die Sturmweiden (2015)}
    \legendensymbol[2015-der-stumme-wald]{Der Stumme Wald (2015)}
    \legendensymbol[2015-die-mauerberge]{Die Mauerberge (2015)}
\end{center}
...
\fillbreak
\produkt[2015-stinner-der-seekrieger-die-solo-erweiterung]{Stinner, der Seekrieger: Die Solo-Erweiterung (2015)}

\bildmitts{2015-stinner-der-seekrieger}

\begin{center}
    Erweiterung zu \hyperref[produkt-2015-chada-und-thorn]{Chada \& Thorn (2015)}, von der offiziellen Website oder als Promo
\end{center}
...
\legende[2015-das-losspiel-abenteuer]{Das Losspiel-Abenteuer (2015)}

\begin{center}
    Abenteuer aus \hyperref[produkt-2015-chada-und-thorn]{Chada \& Thorn (2015)}
\end{center}


\legende[2015-die-stachelklippen]{Die Stachelklippen (2015)}
...
\legende[2015-die-sturmweiden]{Die Sturmweiden (2015)}
...
\fillbreak
\legende[2016-die-treibholzbucht]{Die Treibholzbucht (2016)}

\begin{center}
    Abenteuer zu \hyperref[produkt-2015-chada-und-thorn]{Chada \& Thorn (2015)}, von der offiziellen Website
\end{center}

\bildmitts{2016-die-treibholzbucht.jpeg}


\legende[2015-die-westklippen]{Die Westklippen (2015)}

\begin{center}
    Blanko-Abenteuer zu \hyperref[produkt-2015-chada-und-thorn]{Chada \& Thorn (2015)},  von der offiziellen Website
\end{center}



\storytext[2015-neue-nachricht-von-merrik]{Neue Nachricht von Merrik (2015)}
...
\legende[2015-der-stumme-wald]{Der Stumme Wald (2015)}
...
\fillbreak
\legende[2015-die-feuermoore]{Die Feuermoore (2015)}
...
\bildmitts{2015-die-feuermoore.jpeg}

\legende[2015-die-mauerberge]{Die Mauerberge (2015)}
...
\fillbreak
\storytext[2015-chada-und-thorn-entstehung-einer-spielkarte]{Chada und Thorn: Entstehung einer Spielkarte (2015)}

\begin{center}
    Beitrag aus dem offiziellen Forum
\end{center}

\bildmitts{chada-und-thorn-entstehung-einer-spielkarte.jpeg}
...
\fillbreak
\storytext[2015-garz-zu-besuch-in-der-taverne]{Garz zu Besuch in der Taverne (2015)}
...
\fillbreak
\az{Jahr 75}
\legende[2015-die-rueckkehr-der-schwarzen-kogge]{Die Rückkehr der Schwarzen Kogge (2015)}

\begin{center}
    Legende zu \hyperref[produkt-2014-die-reise-in-den-norden]{Die Reise in den Norden (2014)}, von der offiziellen Website   
\end{center}

\bildmitts{2015-die-rueckkehr-der-schwarzen-kogge.jpeg}
...
\fillbreak
\produkt[abenteuer-andor-2016]{Abenteuer Andor 2016}
...
\storytext[2016-treffen-mit-mart]{Treffen mit Mart (2016)}
...
[Link zu \hyperref[produkt-2015-das-lied-des-koenigs]{Das Lied des Königs (2015)}]
...
da kann ich die Zusammenfassung als MP3 empfehlen. Die wichtigsten Dinge werden dort zusammengefasst: [Link zu \hyperref[storytext-2015-abenteuer-andor-mp3]{Abenteuer Andor MP3 (2015)}]
...
[Hörprobe zu \hyperref[produkt-2015-das-lied-des-koenigs]{Das Lied des Königs (2015)}]
...
[\hyperref[storytext-2016-der-statthalter-von-andor]{Der Statthalter von Andor (2016)}]
...
\fillbreak
\storytext[2016-der-statthalter-von-andor]{Der Statthalter von Andor (2016)}
...
\begin{center}
    Aus \hyperref[legende-2016-die-treibholzbucht]{Die Treibholzbucht (2016)}:
\end{center}
...
\begin{center}
    Aus \hyperref[storytext-2016-juna-ist-gefunden]{Juna ist gefunden! (2016)} und \hyperref[storytext-2016-an-land-gehen]{An Land gehen (2016)}:
\end{center}
...
\storytext[2016-juna-ist-gefunden]{Juna ist gefunden! (2016)}
...
[Link zu \hyperref[produkt-2016-juna]{Juna (2016)}]
...
[Link zu \hyperref[legende-2016-die-treibholzbucht]{Die Treibholzbucht (2016)}]
...
\fillbreak
\storytext[2016-3-jahre-taverne-von-andor]{3 Jahre Taverne von Andor! (2016)}
...
[Hörspiel \hyperref[storytext-2016-der-letzte-der-vier-schilde]{Der letzte der vier Schilde (2016)}]
...
[fusssohle:] [Link zu \hyperref[storytext-2015-reka-gefunden]{Reka gefunden (2015)}]
...
\fillbreak
\storytext[2016-an-land-gehen]{An Land gehen (2016)}
...
[Link zu \hyperref[storytext-2016-die-rueckkehr]{Die Rückkehr (2016)}]
...
\fillbreak
\storytext[2016-die-rueckkehr]{Die Rückkehr (2016)}
...
\fillbreak
\storytext[2016-die-suche-nach-dem-letzten-schild]{Die Suche nach dem letzten Schild (2016)}
...
Ja! Unsere Helden (mittlerweile hatte sich auch der hellseherisch nicht unbegabte ChrisW + Familie zu uns gesellt) spielten den Prototypen der Bonus-Mini-Legende "[\hyperref[legende-2016-die-rueckkehr]{Die Rückkehr (2016)}]".
...
[Link zum neuen Trailer zu \hyperref[produkt-2016-die-letzte-hoffnung]{Die letzte Hoffnung (2016)}]
...
Einen ausführlichen Bericht findet ihr in unserem Forum [Link auf \hyperref[storytext-2016-die-suche-nach-dem-letzten-schild]{Die Suche nach dem letzten Schild (2016)}].
...
\legende[2016-die-rueckkehr]{Die Rückkehr (2016)}

\bildmitts{2016-die-rueckkehr.jpeg}

\begin{center}
    Legende zu \hyperref[produkt-2013-der-sternenschild]{Der Sternenschild (2013)}, von der offiziellen Website
\end{center}
...
\fillbreak
\storytext[2016-der-weisse-falke]{Der weiße Falke (2016)}
...
\fillbreak
\storytext[2016-noch-eine-letzte-aufgabe]{Noch eine letzte Aufgabe (2016)}
...
[Link zu \hyperref[storytext-2016-der-weisse-falke]{Der weiße Falke (2016)}]
...
\fillbreak
\az{Jahr 75}
\storytext[2016-andor-iii-macht-euch-bereit]{Andor III... macht euch bereit! (2016)}
...
\produkt[2016-die-dunkle-magierin]{Die Dunkle Magierin (2016)}
...
\fillbreak
\storytext[2016-ein-dunkler-held]{Ein dunkler Held (2016)}

\begin{center}
    Inoffizielle Abschrift eines Hörspiels von der offiziellen Website
\end{center}

\bildmitts{2016-ein-dunkler-held.jpeg}
...
\fillbreak
\storytext[2017-das-geheimnis-der-brueder-2017]{Das Geheimnis der Brüder (2017)}
...
\bildmitts{2017-das-geheimnis-der-brueder.jpeg}
...
\bildmitts{das-geheimnis-der-brueder-bild-1.jpg}
...
\produkt[2017-dunkle-helden]{Dunkle Helden (2017)}

\begin{center}
    Erweiterung zu \hyperref[produkt-2012-die-legenden-von-andor]{Die Legenden von Andor (2012)}, \hyperref[produkt-2016-die-letzte-hoffnung]{Die letzte Hoffnung (2016)} oder \hyperref[produkt-2023-big-box]{Big Box (2023)}
\end{center}

\bildmitts{2017-dunkle-helden.png}
...
\fillbreak
\produkt[2016-die-letzte-hoffnung]{Die letzte Hoffnung (2016)}

\begin{center}
    Eigenständiges Spiel
\end{center}

\bildmitts{2016-die-letzte-hoffnung.png}

\begin{center}
    \legendensymbol[2016-das-graue-gebirge]{Das Graue Gebirge (2016)}
    \legendensymbol[2016-der-bleiche-koenig]{Der Bleiche König (2016)}
    \legendensymbol[2016-der-tross-der-andori]{Der Tross der Andori (2016)}
    \legendensymbol[2016-der-meister-des-trolls]{Der Meister des Trolls (2016)}
    \legendensymbol[2016-der-vergiftete-geist]{Der vergiftete Geist (2016)}
    \legendensymbol[2016-im-schatten-der-winterburg]{Im Schatten der Winterburg (2016)}
    \legendensymbol[2016-die-letzte-hoffnung]{Die letzte Hoffnung (2016)}
\end{center}
...
\storytext[2016-garz-mini-erweiterung]{Garz, Mini-Erweiterung (2016)}
...
\legende[2016-das-graue-gebirge]{Das Graue Gebirge (2016)}

\begin{center}
    Legende aus \hyperref[produkt-2016-die-letzte-hoffnung]{Die letzte Hoffnung (2016)} mit Bonus-Legendenkarten aus \hyperref[produkt-2016-die-dunkle-magierin]{Die Dunkle Magierin (2016)}, \hyperref[produkt-2017-dunkle-helden]{Dunkle Helden (2017)} und \hyperref[produkt-2021-magische-helden]{Magische Helden (2021)}
\end{center}
...
\legende[2016-der-bleiche-koenig]{Der Bleiche König (2016)}

\begin{center}
    Legende aus \hyperref[produkt-2016-die-letzte-hoffnung]{Die letzte Hoffnung (2016)}
\end{center}

\legende[2016-der-tross-der-andori]{Der Tross der Andori (2016)}
...
\fillbreak
\legende[2016-der-meister-des-trolls]{Der Meister des Trolls (2016)}

\begin{center}
    Legende aus \hyperref[produkt-2016-die-letzte-hoffnung]{Die letzte Hoffnung (2016)} mit Bonus-Legendenkarten aus \hyperref[produkt-2016-die-dunkle-magierin]{Die Dunkle Magierin (2016)}, \hyperref[produkt-2017-dunkle-helden]{Dunkle Helden (2017)} und \hyperref[produkt-2021-magische-helden]{Magische Helden (2021)}
\end{center}

\legende[2016-der-vergiftete-geist]{Der vergiftete Geist (2016)}
...
\storytext[2017-marun-die-tapfere]{Marun, die Tapfere (2017)}

\begin{center}
    Beitrag aus dem offiziellen Forum
\end{center}

\bildmitts{2017-marun-die-tapfere.jpeg}
...
\legende[2016-im-schatten-der-winterburg]{Im Schatten der Winterburg (2016)}
...
\fillbreak
\storytext[2017-grenolins-geschichte]{Grenolins Geschichte (2017)}

\begin{center}
    Beiträge aus dem offiziellen Forum, Auflösung des Wettbewerbs \hyperref[produkt-2017-die-feinde]{Die Feinde (2017)}
\end{center}
...
\fillbreak
\legende[2016-die-letzte-hoffnung]{Die letzte Hoffnung (2016)}
...
\begin{chapterbox}
    ...
    \bildmitts[width=\textwidth]{2012-arg-wo-ist-andor-palimpsest.jpg}
...
%\footnote{\hyperref[legende-2022-die-pranken-des-winters]{Die Pranken des Winters (2022)}}

\textit{Hadranoston} – Winterstein (gehoben)
%\footnote{\hyperref[storytext-2022-ein-beunruhigender-fund]{Ein beunruhigender Fund (2022)}}

\textit{[Lamanio mau]} – ?
%\footnote{\hyperref[produkt-2024-die-magischen-minen]{Teil 6: Die magischen Minen (2024)}\label{fn-aj6}}
...
\textit{[Lamoko dotom]} – ?
%\footnote{\hyperref[produkt-2024-die-daemonen-im-eis]{Teil 7: Die Dämonen im Eis (2024)}\label{fn-aj7}}
...
%\footnote{\hyperref[produkt-2021-der-fluch-des-roten-drachen]{Teil 1: Der Fluch des roten Drachen (2021)}\label{fn-aj1}}

\textit{Narkon} – Falle, Hinterhalt
%\footnote{\hyperref[storytext-2015-varatans-fluch]{Varatans Fluch (2015)}}\textsuperscript{,}\footnote{\hyperref[legende-2015-die-sturmweiden]{Die Sturmweiden (2015)}}

\textit{[Prituro]} – ?
%\footnote{\hyperref[produkt-2023-das-fluestern-im-wald]{Teil 3: Das Flüstern im Wald (2023)} (nur Hörspiel)\label{fn-aj3-hoerspiel}}

\textit{Qurun est to} – Das Ende ist nah
%\footnote{\hyperref[legende-2014-hadria]{Hadria (2014)}\label{fn-l10}}

\textit{Qurun est ir} – [Das Ende ist hier]
%\footref{fn-l10}

\textit{Rumuno [belitum]} – ?
%\footref{fn-aj3-hoerspiel}

\textit{Rumuno earim} – ?
%\footnote{\hyperref[produkt-2024-das-wesen-im-wasser]{Teil 5: Das Wesen im Wasser (2024)}\label{fn-aj5}}
...
%\footnote{\hyperref[storytext-2014-die-zwei-orden]{Die Zwei Orden (2014)}\label{fn-st-zo}}
...
%\footnote{\hyperref[storytext-2015-kapitel-2-die-rechte-hand-des-koenigs]{Kapitel 2: Die rechte Hand des Königs (2015)}}\textsuperscript{,}\footnote{\hyperref[legende-2015-die-jagd]{Die Jagd (2015)}}
...
%\footnote{\hyperref[storytext-2013-michael-menzel-im-interview]{Michael Menzel im Interview (2013)}\label{fn-andori}} 
(Bewahrer-Wort)
%\footnote{\hyperref[storytext-2020-feuer-und-metall]{Feuer und Metall (2020)}\label{fn-st-fum}}

\textit{Andori} – Angekommener
%\footref{fn-andori}\textsuperscript{,}\footnote{\hyperref[storytext-2022-tenayas-reise]{Tenayas Reise (2022)}} 
(Bewahrer-Wort)
%\footref{fn-st-fum}

\textit{Arbak} – Geist des Waldes
%\footnote{\hyperref[legende-2018-die-spur-des-drachen]{Die Spur des Drachen (2018)}}

\textit{Forn} – scheu
%\footnote{\hyperref[storytext-2016-ein-dunkler-held]{Ein dunkler Held (2016)}\label{fn-st-edh}}
...
%\footnote{\hyperref[storytext-2012-reka-die-hexe]{Reka die Hexe (2012)}}

\textit{Krahder} – Unsterblicher
%\footnote{\hyperref[storytext-2016-die-winterburg]{Die Winterburg (2016)}}

\textit{Ruoor} – Immerwütende
%\footnote{\hyperref[legende-2016-die-letzte-hoffnung]{Die letzte Hoffnung (2016)}}
...
\textit{Grate} – groß
%\footnote{\hyperref[storytext-2020-hoffnung-und-schicksal]{Hoffnung und Schicksal (2020)}\label{fn-st_hus}}

\textit{Mamoru} – Beschützer
%\footnote{\hyperref[storytext-2024-die-bezwingerin-des-feuers]{Die Bezwingerin des Feuers (2024)}}\textsuperscript{,}\footnote{\hyperref[produkt-2025-das-ferne-land]{Das ferne Land (2025)}}

\textit{Yjotege} – Büffel
%\footref{fn-st-hus}\textsuperscript{,}\footnote{\hyperref[storytext-2019-ein-rabe-entscheidet-sich]{Ein Rabe entscheidet sich (2019)}\label{fn-st-eres}}
...
%\footnote{\hyperref[produkt-2022-der-sturm-auf-die-rietburg]{Teil 2: Der Sturm auf die Rietburg (2022)}\label{fn-aj2}}

\textit{[Fito]} – ?
%\footref{fn-aj7}

\textit{Haamun} – Licht des Morgens
%\footnote{\hyperref[storytext-2018-tulgor]{Tulgor (2018)}\label{fn-st-tulgor}}

\textit{Karra} – ?
%\footnote{\hyperref[produkt-2023-das-fluestern-im-wald]{Teil 3: Das Flüstern im Wald (2023)}\label{fn-aj3}}

\textit{Kuolema} – Berge in den Wolken (Fahles Gebirge)
%\footref{fn-st-tulgor}
...
%\footnote{\hyperref[produkt-2015-chada-und-thorn]{Chada \& Thorn (2015)}\label{fn-cut}}

\textit{Lonas} – Gezähmter
%\footnote{\hyperref[produkt-2015-das-lied-des-koenigs]{Das Lied des Königs (2015)}}
...
\begin{chapterbox}
    ...
    \begin{center}
        Aus \hyperref[produkt-die-taverne-von-andor]{Die Taverne von Andor}:
    \end{center}
...
Für den Quelltext dieses Dokuments siehe \url{https://butterbrotbaer.github.io}.
...
\vspace*{1cm}
    ...
    \legendensymbol[2022-das-land-der-drei-brueder]{Das Land der drei Brüder (2022)}
    \legendensymbol[2022-die-spur-der-macht]{Die Spur der Macht (2022)}
    \legendensymbol[2024-orennah]{Orennah (2024)}
    \legendensymbol[2022-die-pranken-des-winters]{Die Pranken des Winters (2022)}
    ...
    \legendensymbol[2018-der-hexer-aus-andor]{Der Hexer aus Andor (2018)}
    \legendensymbol[2018-die-steinernen-drei]{Die steinernen Drei (2018)}
    \legendensymbol[2018-die-vierte-statue]{Die vierte Statue (2018)}
    
    \legendensymbol[2013-die-aera-des-sternenschildes]{Die Ära des Sternenschildes (2013)}
    
    \legendensymbol[2022-im-bann-von-choranat]{Im Bann von Choranat (2022)}
    
    \legendensymbol[2014-der-kampf-um-cavern]{Der Kampf um Cavern (2014)}
    \legendensymbol[2020-schatten-ueber-cavern]{Schatten über Cavern (2020)}
    \legendensymbol[2020-fremde-heimat]{Fremde Heimat (2020)}
    \legendensymbol[2020-der-marsch-der-trolle]{Der Marsch der Trolle (2020)}
    \legendensymbol[2020-der-letzte-schatten]{Der letzte Schatten (2020)}
    
    \legendensymbol[2014-die-suche-nach-dem-kartographen]{Die Suche nach dem Kartographen (2014)}
    \legendensymbol[2014-ein-sturm-zieht-auf]{Ein Sturm zieht auf (2014)}
    \legendensymbol[2014-die-maechte-des-meeres]{Die Mächte des Meeres (2014)}
    \legendensymbol[2020-die-suche-nach-grenolin]{Die Suche nach Grenolin (2020)}
    \legendensymbol[2014-hadria]{Hadria (2014)}
    \legendensymbol[2015-die-jagd]{Die Jagd (2015)}
    ...
    \legendensymbol[2015-die-stachelklippen]{Die Stachelklippen (2015)}
    \legendensymbol[2015-die-sturmweiden]{Die Sturmweiden (2015)}
    \legendensymbol[2016-die-treibholzbucht]{Die Treibholzbucht (2016)}
    \legendensymbol[2015-der-stumme-wald]{Der Stumme Wald (2015)}
    \legendensymbol[2015-die-mauerberge]{Die Mauerberge (2015)}
    
    \legendensymbol[2015-die-rueckkehr-der-schwarzen-kogge]{Die Rückkehr der Schwarzen Kogge (2015)}
    \legendensymbol[2016-die-rueckkehr]{Die Rückkehr (2016)}
