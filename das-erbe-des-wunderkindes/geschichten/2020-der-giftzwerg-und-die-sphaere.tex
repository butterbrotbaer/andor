\begin{chapterbox}
    ...
    \label{2020-der-giftzwerg-und-die-sphaere}
    \az{0 bis 340}
    ...
    \nurvollversion{
        % https://legenden-von-andor.de/forum/viewtopic.php?p=75022#p75022
        \textit{Schön dass es endlich wieder gute Geschichten in der Taverne anzuhören gibt}
        \newline
        – Merrik der Bewahrer
        \bigskip

        % https://legenden-von-andor.de/forum/viewtopic.php?p=75064#p75064
        \textit{Ich hoffe BBB du kreierst keine Paradoxien, aber normalerweise bist du ja sehr geschickt, was deine Geschichten angeht.}
        \newline
        – Phoenixpower
        \bigskip
        
        % https://legenden-von-andor.de/forum/viewtopic.php?p=75133#p75133
        \textit{Übrigens sehr schön, dass der Prolog sowohl aus Kjalls Perpektive als auch chronologisch erst nach dem ersten Kapitel spielt...}
        \newline
        – TroII
        \bigskip

        % https://legenden-von-andor.de/forum/viewtopic.php?p=75419#p75419
        \textit{Auch von mir ein ganz großes Lob an unseren Bären!}
        \newline
        – Schlafende Katze
        \bigskip

        % https://legenden-von-andor.de/forum/viewtopic.php?p=101695#p101695
        \textit{Auch die Kjall-Geschichte wurde mit Freuden konsumiert (Burps!) und hat gemundet}
        \newline
        – Trollerei
        \bigskip

        % https://legenden-von-andor.de/forum/viewtopic.php?p=113420#p113420
        \textit{Die Zeitreisen in der Geschichte gefallen mir besonders gut}
        \newline
        – Kamuna
    }
...
Hallwort sah Kjall prüfend in die Augen. Dann nickte er, drehte sich energetisch um und stapfte von Kjalls Zelle weg. Die beiden Zwergenwachen musterten Kjall finster und schritten dann im Einklang ihrem Fürsten hinterher. Kjall blieb alleine zurück und überlegte.
...
Die drei Zwerge traten synchron nach vorne und verschwanden ins Portal hinein.
...
Mit diesen Worten huschte Kjall in den dunklen, modrigen Seitengang zurück, in welchem die beiden Kjalls Bort und Hallwort zurückgelassen hatten. Drei Knalle hallten durch den Gang. Sein Doppelgänger hatte soeben wütend gegen die Zellentür getreten.
...
Hallwort nickte ergeben, während Bort immer noch mit den Zähnen knirschte. Dann nickte er ebenfalls. Kjall empfand wieder Hoffnung. Bald hätte er das alles hinter sich.
...
Kurz überlegte Kjall, ob er seiner Werkstatt einen Besuch abstatten sollte, entschied sich dann aber dagegen. Wer weiß, wie sein jüngeres Ich darauf reagieren würde, wenn es einer faltigeren Version seiner selbst im Gefangenenoutfit gegenüberstehen würde? Lieber würde er zum Verlassenen Turm aufbrechen. Kjall wusste nicht, wie es seinen Verbündeten ergangen war, aber wenn der Bleiche, Shan oder Thogger die Begegnung mit den Helden besser überstanden hatten als er, würden sie sich wahrscheinlich ebenfalls dort einfinden. Die Schar hatte sich über längere Zeit in diesem Turm eingerichtet. Nur eine der unzähligen tragisch verlassenen Zwergenbauten im Grauen Gebirge. Das Zwergenreich war am Verenden und viele Zwerge kümmerte es nicht einmal! Kjall spuckte aus.
...
Diese und ähnliche Gedanken schossen durch Kjalls Kopf, während er durch die Gänge Caverns schlich, langsam, aber stetig dem Verlassenen Turm entgegen.
...
Josella machte große Augen und war dann still.
...
\begin{commentbox}
    Weiter geht es in \hyperref[2023-die-legende-der-entzweiten-zeit]{Die Legende der entzweiten Zeit (2023)} und \hyperref[2023-der-giftzwerg-und-das-drachenherz]{Der Giftzwerg und das Drachenherz (2023)}.
\end{commentbox}
