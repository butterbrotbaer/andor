\begin{chapterbox}
    ...
    \label{2019-2020-stuermische-raetselnacht-in-der-taverne}
    ...
    \nurvollversion{
        % https://die-legenden-von-andor.fandom.com/de/wiki/Benutzer_Blog:Butterbrotb%C3%A4r/Die_Sage_vom_Butterbrotb%C3%A4ren?commentId=4400000000000007564
        \textit{Ich bin begeistert und finde, dass sich deine Sagen nicht hinter Birds und Trolls verstecken müssen.}
        \newline
        – Kar éVarin
        \bigskip

        % https://die-legenden-von-andor.fandom.com/de/wiki/Benutzer_Blog:Butterbrotb%C3%A4r/Die_Sage_vom_Butterbrotb%C3%A4ren?commentId=4400000000000007565
        \textit{Sehr schön! :D Nach den Andor-Märchen hier wieder ein eindeutiger Beweis, dass ich nicht der einzige Andori im Wiki mit einer literarischen Ader bin!}
        \newline
        – TroII
        \bigskip

        % https://legenden-von-andor.de/forum/viewtopic.php?p=58483#p58483
        \textit{voll coole Geschichten! :P}
        \newline
        – Galaphil
        \bigskip

        % https://legenden-von-andor.de/forum/viewtopic.php?p=59496#p59496
        \textit{Äusserst nett!}
        \newline
...
[Siehe \hyperref[2020-die-agren-der-schildzwerg-und-der-feuerdrache]{Die Agren, der Schildzwerg und der Feuerdrache (2020)}.]
...
\textit{Das einzige, was ich noch in meiner Schriftensammlung auftreiben konnte, war ein Bericht von Wrort, dem reisenden Temm. Vielleicht kann dieser ja bei der Suche helfen?}
...
\begin{commentbox}
    Weiter geht es in \hyperref[2023-der-feuerkrieger-und-die-wassermagierin]{Der Feuerkrieger und die Wassermagierin (2023)}.
\end{commentbox}
