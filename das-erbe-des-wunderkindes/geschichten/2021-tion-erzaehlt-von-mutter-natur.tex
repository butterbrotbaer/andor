\begin{chapterbox}
    ...
    \label{2021-tion-erzaehlt-von-mutter-natur}
    \az{Jahr 67}
    ...
    \nurvollversion{
        % https://legenden-von-andor.de/forum/viewtopic.php?p=84443#p84443
        \textit{Ich habe jetzt die ganze Geschichte gelesen und sage einfach nur: WOW! :D}
        \newline
        \textit{Wie du alle Stränge miteinander verknüpfst - das ist genial! :D}
        \newline
        – AB von dem Andorwiki
        \bigskip

        % https://legenden-von-andor.de/forum/viewtopic.php?p=84448#p84448
        \textit{Hehehe, eine wirklich schöne Verknüpfung unseres "Wissens".}
        \newline
        – TroII
        \bigskip
        ...
        \textit{eine schöne Geschichte. Da versteht man Andor gleich viel besser}
        \newline
        – Kamuna
    }
\end{chapterbox}
...
\textit{"Dort, glaubten die Andori, würde das ewige Glück auf sie warten."}
