\begin{chapterbox}
    ...
    \nurvollversion{
        % https://legenden-von-andor.de/forum/viewtopic.php?p=86866#p86866
        \textit{Ganz besonders genial fand ich übrigens, wie die Bären-Prophezeiung eingebaut wurde!}
        \newline
        – TroII
        \bigskip

        % https://legenden-von-andor.de/forum/viewtopic.php?p=113420#p113420
        \textit{Das ist wahrscheinlich meine Lieblingsgeschichte.}
        \newline
        – Kamuna
    }
\end{chapterbox}
...
Leander schwieg, wie er es schon für den Großteil des Wegs getan hatte. Er strich mit seinem Stab über die schön angeordneten Steine, aus denen die Alte Zwergenstraße aufgebaut war. Hoffentlich waren sie bald am Ziel.
...
„Aus dem Weg!“, brachte er noch heraus, dann stolperte Leander mehr aus der Höhle, als dass er schritt.
...
So trauerte Leander lange um Tarok, ehe er endlich einschlief.
...
Nichtsdestotrotz war Leander dankbar für ihre Gabe.
...
Und nun lag Hademars Geist in Leanders Hand, wusste vielleicht, wo Varkur sich aufhielt, konnte es Leander aber nicht verraten. Noch nicht. Doch Leander war geduldig. Er konnte warten. Und Varkur würde ihm nicht davonlaufen.
...
Und Leander packte Meres bei den Schultern und führte ihn zu seiner Hütte zurück.
...
Genug, um herauszufinden, wie er ihn aus diesem Gefängnis befreien konnte.
...
Leanders letzter Gedanke galt Callem.
...
Kopfschüttelnd sank er in einen unruhigen Schlummer.
...
\begin{commentbox}
    Weiter geht es in \hyperref[2023-der-giftzwerg-und-das-drachenherz]{Der Giftzwerg und das Drachenherz (2023)}.
\end{commentbox}
