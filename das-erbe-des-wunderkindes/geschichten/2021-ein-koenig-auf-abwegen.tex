\begin{chapterbox}
    ...
    \label{2021-ein-koenig-auf-abwegen}
    \az{Jahr 74}
    ...
    \nurvollversion{
        % https://legenden-von-andor.de/forum/viewtopic.php?p=85033#p85033
        \textit{Jippieh, eine weitere Geschichte! :D :P}
        \textit{Thorald ist dir gut gelungen}
        \newline
        – TroII
        \bigskip

        % https://legenden-von-andor.de/forum/viewtopic.php?p=85178#p85178
        \textit{Echt gute Geschichte. Und Thorald wird besser dargestellt als sonst.}
        \newline
        – Brogg
        \bigskip

        % https://legenden-von-andor.de/forum/viewtopic.php?p=85323#p85323
        \textit{ich find die Geschichte echt gut}
        \newline
        – Drukil
        \bigskip

        % https://legenden-von-andor.de/forum/viewtopic.php?p=101647#p101647
        \textit{gelesen und für gut befunden :P}
        \newline
        \textit{Der trunkene Tor Thorald torkelt tanfangs teprimiert durch Andor (und kommt wie gewohnt als Waschlappen rüber), aber dann zeigt er doch noch Courage und eigenen Willen, der über das Beschaffen des nächsten Zwergenstarkbiers hinausgeht.}
        \newline
        – Trollerei
        \bigskip

        % https://legenden-von-andor.de/forum/viewtopic.php?p=113420#p113420
        \textit{An sich finde ich es ganz lustig, mit Thorald mitfühlen zu können und ihn gleichzeitig nicht zu mögen, für das was er tut.}
        \newline
        – Kamuna
    }
\end{chapterbox}
...
Armond schüttelte bloß den Kopf. Ein Kontrollblick verriet ihm allerdings, dass der König noch sämtliche Finger und Ohren besaß und dass die Flecken auf seinem Wams eher nach Wein als nach Blut aussahen. So ließ er ihn widerwillig ziehen.
...
„Ja, das hast du“, räumte Ken ein. Mit einem schiefen Grinsen fügte er dann hinzu: „Aber ganz ehrlich, willst du lieber hier drinnen reihern?“
...
Aber nun, ein wenig nüchterner, war sich Thorald plötzlich nicht mehr sicher, ob er sie wirklich abgeben wollte.
...
Elga winkte ihn dennoch hinein.
...
Da ertönte ein lautes Plätschern und wie aus dem Nichts ergoss sich ein Schwall Wasser darüber. Ein wahrer Wasserfall verdeckte das steinerne Gesicht mit dem Höhleneingang nun vollständig. Thorald beachtete den Vorgang kaum und versuchte stattdessen orientierungslos, sich für einen optimalen Pfad zu entscheiden. Er wollte schließlich nach Cavern, und diese Mine lag südlich des Wachsamen Waldes. Süden war links von dort, wo sich die Sonne hinbewegte, oder?
...
Er entspannte sich. So weit, so gut.
...
Dieser lächelte: „Jetzt sprecht ihr definitiv meine Sprache!“
...
So nahm Thorald seine Beine in die Hand und setzte Ken nach.
...
Ken schüttelte sich und brach auf. Auf, zurück nach Andor. Auf, zurück zur Rietburg. Er musste seine Karten jetzt gut ausspielen, um am Ende noch obenauf zu enden. Aber ja, alles konnte noch gut kommen.
