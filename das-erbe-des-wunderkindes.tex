...
\usepackage{snotez} % für \sidenote
    \setsidenotes{
        perchapter=true,
...
\newcommand{\az}[1]{%fügt einen "nach andorischer Zeit"-Block ein
    \begin{center}
        \includegraphics[width=180px]{das-erbe-des-wunderkindes/verzierung-2.png}\\
        {\Huge #1} \\
        {nach andorischer Zeitrechnung}\\
        \includegraphics[width=180px]{das-erbe-des-wunderkindes/verzierung-1.png}
    \end{center}
    \extramarks{}{#1 a.Z.}
}
...
% Definiere Command für Verweise zur Chronik der Andorversen
\newcommand{\siehechronik}[1]{\href{https://legenden-von-andor.de/forum/viewtopic.php?f=11&t=10314}{\blacktriangleright #1}}

% Definiere Command für Pu'Xif
\newcommand{\puxif}[1]{}

% Definiere Commands für TeX-Stellen nur in der Vollversion oder nur in der Plainversion
\newcommand{\nurvollversion}[1]{#1}
\newcommand{\nurplainversion}[1]{}
...
\usepackage{environ}
    ...
    {%    
        % Seit TeX Live 2026 scheinen Marks in tcolorbox ignoriert zu werden. Speichere darum den 
        % Kapiteltitel global in der tcolorbox und setze die Header-Marks erst nach der tcolorbox.
        \begingroup
            \renewcommand{\chaptermark}[1]{\gdef\kapiteltitel{##1}}
            \begin{tcolorbox}[arc=0pt, colback=white, boxrule=0pt]
                \BODY
                \vfill
            \end{tcolorbox}
        \endgroup
        \markboth{\kapiteltitel}{}
    }
    \NewEnviron{commentbox} % box für Kommentare
    {   
        \begin{tcolorbox}[arc=0pt, colback=white, boxrule=0pt]
            \BODY
            \vfill
...
\title{Das Erbe des Wunderkindes\\und andere andorische Erzählungen\\Stand ????}
...
\date{\vfill Das Erbe des Wunderkindes v??.?\\Dieses Dokument wurde erstellt mit \LaTeX{}.\\Für den Quelltext siehe \url{https://butterbrotbaer.github.io}.\\Für die neuste Version siehe \url{https://legenden-von-andor.de/forum/viewtopic.php?f=11&t=10516}.}
...
Ich schreibe diese Geschichten vor allem, weil es mir Spass bereitet, und nicht, weil ich gut darin wäre. Ihr sollt euch auf keinen Fall durch sie hindurchquälen, wenn sie euch nicht ansprechen. Aber falls jemand Freude daran findet, könnt ihr aktiv werden (idealerweise auf \url{https://legenden-von-andor.de/forum/viewtopic.php?f=11&t=10516}): Sagt mir, was ich verbessern kann, und sagt mir, was ihr toll findet und ich bei Überarbeitungen und zukünftigen Geschichten beibehalten soll.
...
\begin{chapterbox}
    ...
    \nurvollversion{
        % https://legenden-von-andor.de/forum/viewtopic.php?p=55170#p55170
        \textit{Butterbrotbär, dein Märchen finde ich echt schön! Ganz großen Applaus!!!}
        \newline
        – Galaphil
        \bigskip

        % https://legenden-von-andor.de/forum/viewtopic.php?p=56498#p56498
        \textit{Wieder eine mehr als gelungene Geschichte!}
        \newline
        – TroII
    }
...
\begin{chapterbox}
    ...
    \nurvollversion{
        % https://legenden-von-andor.de/forum/viewtopic.php?p=54953#p54953
        \textit{die Story ist sehr gelungen}
        \newline
        – Wurzel1
        \bigskip

        % https://legenden-von-andor.de/forum/viewtopic.php?p=54954#p54954
        \textit{ich finde Idee und Story sehr toll}
        \newline
        – Frodo
        \bigskip

        % https://legenden-von-andor.de/forum/viewtopic.php?p=54958#p54958
        \textit{Dies ist eine sehr schöne Geschichte}
        \newline
        – Galaphil
        \bigskip

        % https://legenden-von-andor.de/forum/viewtopic.php?p=101631#p101631
        \textit{gefallen mir sehr}
        \newline
        – Trollerei
        \bigskip

        % https://legenden-von-andor.de/forum/viewtopic.php?p=101701#p101701
        \textit{Schönes Geschichtchen!}
        \newline
        – TroII
    }
...
\begin{chapterbox}
    ...
    \nurvollversion{
        % https://legenden-von-andor.de/forum/viewtopic.php?p=97872#p97872
        \textit{Vielen Dank für den unterhaltsamen Bericht, BBB!}
        \newline
        – Trollerei
        \bigskip

        % https://legenden-von-andor.de/forum/viewtopic.php?p=97963#p97963
        \textit{Respekt für diese Leistung, ich hätte den höchsten erreichbaren Kampfwert deutlich geringer Eingeschätzt.}
        \newline
        – Bewahrer Melkart
        \bigskip

        % https://legenden-von-andor.de/forum/viewtopic.php?p=97981#p97981
        \textit{Respekt! Der Kampfwert wird in der Tat nur schwer zu toppen!}
        \newline
        – TroII
        \bigskip

        % https://legenden-von-andor.de/forum/viewtopic.php?p=99005#p99005
        \textit{Vielen Dank für den stimmungsvollen Spielbericht, dem man deutlich anmerkt, wie viel Spaß Dir das Ausknobeln gemacht hat.}
        \newline
        – Bennie
    }
...
\begin{chapterbox}
    ...
    \label{was-ist-ein-butterbrotbaer}
...
In der Welt der Fan-Geschichte \hyperref[2025-ein-gemuetliches-gasthaus-voller-geschichten]{Ein gemütliches Gasthaus voller Geschichten (2025)}, in welcher die meisten bis und mit 2025 erschienenen Andor-Geschichten vorgetragen werden, trägt eine als \textit{kleiner Teddybär} und \textit{tiny toastförmiger Teddy mit einer Vorliebe für Butterbrote} beschriebene Person meine Geschichten vor. Da dieser Text erst weniger Seiten her ist, verzichte ich hier auf das Zitieren entsprechender Textstellen.\bigskip
