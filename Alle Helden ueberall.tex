...
\newcommand{\heldenfigur}[1]{%
    \begin{tikzpicture}[remember picture, overlay]
        \node[opacity=1, inner sep=1.5cm, anchor=north] at (current page.north) {%
            \frame{\includegraphics[height=60px]{Alle Helden ueberall/Heldenfiguren/#1}}%
        };
    \end{tikzpicture}%
    \vspace*{-\baselineskip}
}
...
\begin{titlepage}
    ...
    \frame{\hyperref[Feuerkrieger]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Trieest.jpg}}}
    \frame{\hyperref[Wassermagierin]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Jarid.jpg}}}
    \frame{\hyperref[Seher]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Leander.jpg}}}
    \frame{\hyperref[Eis-Dämon]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Ijsdur.jpg}}}
    \frame{\hyperref[Wolfskrieger]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Orfen.jpg}}}
    \frame{\hyperref[Zwerg]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Kram.jpg}}}
    \frame{\hyperref[Seekrieger]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Stinner.jpg}}}
    \frame{\hyperref[Krieger]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Thorn.jpg}}}
    \frame{\hyperref[Ritter]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Thorn (Reiter).jpg}}}
    \frame{\hyperref[Tarus]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Bragor.jpg}}}

    \vspace{2pt}

    \frame{\hyperref[Fährtenleser]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Fenn.jpg}}}
    \frame{\hyperref[Hautwandler]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Drukil.jpg}}}
    \frame{\hyperref[Heilerin]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Avida.jpg}}}
    \frame{\hyperref[Weihnachts-Gor]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Santa Gor.jpg}}}
    \frame{\hyperref[Bogenschützin]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Chada.jpg}}}
    \frame{\hyperref[Takuri-Hüterin]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Aćh.jpg}}}
    \frame{\hyperref[Hüterin]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Kheela.jpg}}}
    \frame{\hyperref[Bergkrieger]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Grent.jpg}}}
    \frame{\hyperref[Zauberin]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Eara.jpg}}}

    \vspace{2pt}

    \frame{\hyperref[Dunkle Magierin]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Eara (dunkel).jpg}}}
    \frame{\hyperref[Halbskral]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Forn.jpg}}}
    \frame{\hyperref[Steppennomade]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Barz.jpg}}}
    \frame{\hyperref[Steppenreiter]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Raash.jpg}}}
    \frame{\hyperref[Bewahrer]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Arbon.jpg}}}
    \frame{\hyperref[Runenmeisterin]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Iril.jpg}}}
    \frame{\hyperref[Feuerwächterin]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Tenaya (Feuerwächterin).jpg}}}
    \frame{\hyperref[Feuerbezwingerin]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Tenaya.jpg}}}
    \frame{\hyperref[Zeitzauberer]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Kirr.jpg}}}
    \frame{\hyperref[Beschwörerin]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Darh.jpg}}}
\end{titlepage}
...
\label{Krieger}
\heldenfigur{Thorn.jpg}
\vspace*{-1.5\baselineskip}
\begin{center}
    Siehe auch \hyperref[Ritter]{Thorn (Mairen), der \fan{Ritter}}.
\end{center}
...
\label{Ritter}
\heldenfigur{Thorn (Reiter).jpg}
\vspace*{-1.5\baselineskip}
\begin{center}
    Siehe auch \hyperref[Krieger]{Thorn (Mairen), der Krieger}.
\end{center}
...
\label{Zauberin}
\heldenfigur{Eara.jpg}
\vspace*{-1.5\baselineskip}
\begin{center}
    Siehe auch \hyperref[Dunkle Magierin]{Eara (Liphardus), die Dunkle Magierin}.
\end{center}
...
\heldenfigur{Eara (dunkel).jpg}
\vspace*{-1.5\baselineskip}
\begin{center}
    Siehe auch \hyperref[Zauberin]{Eara (Liphardus), die Zauberin}.
\end{center}
...
\heldenfigur{Tenaya (Feuerwächterin).jpg}
\vspace*{-1.5\baselineskip}
\begin{center}
    Siehe auch \hyperref[Feuerbezwingerin]{Tenaya (Teyan), die Feuerbezwingerin}.
\end{center}
...
\heldenfigur{Tenaya.jpg}
\vspace*{-1.5\baselineskip}
\begin{center}
    Siehe auch \hyperref[Feuerwächterin]{Tenaya (Teyan), die Feuerwächterin}.
\end{center}
