...
\begin{titlepage}
    ...
    \hyperref[Feuerkrieger]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Trieest.jpg}}
    \hyperref[Wassermagierin]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Jarid.jpg}}
    \hyperref[Seher]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Leander.jpg}}
    \hyperref[Eis-Dämon]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Ijsdur.jpg}}
    \hyperref[Wolfskrieger]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Orfen.jpg}}
    \hyperref[Zwerg]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Kram.jpg}}
    \hyperref[Seekrieger]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Stinner.jpg}}
    \hyperref[Krieger]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Thorn.jpg}}
    \hyperref[Ritter]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Thorn (Reiter).jpg}}
    \hyperref[Tarus]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Bragor.jpg}}

    \vspace{2pt}

    \hyperref[Fährtenleser]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Fenn.jpg}}
    \hyperref[Hautwandler]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Drukil.jpg}}
    \hyperref[Heilerin]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Avida.jpg}}
    \hyperref[Weihnachts-Gor]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Santa Gor.jpg}}
    \hyperref[Bogenschützin]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Chada.jpg}}
    \hyperref[Takuri-Hüterin]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Aćh.jpg}}
    \hyperref[Hüterin]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Kheela.jpg}}
    \hyperref[Bergkrieger]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Grent.jpg}}
    \hyperref[Zauberin]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Eara.jpg}}

    \vspace{2pt}

    \hyperref[Dunkle Magierin]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Eara (dunkel).jpg}}
    \hyperref[Halbskral]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Forn.jpg}}
    \hyperref[Steppennomade]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Barz.jpg}}
    \hyperref[Steppenreiter]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Raash.jpg}}
    \hyperref[Bewahrer]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Arbon.jpg}}
    \hyperref[Runenmeisterin]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Iril.jpg}}
    \hyperref[Feuerwächterin]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Tenaya (Feuerwächterin).jpg}}
    \hyperref[Feuerbezwingerin]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Tenaya.jpg}}
    \hyperref[Zeitzauberer]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Kirr.jpg}}
    \hyperref[Beschwörerin]{\includegraphics[width=42pt]{Alle Helden ueberall/Heldenfiguren/Darh.jpg}}
\end{titlepage}
